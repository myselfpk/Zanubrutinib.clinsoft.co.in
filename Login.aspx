    ...
    <main class="login-shell">
        <section class="login-intro" aria-label="Study information">
            <div class="intro-content">
                ...
                <h1>Reliable study data,<br />in one secure workspace.</h1>
            ...
            <form id="loginForm" class="login-card" runat="server" autocomplete="on">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <asp:TextBox ID="txtLogin" ClientIDMode="Static" runat="server" CssClass="form-control" placeholder="Enter login ID" autocomplete="username" MaxLength="25" required="" aria-required="true" aria-describedby="validationSummary loginErrors" oninvalid="this.setCustomValidity('Please enter your login ID')" oninput="setCustomValidity('')"></asp:TextBox>
                    </div>
                    <asp:RequiredFieldValidator ID="LoginRequiredValidator" runat="server" ControlToValidate="txtLogin" ValidationGroup="Login1" Display="Dynamic" CssClass="field-error" ErrorMessage="Login ID is required." />
                </div>
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <asp:TextBox ID="txtPassword" ClientIDMode="Static" runat="server" CssClass="form-control" TextMode="Password" placeholder="Enter password" autocomplete="current-password" MaxLength="128" required="" aria-required="true" aria-describedby="validationSummary loginErrors" oninvalid="this.setCustomValidity('Please enter your password')" oninput="setCustomValidity('')"></asp:TextBox>
                    </div>
                    <asp:RequiredFieldValidator ID="PasswordRequiredValidator" runat="server" ControlToValidate="txtPassword" ValidationGroup="Login1" Display="Dynamic" CssClass="field-error" ErrorMessage="Password is required." />
                </div>
                <asp:ValidationSummary ID="LoginValidationSummary" ClientIDMode="Static" runat="server" ValidationGroup="Login1" CssClass="login-error validation-summary" DisplayMode="BulletList" role="alert" />
