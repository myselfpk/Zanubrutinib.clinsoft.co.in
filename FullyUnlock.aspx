<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FullyUnlock.aspx.cs" Inherits="DataView_Day1_FullyUnlock" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function Confirm() {
            ...
            if (validated) {
                ...
                if (confirm("Do you want to Submit DataBase Unlock By Data Manager Page?")) {
    ...
    <script type="text/javascript">
        function Confirm1() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to Save DataBase Unlock By Data Manager Page?")) {
                confirm_value.value = "Yes";
            } else {
                confirm_value.value = "No";
            }
            ...
            <div class="page-title">
                <div>
                    <h1><i class="fa fa-edit"></i>
                        <asp:Label runat="server" ID="lblPage">DataBase Unlock</asp:Label></h1>
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <asp:RadioButtonList ID="RadioButtonListPI" ValidationGroup="IC" runat="server">
                                                    <asp:ListItem><%--I declare that I have reviewed all subject visit data and found them accurate and complete to the best of my knowledge.--%>Database fully Unlock by the Data Manager</asp:ListItem>
                                                </asp:RadioButtonList>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            <div class="col-md-5 col-md-offset-3">
                                                ...
                                                <input type = "button" id="btnShowLogin" class="btn btn-primary" value = "Database Unlock by the Data Manager" />
                                            </div>
                                        </div>
                                    </div>
