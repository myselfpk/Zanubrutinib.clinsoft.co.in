...
public partial class Data_Entry_AdVisit_PiSingSC : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    {
        if (RadioButtonListPI.SelectedValue == "I declare that I have reviewed the data and statements Submitted for this subject for Withdrawal Form and found them accurate and complete to the best of my knowledge.")
        {
        ...
        {
            dvMessage.Visible = true;
            lblMessage.Text = "Please click on I declare that I have reviewed the data and statements Submitted for this subject for Withdrawal Form and found them accurate and complete to the best of my knowledge.";
            ClientScript.RegisterStartupScript(this.GetType(), "JS", "$(function () { $('#LoginModal').modal('show'); });", true);
        }
