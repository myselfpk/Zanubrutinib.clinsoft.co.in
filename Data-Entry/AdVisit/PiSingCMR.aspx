<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PiSingCMR.aspx.cs" Inherits="Data_Entry_AdVisit_PiSingCMR" MaintainScrollPositionOnPostback="true" %>
                                ...
                                <div class="text-center">
                                    ...
                                    <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                        ...
                                        <tr style="background-color:orange; height:40px; color:#003300">
                                            <td><b>Concomitant Medication Log</b></td>
                                        ...
                                        <tr>
                                            <td colspan="3" style="height:40px; padding-top:10px">
                                                <asp:RadioButtonList ID="RadioButtonListPI" ValidationGroup="IC" runat="server" CssClass="rbl">
                                                    <asp:ListItem>I declare that I have reviewed the data and statements Submitted for this subject for Concomitant Medication Log and found them accurate and complete to the best of my knowledge.</asp:ListItem>
                                                </asp:RadioButtonList>
