<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PiSingSC.aspx.cs" Inherits="Data_Entry_AdVisit_PiSingSC" MaintainScrollPositionOnPostback="true" %>
                                        ...
                                        <tr>
                                            <td colspan="3" style="height:40px; padding-top:10px">
                                                <asp:RadioButtonList ID="RadioButtonListPI" ValidationGroup="IC" runat="server" CssClass="rbl">
                                                    <asp:ListItem>I declare that I have reviewed the data and statements Submitted for this subject for Withdrawal Form and found them accurate and complete to the best of my knowledge.</asp:ListItem>
                                                </asp:RadioButtonList>
