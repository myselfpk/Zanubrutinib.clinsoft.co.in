<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Biochemistry.aspx.cs" Inherits="Data_Entry_Visit7_Biochemistry" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Data Entry | Visit 7 | Biochemistry</title>
    ...
    <script type="text/javascript">
        function Confirm() {
            ...
            if (validated) {
                ...
                if (confirm("Do you want to Submit Biochemistry page?")) {
    ...
    <script type="text/javascript">
        function Confirm1() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to Save Biochemistry page?")) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
            ...
            <div class="page-title">
                <div>
                    <h1><i class="fa fa-edit"></i>
                        <asp:Label runat="server" ID="lblPage">Biochemistry</asp:Label></h1>
                ...
                <div>
                    <ul class="breadcrumb">
                        ...
                        <li>Data Entry</li>
                        <li>
                            <asp:LinkButton ID="lblVisit" runat="server" OnClick="lblVisit_Click">Visit 7</asp:LinkButton></li>
                    </ul>
                </div>
            </div>
            <div class="row">
               ...
               <asp:ImageButton ID="AttachmentPageHistory" Height="25px" Width="25px" runat="server" OnClick="AttachmentPageHistory_Click" />
                                    ...
                                    <asp:Panel ID="hideBIO" runat="server" Visible="false">
                                        <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                            <colgroup>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB1OPT">Sr Uric Acid</asp:Label>
                                                </td>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB2OPT">Sr Creatinine</asp:Label>
                                                </td>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB3OPT">eGFR</asp:Label>
                                                </td>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB4OPT">Sr Sodium</asp:Label>
                                                </td>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB5OPT">Sr Potassium</asp:Label>
                                                </td>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB6OPT">Total Cholesterol</asp:Label>
                                                </td>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB7OPT">HDL</asp:Label>
                                                </td>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB8OPT">LDL</asp:Label>
                                                </td>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB9OPT">Sr triglycerides</asp:Label>
                                                </td>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB10OPT">Total Bilirubin</asp:Label>
                                                </td>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB11OPT">SGOT</asp:Label>
                                                </td>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB12OPT">SGPT</asp:Label>
                                                </td>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB13OPT">GGT</asp:Label>
                                                </td>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB14OPT">Sr Alkaline Phosphatase</asp:Label>
                                                </td>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListNAB14OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" AutoPostBack="true" OnSelectedIndexChanged="RadioButtonListNAB14OPT_SelectedIndexChanged">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>Normal</asp:ListItem>
                                                        <asp:ListItem>Abnormal</asp:ListItem>
                                                    </asp:DropDownList>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListABN14OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" Visible="false">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>CS</asp:ListItem>
                                                        <asp:ListItem>NCS</asp:ListItem>
                                                    </asp:DropDownList>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB15OPT">Trop-T</asp:Label>
                                                </td>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListNAB15OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" AutoPostBack="true" OnSelectedIndexChanged="RadioButtonListNAB15OPT_SelectedIndexChanged">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>Normal</asp:ListItem>
                                                        <asp:ListItem>Abnormal</asp:ListItem>
                                                    </asp:DropDownList>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListABN15OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" Visible="false">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>CS</asp:ListItem>
                                                        <asp:ListItem>NCS</asp:ListItem>
                                                    </asp:DropDownList>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB16OPT">PT</asp:Label>
                                                </td>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListNAB16OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" AutoPostBack="true" OnSelectedIndexChanged="RadioButtonListNAB16OPT_SelectedIndexChanged">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>Normal</asp:ListItem>
                                                        <asp:ListItem>Abnormal</asp:ListItem>
                                                    </asp:DropDownList>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListABN16OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" Visible="false">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>CS</asp:ListItem>
                                                        <asp:ListItem>NCS</asp:ListItem>
                                                    </asp:DropDownList>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB17OPT">INR</asp:Label>
                                                </td>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListNAB17OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" AutoPostBack="true" OnSelectedIndexChanged="RadioButtonListNAB17OPT_SelectedIndexChanged">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>Normal</asp:ListItem>
                                                        <asp:ListItem>Abnormal</asp:ListItem>
                                                    </asp:DropDownList>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListABN17OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" Visible="false">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>CS</asp:ListItem>
                                                        <asp:ListItem>NCS</asp:ListItem>
                                                    </asp:DropDownList>
    ...
    <asp:Label runat="server" ID="lblRSLT1OPT" Text="Sr Uric Acid Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT2OPT" Text="Sr Creatinine Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT3OPT" Text="eGFR Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT4OPT" Text="Sr Sodium Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT5OPT" Text="Sr Potassium Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT6OPT" Text="Total Cholesterol Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT7OPT" Text="HDL count Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT8OPT" Text="LDL Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT9OPT" Text="Sr triglycerides Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT10OPT" Text="Total Bilirubin Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT11OPT" Text="SGOT Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT12OPT" Text="SGPT Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT13OPT" Text="GGT Results" Visible="false"></asp:Label>

    <asp:Label runat="server" ID="lblUN1OPT" Text="Sr Uric Acid Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN2OPT" Text="Sr Creatinine Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN3OPT" Text="eGFR Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN4OPT" Text="Sr Sodium Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN5OPT" Text="Sr Potassium Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN6OPT" Text="Total Cholesterol Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN7OPT" Text="HDL count Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN8OPT" Text="LDL Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN9OPT" Text="Sr triglycerides Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN10OPT" Text="Total Bilirubin Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN11OPT" Text="SGOT Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN12OPT" Text="SGPT Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN13OPT" Text="GGT Units" Visible="false"></asp:Label>

    <asp:Label runat="server" ID="lblNAB1OPT" Text="Sr Uric Acid Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB2OPT" Text="Sr Creatinine Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB3OPT" Text="eGFR Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB4OPT" Text="Sr Sodium Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB5OPT" Text="Sr Potassium Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB6OPT" Text="Total Cholesterol Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB7OPT" Text="HDL count Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB8OPT" Text="LDL Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB9OPT" Text="Sr triglycerides Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB10OPT" Text="Total Bilirubin Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB11OPT" Text="SGOT Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB12OPT" Text="SGPT Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB13OPT" Text="GGT Normal/Abnormal" Visible="false"></asp:Label>

    <asp:Label runat="server" ID="lblABN1OPT" Text="Sr Uric Acid CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN2OPT" Text="Sr Creatinine CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN3OPT" Text="eGFR CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN4OPT" Text="Sr Sodium CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN5OPT" Text="Sr Potassium CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN6OPT" Text="Total Cholesterol CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN7OPT" Text="HDL count CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN8OPT" Text="LDL CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN9OPT" Text="Sr triglycerides CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN10OPT" Text="Total Bilirubin CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN11OPT" Text="SGOT CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN12OPT" Text="SGPT CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN13OPT" Text="GGT CS/NCS" Visible="false"></asp:Label>

    <asp:Label runat="server" ID="lblRSLT14OPT" Text="Sr Alkaline Phosphatase Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT15OPT" Text="Trop-T  Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT16OPT" Text="PT Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT17OPT" Text="INR Results" Visible="false"></asp:Label>

    <asp:Label runat="server" ID="lblUN14OPT" Text="Sr Alkaline Phosphatase Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN15OPT" Text="Trop-T  Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN16OPT" Text="PT Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN17OPT" Text="INR Units" Visible="false"></asp:Label>

    <asp:Label runat="server" ID="lblNAB14OPT" Text="Sr Alkaline Phosphatase Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB15OPT" Text="Trop-T  Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB16OPT" Text="PT Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB17OPT" Text="INR Normal/Abnormal" Visible="false"></asp:Label>

    <asp:Label runat="server" ID="lblABN14OPT" Text="Sr Alkaline Phosphatase CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN15OPT" Text="Trop-T  CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN16OPT" Text="PT CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN17OPT" Text="INR CS/NCS" Visible="false"></asp:Label>
    ...
    <!-- Query Sr Uric Acid Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Sr Uric Acid Details:" ID="RAISERSLT1OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Sr Uric Acid Details:" ID="RAISERSLT1OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT1OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel3" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Sr Uric Acid Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Sr Creatinine Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Sr Creatinine Details:" ID="RAISERSLT2OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Sr Creatinine Details:" ID="RAISERSLT2OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT2OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Sr Creatinine Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query eGFR Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: eGFR Details:" ID="RAISERSLT3OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: eGFR Details:" ID="RAISERSLT3OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT3OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel2" runat="server" BorderStyle="Solid">
                            Query has been Responded of the eGFR Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Sr Sodium Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Sr Sodium Details:" ID="RAISERSLT4OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Sr Sodium Details:" ID="RAISERSLT4OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT4OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel4" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Sr Sodium Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Sr Potassium Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Sr Potassium Details:" ID="RAISERSLT5OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Sr Potassium Details:" ID="RAISERSLT5OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT5OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel5" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Sr Potassium Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Total Cholesterol Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Total Cholesterol Details:" ID="RAISERSLT6OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Total Cholesterol Details:" ID="RAISERSLT6OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT6OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel6" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Total Cholesterol Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query HDL count Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: HDL count Details:" ID="RAISERSLT7OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: HDL count Details:" ID="RAISERSLT7OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT7OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel7" runat="server" BorderStyle="Solid">
                            Query has been Responded of the HDL count Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query LDL Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: LDL Details:" ID="RAISERSLT8OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: LDL Details:" ID="RAISERSLT8OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT8OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel8" runat="server" BorderStyle="Solid">
                            Query has been Responded of the LDL Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Sr triglycerides Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Sr triglycerides Details:" ID="RAISERSLT9OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Sr triglycerides Details:" ID="RAISERSLT9OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT9OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel9" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Sr triglycerides Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Total Bilirubin Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Total Bilirubin Details:" ID="RAISERSLT10OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Total Bilirubin Details:" ID="RAISERSLT10OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT10OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel10" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Total Bilirubin Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query SGOT Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: SGOT Details:" ID="RAISERSLT11OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: SGOT Details:" ID="RAISERSLT11OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT11OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel11" runat="server" BorderStyle="Solid">
                            Query has been Responded of the SGOT Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query SGPT Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: SGPT Details:" ID="RAISERSLT12OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: SGPT Details:" ID="RAISERSLT12OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT12OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel12" runat="server" BorderStyle="Solid">
                            Query has been Responded of the SGPT Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query GGT Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: GGT Details:" ID="RAISERSLT13OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: GGT Details:" ID="RAISERSLT13OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT13OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel13" runat="server" BorderStyle="Solid">
                            Query has been Responded of the GGT Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Sr Alkaline Phosphatase Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Sr Alkaline Phosphatase Details:" ID="RAISERSLT14OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Sr Alkaline Phosphatase Details:" ID="RAISERSLT14OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT14OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel15" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Sr Alkaline Phosphatase Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Trop-T Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Trop-T Details:" ID="RAISERSLT15OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Trop-T Details:" ID="RAISERSLT15OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT15OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel16" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Trop-T Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query PT Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: PT Details:" ID="RAISERSLT16OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: PT Details:" ID="RAISERSLT16OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT16OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel17" runat="server" BorderStyle="Solid">
                            Query has been Responded of the PT Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query INR Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: INR Details:" ID="RAISERSLT17OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: INR Details:" ID="RAISERSLT17OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT17OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel18" runat="server" BorderStyle="Solid">
                            Query has been Responded of the INR Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
