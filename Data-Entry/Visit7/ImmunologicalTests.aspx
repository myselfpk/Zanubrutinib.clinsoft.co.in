<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ImmunologicalTests.aspx.cs" Inherits="Data_Entry_Visit7_ImmunologicalTests" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Data Entry | Visit 7 | Immunological Tests</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
         ...
         <asp:ImageButton ID="AttachmentPageHistory" Height="25px" Width="25px" runat="server" OnClick="AttachmentPageHistory_Click" />
                                    ...
                                    <asp:Panel ID="hideIMMT" runat="server" Visible="false">
                                        <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                            <colgroup>
                                            ...
                                            <tr class="auto-style2">
                                                <td>
                                                    <asp:Label runat="server" ID="lblLAB1OPT">IgM</asp:Label>
                                                </td>
    ...
    <asp:Label runat="server" ID="lblRSLT1OPT" Text="IgM Results" Visible="false"></asp:Label>

    <asp:Label runat="server" ID="lblUN1OPT" Text="IgM Units" Visible="false"></asp:Label>

    <asp:Label runat="server" ID="lblNAB1OPT" Text="IgM Normal/Abnormal" Visible="false"></asp:Label>

    <asp:Label runat="server" ID="lblABN1OPT" Text="IgM CS/NCS" Visible="false"></asp:Label>
    ...
    <!-- Query IgM Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: IgM Details:" ID="RAISERSLT1OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: IgM Details:" ID="RAISERSLT1OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT1OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel3" runat="server" BorderStyle="Solid">
                            Query has been Responded of the IgM Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
