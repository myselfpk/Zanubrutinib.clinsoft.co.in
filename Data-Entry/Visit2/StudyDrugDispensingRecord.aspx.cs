...
public partial class Data_Entry_Visit2_StudyDrugDispensingRecord : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    private void BindPage()
    {
        con.Close();
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select SDDRPER , SDDDOSE , SDDFRQ , SDDNCD , SDDDOD from [Visit2].[StudyDrugDispensingRecord] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            TextBoxSDDNCD.Text = dt.Rows[0]["SDDNCD"].ToString().Trim();
            ...
            ViewState["txt4"] = TextBoxSDDNCD.Text;
            ViewState["txt5"] = TextBoxSDDDOD.Text;
        }
        con.Close();
    ...
    private void PageStatus()
    {
        ...
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select EntryStatus,LockStatus from [Visit2].[StudyDrugDispensingRecord] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt1);
        if (dt1.Rows.Count > 0)
        {
    ...
    public void OnConfirm(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select EntryStatus from [Visit2].[StudyDrugDispensingRecord] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt2);
        if (dt2.Rows.Count > 0)
        {
            ...
            if (dt2.Rows[0]["EntryStatus"].ToString() == "Save")
            {
                ...
                {
                    con.Close();
                    cmd = new SqlCommand("[Visit2].[sp_StudyDrugDispensingRecord]", con);
                    ...
                    cmd.Parameters.AddWithValue("@SDDNCD", TextBoxSDDNCD.Text);
            ...
            if (dt2.Rows[0]["EntryStatus"].ToString() == "Submit")
            {
                ...
                if (confirmValue == "Yes")
                {
                    ...
                    DataTable dt1 = new DataTable();
                    con.Open();
                    sqlCmd = new SqlCommand("SELECT ActivefLag FROM [Visit2].[StudyDrugDispensingRecord] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "' and (ActivefLag='0' or ActivefLag='1')", con);
                    ...
                    if (dt1.Rows.Count > 0)
                    {
                        ...
                        {
                            if (ViewState["txt1"].ToString() != RadioButtonListSDDRPER.SelectedValue || ViewState["txt2"].ToString() != TextBoxSDDDOSE.Text || ViewState["txt3"].ToString() != TextBoxSDDFRQ.Text || ViewState["txt4"].ToString() != TextBoxSDDNCD.Text || ViewState["txt5"].ToString() != TextBoxSDDDOD.Text)
                            {
    ...
    private DataTable AddRow()
    {
        ...
        if (!string.IsNullOrEmpty(RadioButtonListSDDRPER.SelectedValue) || !string.IsNullOrEmpty(TextBoxSDDDOSE.Text) || !string.IsNullOrEmpty(TextBoxSDDFRQ.Text) || !string.IsNullOrEmpty(TextBoxSDDNCD.Text) || !string.IsNullOrEmpty(TextBoxSDDDOD.Text))
        {
            DataTable dt1 = new DataTable();
            ...
            if (ViewState["txt4"].ToString() != TextBoxSDDNCD.Text)
            {
                DataRow dtrow = dtEmp.NewRow();
                dtrow["Column"] = lblSDDNCD.Text;
                dtrow["OldValue"] = dt1.Rows[0][3];
                dtrow["NewValue"] = TextBoxSDDNCD.Text;
                dtEmp.Rows.Add(dtrow);
            }
            if (ViewState["txt5"].ToString() != TextBoxSDDDOD.Text)
            {
                DataRow dtrow = dtEmp.NewRow();
    ...
    protected void ImageQuerySDDRPER_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit2].[StudyDrugDispensingRecord] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SDDRPER = '" + RadioButtonListSDDRPER.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseSDDRPER_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit2].[StudyDrugDispensingRecord] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SDDRPER = '" + RadioButtonListSDDRPER.SelectedValue + "'", con1);
    ...
    protected void ImageQuerySDDDOSE_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit2].[StudyDrugDispensingRecord] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SDDDOSE = '" + TextBoxSDDDOSE.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseSDDDOSE_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit2].[StudyDrugDispensingRecord] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SDDDOSE = '" + TextBoxSDDDOSE.Text + "'", con1);
    ...
    protected void ImageQuerySDDFRQ_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit2].[StudyDrugDispensingRecord] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SDDFRQ = '" + TextBoxSDDFRQ.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseSDDFRQ_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit2].[StudyDrugDispensingRecord] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SDDFRQ = '" + TextBoxSDDFRQ.Text + "'", con1);
    ...
    #endregion
    #region QuerySDDNCD
    private void SetImageQuerySDDNCD()
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select top 1 * from tblQuery where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'and Field = '" + lblSDDNCD.Text + "' order by ID desc", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySDDNCD.ImageUrl = "~/Data-Entry/Images/red.png";
            ...
            {
                ImageQuerySDDNCD.ImageUrl = "~/Data-Entry/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySDDNCD.ImageUrl = "~/Data-Entry/Images/Yellow.png";

            }
            else
            {
                ImageQuerySDDNCD.ImageUrl = "~/Data-Entry/Images/Blue.jpg";
    ...
    private void BindQueryDataSDDNCD()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                LabelRaiseSDDNCD.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                PanelRaiseSDDNCD.Visible = true;
                PanelRaiseSDDNCD2.Visible = false;
                PanelRaiseSDDNCD3.Visible = false;
                PanelHideSDDNCD.Visible = true;

            }
            else if (dr["Status"].ToString() == "Close")
            {
                LabelRaiseSDDNCD.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                LabelRaiseSDDNCD2.Text = "<b>" + "Query Resolved by: " + "</b>" + dr["Username2"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Reply: " + "</b>" + dr["QueryResponse"].ToString() + "" + "<br />" + "<b>";
                LabelRaiseSDDNCD3.Text = "<b>" + "Query closed by: " + "</b>" + dr["Username3"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Closed Remarks: " + "</b>" + dr["QueryResponse3"].ToString();
                PanelRaiseSDDNCD.Visible = true;
                PanelRaiseSDDNCD2.Visible = true;
                PanelRaiseSDDNCD3.Visible = true;
                PanelHideSDDNCD.Visible = false;
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                LabelRaiseSDDNCD.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
    ...
    protected void ImageQuerySDDNCD_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit2].[StudyDrugDispensingRecord] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SDDNCD = '" + TextBoxSDDNCD.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySDDNCD.ImageUrl == "~/Data-Entry/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISESDDNCD.Visible = true;
                RAISESDDNCD.ShowPopupWindow();
                QueryRaiseSDDNCD.Visible = false;
                TextBoxRaiseSDDNCD.Visible = false;
                PanelRaiseSDDNCD.Visible = false;
                PanelRaiseSDDNCD2.Visible = false;
                PanelRaiseSDDNCD3.Visible = false;

                LabelRespondSDDNCD.Visible = false;
            }

            else if ((ImageQuerySDDNCD.ImageUrl == "~/Data-Entry/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESDDNCD.Visible = true;
                RAISESDDNCD.ShowPopupWindow();
                QueryRaiseSDDNCD.Visible = true;
                TextBoxRaiseSDDNCD.Visible = true;
                PanelRaiseSDDNCD.Visible = true;
                PanelRaiseSDDNCD2.Visible = false;
                PanelRaiseSDDNCD3.Visible = false;
                LabelRespondSDDNCD.Visible = true;
            }

            else if ((ImageQuerySDDNCD.ImageUrl == "~/Data-Entry/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESDDNCD.Visible = true;
                RAISESDDNCD.ShowPopupWindow();
                QueryRaiseSDDNCD.Visible = false;
            ...
            else if ((ImageQuerySDDNCD.ImageUrl == "~/Data-Entry/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESDDNCD.Visible = true;
                RAISESDDNCD.ShowPopupWindow();
                QueryRaiseSDDNCD.Visible = false;
    ...
    protected void QueryRaiseSDDNCD_Click(object sender, EventArgs e)
    {
        con.Close();
        con.Open();
        con1.Open();

        cmd = new SqlCommand("Update tblQuery set QueryResponse = '" + TextBoxRaiseSDDNCD.Text + "', Status ='Query Responded', Username2 ='" + LabelUserName.Text + "', Date2 ='" + DateTime.Today.ToString("dd-MMM-yyyy") + "' where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'and Field = '" + lblSDDNCD.Text + "' and QueryResponse IN (Select top 1 QueryResponse from tblQuery  where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'and Field = '" + lblSDDNCD.Text + "' order by ID desc)", con);

        cmd1 = new SqlCommand("Update [Visit2].[StudyDrugDispensingRecord] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SDDNCD = '" + TextBoxSDDNCD.Text + "'", con1);
        ...
        RAISESDDNCDMSG.ShowPopupWindow();
        RAISESDDNCD.Visible = false;
    ...
    protected void ImageQuerySDDDOD_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit2].[StudyDrugDispensingRecord] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SDDDOD = '" + TextBoxSDDDOD.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseSDDDOD_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit2].[StudyDrugDispensingRecord] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SDDDOD = '" + TextBoxSDDDOD.Text + "'", con1);
    ...
    protected void ShowHide()
    {
        ...
        {
            hideSDD.Visible = true;
        }
        else
        {
            hideSDD.Visible = false;
        }
    }
    ...
    protected void RadioButtonListSDDRPER_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            TextBoxSDDNCD.Text = string.Empty;
