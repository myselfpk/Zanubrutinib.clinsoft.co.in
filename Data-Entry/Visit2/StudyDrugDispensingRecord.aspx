<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StudyDrugDispensingRecord.aspx.cs" Inherits="Data_Entry_Visit2_StudyDrugDispensingRecord" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Data Entry | Visit 2 | Study Drug Dispensing Record</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
                                ...
                                <div class="text-center">
                                    ...
                                    <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                        ...
                                        <tr class="auto-style2">
                                            <td>
                                                <asp:Label runat="server" ID="lblSDDRPER">Was study drug for 1 month dispensed to the subject?</asp:Label>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorSDDRPER" runat="server"
                                                    CssClass="Validators" Display="None" ErrorMessage="please mention Was study drug for 1 month dispensed to the subject?"
                                        ...
                                        <asp:Panel ID="hideSDD" runat="server" Visible="false">
                                            <tr class="auto-style2">
                                                <td>
    ...
    <!-- Query Was study drug for 1 month dispensed to the subject?: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Was study drug for 1 month dispensed to the subject?:" ID="RAISESDDRPER" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Was study drug for 1 month dispensed to the subject?:" ID="RAISESDDRPERMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESDDRPERMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel3" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Was study drug for 1 month dispensed to the subject? Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
