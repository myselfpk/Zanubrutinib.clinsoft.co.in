...
public partial class Data_Entry_Visit4_SubjectDiaryDispensing : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    private void BindPage()
    {
        con.Close();
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select SDDPER from [Visit4].[SubjectDiaryDispensing] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt);
        if (dt.Rows.Count > 0)
        {
            RadioButtonListSDDPER.SelectedValue = dt.Rows[0]["SDDPER"].ToString().Trim();


            ViewState["txt1"] = RadioButtonListSDDPER.SelectedValue;
        }
        con.Close();
    ...
    private void PageStatus()
    {
        ...
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select EntryStatus,LockStatus from [Visit4].[SubjectDiaryDispensing] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt1);
        if (dt1.Rows.Count > 0)
        {
    ...
    public void OnConfirm(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select EntryStatus from [Visit4].[SubjectDiaryDispensing] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt2);
        if (dt2.Rows.Count > 0)
        {
            ...
            if (dt2.Rows[0]["EntryStatus"].ToString() == "Save")
            {
                ...
                {
                    con.Close();
                    cmd = new SqlCommand("[Visit4].[sp_SubjectDiaryDispensing]", con);
                    ...
                    cmd.Parameters.AddWithValue("@SDDPER", RadioButtonListSDDPER.SelectedValue);
            ...
            if (dt2.Rows[0]["EntryStatus"].ToString() == "Submit")
            {
                ...
                if (confirmValue == "Yes")
                {
                    ...
                    DataTable dt1 = new DataTable();
                    con.Open();
                    sqlCmd = new SqlCommand("SELECT ActivefLag FROM [Visit4].[SubjectDiaryDispensing] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "' and (ActivefLag='0' or ActivefLag='1')", con);
                    ...
                    if (dt1.Rows.Count > 0)
                    {
                        ...
                        {
                            if (ViewState["txt1"].ToString() != RadioButtonListSDDPER.SelectedValue)
                            {
    ...
    private DataTable AddRow()
    {
        ...
        if (!string.IsNullOrEmpty(RadioButtonListSDDPER.SelectedValue))
        {
            DataTable dt1 = new DataTable();
            ...
            if (ViewState["txt1"].ToString() !=  RadioButtonListSDDPER.SelectedValue)
            {
                ...
                dtrow["Column"] = lblSDDPER.Text;
                dtrow["OldValue"] = dt1.Rows[0][0];
                dtrow["NewValue"] = RadioButtonListSDDPER.SelectedValue;
    ...
    #region Query
    #region QuerySDDPER
    private void SetImageQuerySDDPER()
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select top 1 * from tblQuery where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'and Field = '" + lblSDDPER.Text + "' order by ID desc", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySDDPER.ImageUrl = "~/Data-Entry/Images/red.png";
            ...
            {
                ImageQuerySDDPER.ImageUrl = "~/Data-Entry/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySDDPER.ImageUrl = "~/Data-Entry/Images/Yellow.png";

            }
            else
            {
                ImageQuerySDDPER.ImageUrl = "~/Data-Entry/Images/Blue.jpg";
    ...
    private void BindQueryDataSDDPER()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                LabelRaiseSDDPER.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                PanelRaiseSDDPER.Visible = true;
                PanelRaiseSDDPER2.Visible = false;
                PanelRaiseSDDPER3.Visible = false;
                PanelHideSDDPER.Visible = true;

            }
            else if (dr["Status"].ToString() == "Close")
            {
                LabelRaiseSDDPER.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                LabelRaiseSDDPER2.Text = "<b>" + "Query Resolved by: " + "</b>" + dr["Username2"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Reply: " + "</b>" + dr["QueryResponse"].ToString() + "" + "<br />" + "<b>";
                LabelRaiseSDDPER3.Text = "<b>" + "Query closed by: " + "</b>" + dr["Username3"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Closed Remarks: " + "</b>" + dr["QueryResponse3"].ToString();
                PanelRaiseSDDPER.Visible = true;
                PanelRaiseSDDPER2.Visible = true;
                PanelRaiseSDDPER3.Visible = true;
                PanelHideSDDPER.Visible = false;
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                LabelRaiseSDDPER.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
    ...
    protected void ImageQuerySDDPER_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit4].[SubjectDiaryDispensing] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SDDPER = '" + RadioButtonListSDDPER.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySDDPER.ImageUrl == "~/Data-Entry/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISESDDPER.Visible = true;
                RAISESDDPER.ShowPopupWindow();
                QueryRaiseSDDPER.Visible = false;
                TextBoxRaiseSDDPER.Visible = false;
                PanelRaiseSDDPER.Visible = false;
                PanelRaiseSDDPER2.Visible = false;
                PanelRaiseSDDPER3.Visible = false;

                LabelRespondSDDPER.Visible = false;
            }

            else if ((ImageQuerySDDPER.ImageUrl == "~/Data-Entry/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESDDPER.Visible = true;
                RAISESDDPER.ShowPopupWindow();
                QueryRaiseSDDPER.Visible = true;
                TextBoxRaiseSDDPER.Visible = true;
                PanelRaiseSDDPER.Visible = true;
                PanelRaiseSDDPER2.Visible = false;
                PanelRaiseSDDPER3.Visible = false;
                LabelRespondSDDPER.Visible = true;
            }

            else if ((ImageQuerySDDPER.ImageUrl == "~/Data-Entry/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESDDPER.Visible = true;
                RAISESDDPER.ShowPopupWindow();
                QueryRaiseSDDPER.Visible = false;
            ...
            else if ((ImageQuerySDDPER.ImageUrl == "~/Data-Entry/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESDDPER.Visible = true;
                RAISESDDPER.ShowPopupWindow();
                QueryRaiseSDDPER.Visible = false;
    ...
    protected void QueryRaiseSDDPER_Click(object sender, EventArgs e)
    {
        con.Close();
        con.Open();
        con1.Open();

        cmd = new SqlCommand("Update tblQuery set QueryResponse = '" + TextBoxRaiseSDDPER.Text + "', Status ='Query Responded', Username2 ='" + LabelUserName.Text + "', Date2 ='" + DateTime.Today.ToString("dd-MMM-yyyy") + "' where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'and Field = '" + lblSDDPER.Text + "' and QueryResponse IN (Select top 1 QueryResponse from tblQuery  where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'and Field = '" + lblSDDPER.Text + "' order by ID desc)", con);

        cmd1 = new SqlCommand("Update [Visit4].[SubjectDiaryDispensing] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SDDPER = '" + RadioButtonListSDDPER.SelectedValue + "'", con1);
        ...
        RAISESDDPERMSG.ShowPopupWindow();
        RAISESDDPER.Visible = false;
