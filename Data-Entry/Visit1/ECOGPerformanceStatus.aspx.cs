...
public partial class Data_Entry_Visit1_ECOGPerformanceStatus : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SetImageQueryECOGPRS();

        BindQueryDataECOGPRS();
    }
    ...
    private void BindPage()
    {
        con.Close();
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select ECOGPRS from [Visit1].[ECOGPerformanceStatus] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt);
        if (dt.Rows.Count > 0)
        {
            RadioButtonListECOGPRS.SelectedValue = dt.Rows[0]["ECOGPRS"].ToString().Trim();


            ViewState["txt1"] = RadioButtonListECOGPRS.SelectedValue;
        }
        con.Close();
    ...
    private void PageStatus()
    {
        ...
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select EntryStatus,LockStatus from [Visit1].[ECOGPerformanceStatus] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt1);
        if (dt1.Rows.Count > 0)
        {
    ...
    public void OnConfirm(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select EntryStatus from [Visit1].[ECOGPerformanceStatus] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt2);
        if (dt2.Rows.Count > 0)
        {
            ...
            if (dt2.Rows[0]["EntryStatus"].ToString() == "Save")
            {
                ...
                {
                    con.Close();
                    cmd = new SqlCommand("[Visit1].[sp_ECOGPerformanceStatus]", con);
                    ...
                    cmd.Parameters.AddWithValue("@ECOGPRS", RadioButtonListECOGPRS.SelectedValue);
            ...
            if (dt2.Rows[0]["EntryStatus"].ToString() == "Submit")
            {
                ...
                if (confirmValue == "Yes")
                {
                    ...
                    DataTable dt1 = new DataTable();
                    con.Open();
                    sqlCmd = new SqlCommand("SELECT ActivefLag FROM [Visit1].[ECOGPerformanceStatus] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "' and (ActivefLag='0' or ActivefLag='1')", con);
                    ...
                    if (dt1.Rows.Count > 0)
                    {
                        ...
                        {
                            if (ViewState["txt1"].ToString() != RadioButtonListECOGPRS.SelectedValue)
                            {
    ...
    private DataTable AddRow()
    {
        ...
        if (!string.IsNullOrEmpty(RadioButtonListECOGPRS.SelectedValue))
        {
            DataTable dt1 = new DataTable();
            ...
            if (ViewState["txt1"].ToString() !=  RadioButtonListECOGPRS.SelectedValue)
            {
                ...
                dtrow["Column"] = lblECOGPRS.Text;
                dtrow["OldValue"] = dt1.Rows[0][0];
                dtrow["NewValue"] = RadioButtonListECOGPRS.SelectedValue;
    ...
    #region Query
    #region QueryECOGPRS
    private void SetImageQueryECOGPRS()
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select top 1 * from tblQuery where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'and Field = '" + lblECOGPRS.Text + "' order by ID desc", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryECOGPRS.ImageUrl = "~/Data-Entry/Images/red.png";
            ...
            {
                ImageQueryECOGPRS.ImageUrl = "~/Data-Entry/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryECOGPRS.ImageUrl = "~/Data-Entry/Images/Yellow.png";

            }
            else
            {
                ImageQueryECOGPRS.ImageUrl = "~/Data-Entry/Images/Blue.jpg";
    ...
    private void BindQueryDataECOGPRS()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                LabelRaiseECOGPRS.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                PanelRaiseECOGPRS.Visible = true;
                PanelRaiseECOGPRS2.Visible = false;
                PanelRaiseECOGPRS3.Visible = false;
                PanelHideECOGPRS.Visible = true;

            }
            else if (dr["Status"].ToString() == "Close")
            {
                LabelRaiseECOGPRS.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                LabelRaiseECOGPRS2.Text = "<b>" + "Query Resolved by: " + "</b>" + dr["Username2"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Reply: " + "</b>" + dr["QueryResponse"].ToString() + "" + "<br />" + "<b>";
                LabelRaiseECOGPRS3.Text = "<b>" + "Query closed by: " + "</b>" + dr["Username3"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Closed Remarks: " + "</b>" + dr["QueryResponse3"].ToString();
                PanelRaiseECOGPRS.Visible = true;
                PanelRaiseECOGPRS2.Visible = true;
                PanelRaiseECOGPRS3.Visible = true;
                PanelHideECOGPRS.Visible = false;
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                LabelRaiseECOGPRS.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
    ...
    protected void ImageQueryECOGPRS_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[ECOGPerformanceStatus] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and ECOGPRS = '" + RadioButtonListECOGPRS.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQueryECOGPRS.ImageUrl == "~/Data-Entry/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEECOGPRS.Visible = true;
                RAISEECOGPRS.ShowPopupWindow();
                QueryRaiseECOGPRS.Visible = false;
                TextBoxRaiseECOGPRS.Visible = false;
                PanelRaiseECOGPRS.Visible = false;
                PanelRaiseECOGPRS2.Visible = false;
                PanelRaiseECOGPRS3.Visible = false;

                LabelRespondECOGPRS.Visible = false;
            }

            else if ((ImageQueryECOGPRS.ImageUrl == "~/Data-Entry/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEECOGPRS.Visible = true;
                RAISEECOGPRS.ShowPopupWindow();
                QueryRaiseECOGPRS.Visible = true;
                TextBoxRaiseECOGPRS.Visible = true;
                PanelRaiseECOGPRS.Visible = true;
                PanelRaiseECOGPRS2.Visible = false;
                PanelRaiseECOGPRS3.Visible = false;
                LabelRespondECOGPRS.Visible = true;
            }

            else if ((ImageQueryECOGPRS.ImageUrl == "~/Data-Entry/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEECOGPRS.Visible = true;
                RAISEECOGPRS.ShowPopupWindow();
                QueryRaiseECOGPRS.Visible = false;
            ...
            else if ((ImageQueryECOGPRS.ImageUrl == "~/Data-Entry/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEECOGPRS.Visible = true;
                RAISEECOGPRS.ShowPopupWindow();
                QueryRaiseECOGPRS.Visible = false;
    ...
    protected void QueryRaiseECOGPRS_Click(object sender, EventArgs e)
    {
        con.Close();
        con.Open();
        con1.Open();

        cmd = new SqlCommand("Update tblQuery set QueryResponse = '" + TextBoxRaiseECOGPRS.Text + "', Status ='Query Responded', Username2 ='" + LabelUserName.Text + "', Date2 ='" + DateTime.Today.ToString("dd-MMM-yyyy") + "' where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'and Field = '" + lblECOGPRS.Text + "' and QueryResponse IN (Select top 1 QueryResponse from tblQuery  where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'and Field = '" + lblECOGPRS.Text + "' order by ID desc)", con);

        cmd1 = new SqlCommand("Update [Visit1].[ECOGPerformanceStatus] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and ECOGPRS = '" + RadioButtonListECOGPRS.SelectedValue + "'", con1);
        ...
        RAISEECOGPRSMSG.ShowPopupWindow();
        RAISEECOGPRS.Visible = false;
