<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ImmunologicalTests.aspx.cs" Inherits="Data_Entry_Visit1_ImmunologicalTests" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Data Entry | Visit 1 | Immunological Tests</title>
    ...
    <script type="text/javascript">
        function Confirm() {
            ...
            if (validated) {
                ...
                if (confirm("Do you want to Submit Immunological Tests page?")) {
    ...
    <script type="text/javascript">
        function Confirm1() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to Save Immunological Tests page?")) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
            ...
            <div class="page-title">
                <div>
                    <h1><i class="fa fa-edit"></i>
                        <asp:Label runat="server" ID="lblPage">Immunological Tests</asp:Label></h1>
                        ...
                        <asp:Panel ID="MainPanel" runat="server">
                            <div class="row">
                                <div class="text-center">
                                    ...
                                    <asp:Panel ID="hideIMM" runat="server" Visible="false">
                                    <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                        <colgroup>
                                        ...
                                        <tr class="auto-style2">
                                            <td>
                                                <asp:Label runat="server" ID="lblLAB1OPT">IgM (ONLY FOR WM)</asp:Label>
                                            </td>
                                        ...
                                        <tr class="auto-style2">
                                            <td>
                                                <asp:Label runat="server" ID="lblLAB2OPT">Beta-2 Microglobulin (For CLL, MCL, FL Patients)R</asp:Label>
                                            </td>
    ...
    <asp:Label runat="server" ID="lblRSLT1OPT" Text="IgM (ONLY FOR WM) Results" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblRSLT2OPT" Text="Beta-2 Microglobulin (For CLL, MCL, FL Patients)R Results" Visible="false"></asp:Label>

    <asp:Label runat="server" ID="lblUN1OPT" Text="IgM (ONLY FOR WM) Units" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblUN2OPT" Text="Beta-2 Microglobulin (For CLL, MCL, FL Patients)R Units" Visible="false"></asp:Label>

    <asp:Label runat="server" ID="lblNAB1OPT" Text="IgM (ONLY FOR WM) Normal/Abnormal" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblNAB2OPT" Text="Beta-2 Microglobulin (For CLL, MCL, FL Patients)R Normal/Abnormal" Visible="false"></asp:Label>

    <asp:Label runat="server" ID="lblABN1OPT" Text="IgM (ONLY FOR WM) CS/NCS" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblABN2OPT" Text="Beta-2 Microglobulin (For CLL, MCL, FL Patients)R CS/NCS" Visible="false"></asp:Label>
    ...
    <!-- Query IgM (ONLY FOR WM) Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: IgM (ONLY FOR WM) Details:" ID="RAISERSLT1OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: IgM (ONLY FOR WM) Details:" ID="RAISERSLT1OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT1OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel3" runat="server" BorderStyle="Solid">
                            Query has been Responded of the IgM (ONLY FOR WM) Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Beta-2 Microglobulin (For CLL, MCL, FL Patients)R Details: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Beta-2 Microglobulin (For CLL, MCL, FL Patients)R Details:" ID="RAISERSLT2OPT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Beta-2 Microglobulin (For CLL, MCL, FL Patients)R Details:" ID="RAISERSLT2OPTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISERSLT2OPTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Beta-2 Microglobulin (For CLL, MCL, FL Patients)R Details Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
