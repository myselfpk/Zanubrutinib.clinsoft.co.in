...
public partial class Data_Entry_Visit1_VitalSigns : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    private void BindPage()
    {
        con.Close();
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select VSDRV , VSTRV , VSSBP , VSSBPU , VSSBPI , VSSBPCS , VSDBP , VSDBPU , VSDBPI , VSDBPCS , VSPR , VSPRU , VSPRI , VSPRCS , VSRR , VSRRU , VSRRI , VSRRCS , VSTMP , VSTMPU , VSTMPI , VSTMPCS from [Visit1].[VitalSigns] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            RadioButtonListVSDBPCS.SelectedValue = dt.Rows[0]["VSDBPCS"].ToString().Trim();
            ...
            ViewState["txt1"] = TextBoxVSDRV.Text;
            ViewState["txt2"] = TextBoxVSTRV.Text;
            ViewState["txt3"] = TextBoxVSSBP.Text;
            ViewState["txt4"] = TextBoxVSSBPU.Text;
            ViewState["txt5"] = RadioButtonListVSSBPI.SelectedValue;
            ViewState["txt6"] = RadioButtonListVSSBPCS.SelectedValue;
            ViewState["txt7"] = TextBoxVSDBP.Text;
            ViewState["txt8"] = TextBoxVSDBPU.Text;
            ViewState["txt9"] = RadioButtonListVSDBPI.SelectedValue;
            ViewState["txt10"] = RadioButtonListVSDBPCS.SelectedValue;
            ViewState["txt11"] = TextBoxVSPR.Text;
            ViewState["txt12"] = TextBoxVSPRU.Text;
            ViewState["txt13"] = RadioButtonListVSPRI.SelectedValue;
            ViewState["txt14"] = RadioButtonListVSPRCS.SelectedValue;
            ViewState["txt15"] = TextBoxVSRR.Text;
            ViewState["txt16"] = TextBoxVSRRU.Text;
            ViewState["txt17"] = RadioButtonListVSRRI.SelectedValue;
            ViewState["txt18"] = RadioButtonListVSRRCS.SelectedValue;
            ViewState["txt19"] = TextBoxVSTMP.Text;
            ViewState["txt20"] = TextBoxVSTMPU.Text;
            ViewState["txt21"] = RadioButtonListVSTMPI.SelectedValue;
            ViewState["txt22"] = RadioButtonListVSTMPCS.SelectedValue;
        }
        con.Close();
    ...
    private void PageStatus()
    {
        ...
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select EntryStatus,LockStatus from [Visit1].[VitalSigns] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt1);
        if (dt1.Rows.Count > 0)
        {
    ...
    public void OnConfirm(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select EntryStatus from [Visit1].[VitalSigns] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt2);
        if (dt2.Rows.Count > 0)
        {
            ...
            if (dt2.Rows[0]["EntryStatus"].ToString() == "Save")
            {
                ...
                {
                    con.Close();
                    cmd = new SqlCommand("[Visit1].[sp_VitalSigns]", con);
            ...
            if (dt2.Rows[0]["EntryStatus"].ToString() == "Submit")
            {
                ...
                if (confirmValue == "Yes")
                {
                    ...
                    DataTable dt1 = new DataTable();
                    con.Open();
                    sqlCmd = new SqlCommand("SELECT ActivefLag FROM [Visit1].[VitalSigns] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "' and (ActivefLag='0' or ActivefLag='1')", con);
                    ...
                    if (dt1.Rows.Count > 0)
                    {
                        ...
                        {
                            if (ViewState["txt1"].ToString() != TextBoxVSDRV.Text || ViewState["txt2"].ToString() != TextBoxVSTRV.Text || ViewState["txt3"].ToString() != TextBoxVSSBP.Text || ViewState["txt4"].ToString() != TextBoxVSSBPU.Text || ViewState["txt5"].ToString() != RadioButtonListVSSBPI.SelectedValue || ViewState["txt6"].ToString() != RadioButtonListVSSBPCS.SelectedValue || ViewState["txt7"].ToString() != TextBoxVSDBP.Text || ViewState["txt8"].ToString() != TextBoxVSDBPU.Text || ViewState["txt9"].ToString() != RadioButtonListVSDBPI.SelectedValue || ViewState["txt10"].ToString() != RadioButtonListVSDBPCS.SelectedValue || ViewState["txt11"].ToString() != TextBoxVSPR.Text || ViewState["txt12"].ToString() != TextBoxVSPRU.Text || ViewState["txt13"].ToString() != RadioButtonListVSPRI.SelectedValue || ViewState["txt14"].ToString() != RadioButtonListVSPRCS.SelectedValue || ViewState["txt15"].ToString() != TextBoxVSRR.Text || ViewState["txt16"].ToString() != TextBoxVSRRU.Text || ViewState["txt17"].ToString() != RadioButtonListVSRRI.SelectedValue || ViewState["txt18"].ToString() != RadioButtonListVSRRCS.SelectedValue || ViewState["txt19"].ToString() != TextBoxVSTMP.Text || ViewState["txt20"].ToString() != TextBoxVSTMPU.Text || ViewState["txt21"].ToString() != RadioButtonListVSTMPI.SelectedValue || ViewState["txt22"].ToString() != RadioButtonListVSTMPCS.SelectedValue)
                            {
    ...
    private DataTable AddRow()
    {
        ...
        if (!string.IsNullOrEmpty(TextBoxVSDRV.Text) || !string.IsNullOrEmpty(TextBoxVSTRV.Text) || !string.IsNullOrEmpty(TextBoxVSSBP.Text) || !string.IsNullOrEmpty(TextBoxVSSBPU.Text) || !string.IsNullOrEmpty(RadioButtonListVSSBPI.SelectedValue) || !string.IsNullOrEmpty(RadioButtonListVSSBPCS.SelectedValue) || !string.IsNullOrEmpty(TextBoxVSDBP.Text) || !string.IsNullOrEmpty(TextBoxVSDBPU.Text) || !string.IsNullOrEmpty(RadioButtonListVSDBPI.SelectedValue) || !string.IsNullOrEmpty(RadioButtonListVSDBPCS.SelectedValue) || !string.IsNullOrEmpty(TextBoxVSPR.Text) || !string.IsNullOrEmpty(TextBoxVSPRU.Text) || !string.IsNullOrEmpty(RadioButtonListVSPRI.SelectedValue) || !string.IsNullOrEmpty(RadioButtonListVSPRCS.SelectedValue) || !string.IsNullOrEmpty(TextBoxVSRR.Text) || !string.IsNullOrEmpty(TextBoxVSRRU.Text) || !string.IsNullOrEmpty(RadioButtonListVSRRI.SelectedValue) || !string.IsNullOrEmpty(RadioButtonListVSRRCS.SelectedValue) || !string.IsNullOrEmpty(TextBoxVSTMP.Text) || !string.IsNullOrEmpty(TextBoxVSTMPU.Text) || !string.IsNullOrEmpty(RadioButtonListVSTMPI.SelectedValue) || !string.IsNullOrEmpty(RadioButtonListVSTMPCS.SelectedValue))
        {
            ...
            if (ViewState["txt1"].ToString() !=  TextBoxVSDRV.Text)
            {
            ...
            if (ViewState["txt2"].ToString() !=  TextBoxVSTRV.Text)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt3"].ToString() !=  TextBoxVSSBP.Text)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt4"].ToString() !=  TextBoxVSSBPU.Text)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt5"].ToString() !=  RadioButtonListVSSBPI.SelectedValue)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt6"].ToString() !=  RadioButtonListVSSBPCS.SelectedValue)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt7"].ToString() !=  TextBoxVSDBP.Text)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt8"].ToString() !=  TextBoxVSDBPU.Text)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt9"].ToString() !=  RadioButtonListVSDBPI.SelectedValue)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt10"].ToString() != RadioButtonListVSDBPCS.SelectedValue)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt11"].ToString() != TextBoxVSPR.Text)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt12"].ToString() != TextBoxVSPRU.Text)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt13"].ToString() != RadioButtonListVSPRI.SelectedValue)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt14"].ToString() != RadioButtonListVSPRCS.SelectedValue)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt15"].ToString() != TextBoxVSRR.Text)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt16"].ToString() != TextBoxVSRRU.Text)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt17"].ToString() != RadioButtonListVSRRI.SelectedValue)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt18"].ToString() != RadioButtonListVSRRCS.SelectedValue)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt19"].ToString() != TextBoxVSTMP.Text)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt20"].ToString() != TextBoxVSTMPU.Text)
            {
                DataRow dtrow = dtEmp.NewRow();
            ...
            if (ViewState["txt21"].ToString() != RadioButtonListVSTMPI.SelectedValue)
            {
                DataRow dtrow = dtEmp.NewRow(); 
            ...
            if (ViewState["txt22"].ToString() != RadioButtonListVSTMPCS.SelectedValue)
            {
                DataRow dtrow = dtEmp.NewRow();
    ...
    protected void ImageQueryVSDRV_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[VitalSigns] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and VSDRV = '" + TextBoxVSDRV.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseVSDRV_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[VitalSigns] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and VSDRV = '" + TextBoxVSDRV.Text + "'", con1);
    ...
    protected void ImageQueryVSTRV_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[VitalSigns] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and VSTRV = '" + TextBoxVSTRV.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseVSTRV_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[VitalSigns] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and VSTRV = '" + TextBoxVSTRV.Text + "'", con1);
    ...
    protected void ImageQueryVSSBP_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[VitalSigns] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and VSSBP = '" + TextBoxVSSBP.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseVSSBP_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[VitalSigns] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and VSSBP = '" + TextBoxVSSBP.Text + "'", con1);
    ...
    protected void ImageQueryVSDBP_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[VitalSigns] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and VSDBP = '" + TextBoxVSDBP.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseVSDBP_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[VitalSigns] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and VSDBP = '" + TextBoxVSDBP.Text + "'", con1);
    ...
    protected void ImageQueryVSPR_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[VitalSigns] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and VSPR = '" + TextBoxVSPR.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseVSPR_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[VitalSigns] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and VSPR = '" + TextBoxVSPR.Text + "'", con1);
    ...
    protected void ImageQueryVSRR_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[VitalSigns] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and VSRR = '" + TextBoxVSRR.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseVSRR_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[VitalSigns] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and VSRR = '" + TextBoxVSRR.Text + "'", con1);
    ...
    protected void ImageQueryVSTMP_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[VitalSigns] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and VSTMP = '" + TextBoxVSTMP.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseVSTMP_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[VitalSigns] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and VSTMP = '" + TextBoxVSTMP.Text + "'", con1);
