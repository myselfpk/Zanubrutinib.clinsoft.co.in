<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VitalSigns.aspx.cs" Inherits="Data_Entry_Visit1_VitalSigns" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Data Entry | Visit 1 | Vital Signs</title>
                                    ...
                                    <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxVSDRV" runat="server" class="form-control" onkeydown="return false" Height="45px" Width="350px" placeholder="DD-MMM-YYYY" ValidationGroup="IC" MaxLength="11"></asp:TextBox>
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td align="center" class="auto-style2">
                                                ...
                                                <asp:TextBox ID="TextBoxVSTRV" runat="server" class="form-control" Height="45px" Width="350px" placeholder="[HH]:[MM]" ValidationGroup="IC" MaxLength="5"></asp:TextBox>
