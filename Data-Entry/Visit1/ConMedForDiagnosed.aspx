<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ConMedForDiagnosed.aspx.cs" Inherits="Data_Entry_Visit1_ConMedForDiagnosed" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Data Entry | Visit 1 | Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL)</title>
    ...
    <script type="text/javascript">
        function Confirm() {
            ...
            if (validated) {
                ...
                if (confirm("Do you want to Submit Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) page?")) {
    ...
    <script type="text/javascript">
        function Confirm1() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to Save Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) page?")) {
            ...
            <div class="page-title">
                <div>
                    <h1><i class="fa fa-edit"></i>
                        <asp:Label runat="server" ID="lblPage">Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL)</asp:Label></h1>
...
<asp:Label runat="server" ID="lblPDM5ED" Text="Stop Date Row 5" Visible="false"></asp:Label>
    ...
    <!-- Query Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 1: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 1:" ID="RAISEPDM1MN" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 1:" ID="RAISEPDM1MNMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEPDM1MNMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel3" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 1 Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 2: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 2:" ID="RAISEPDM2MN" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 2:" ID="RAISEPDM2MNMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEPDM2MNMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 2 Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 3: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 3:" ID="RAISEPDM3MN" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 3:" ID="RAISEPDM3MNMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEPDM3MNMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel2" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 3 Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 4: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 4:" ID="RAISEPDM4MN" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 4:" ID="RAISEPDM4MNMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEPDM4MNMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel4" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 4 Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 5: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 5:" ID="RAISEPDM5MN" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 5:" ID="RAISEPDM5MNMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEPDM5MNMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel5" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Prior And Concomitant Medication (For Diagnosed MCL/ CLL/ WM/ MZL/ FL) Details Row 5 Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
