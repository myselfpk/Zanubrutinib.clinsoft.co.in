...
public partial class Data_Entry_Visit6_ConcomitantMedication : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (RadioButtonListCONMED.SelectedValue == "Yes")
        {
            hideCDM.Visible = true;
        }
        else
        {
            hideCDM.Visible = false;
        }
    }
    ...
    private void BindPage()
    {
        con.Close();
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select CONMED from [Visit6].[ConcomitantMedication] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt);
        if (dt.Rows.Count > 0)
        {
            RadioButtonListCONMED.SelectedValue = dt.Rows[0]["CONMED"].ToString().Trim();


            ViewState["txt1"] = RadioButtonListCONMED.SelectedValue;
        }
        con.Close();
    ...
    private void PageStatus()
    {
        ...
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select EntryStatus,LockStatus from [Visit6].[ConcomitantMedication] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt1);
        if (dt1.Rows.Count > 0)
        {
    ...
    public void OnConfirm(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select EntryStatus from [Visit6].[ConcomitantMedication] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt2);
        if (dt2.Rows.Count > 0)
        {
            ...
            if (dt2.Rows[0]["EntryStatus"].ToString() == "Save")
            {
                ...
                {
                    con.Close();
                    cmd = new SqlCommand("[Visit6].[sp_ConcomitantMedication]", con);
                    ...
                    cmd.Parameters.AddWithValue("@CONMED", RadioButtonListCONMED.SelectedValue);
            ...
            if (dt2.Rows[0]["EntryStatus"].ToString() == "Submit")
            {
                ...
                if (confirmValue == "Yes")
                {
                    ...
                    DataTable dt1 = new DataTable();
                    con.Open();
                    sqlCmd = new SqlCommand("SELECT ActivefLag FROM [Visit6].[ConcomitantMedication] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "' and (ActivefLag='0' or ActivefLag='1')", con);
                    ...
                    if (dt1.Rows.Count > 0)
                    {
                        ...
                        {
                            if (ViewState["txt1"].ToString() != RadioButtonListCONMED.SelectedValue)
                            {
    ...
    private DataTable AddRow()
    {
        ...
        if (!string.IsNullOrEmpty(RadioButtonListCONMED.SelectedValue))
        {
            DataTable dt1 = new DataTable();
            ...
            if (ViewState["txt1"].ToString() !=  RadioButtonListCONMED.SelectedValue)
            {
                ...
                dtrow["Column"] = lblCONMED.Text;
                dtrow["OldValue"] = dt1.Rows[0][0];
                dtrow["NewValue"] = RadioButtonListCONMED.SelectedValue;
    ...
    #region Query
    #region QueryCONMED
    private void SetImageQueryCONMED()
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select top 1 * from tblQuery where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'and Field = '" + lblCONMED.Text + "' order by ID desc", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryCONMED.ImageUrl = "~/Data-Entry/Images/red.png";
            ...
            {
                ImageQueryCONMED.ImageUrl = "~/Data-Entry/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryCONMED.ImageUrl = "~/Data-Entry/Images/Yellow.png";

            }
            else
            {
                ImageQueryCONMED.ImageUrl = "~/Data-Entry/Images/Blue.jpg";
    ...
    private void BindQueryDataCONMED()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                LabelRaiseCONMED.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                PanelRaiseCONMED.Visible = true;
                PanelRaiseCONMED2.Visible = false;
                PanelRaiseCONMED3.Visible = false;
                PanelHideCONMED.Visible = true;

            }
            else if (dr["Status"].ToString() == "Close")
            {
                LabelRaiseCONMED.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                LabelRaiseCONMED2.Text = "<b>" + "Query Resolved by: " + "</b>" + dr["Username2"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Reply: " + "</b>" + dr["QueryResponse"].ToString() + "" + "<br />" + "<b>";
                LabelRaiseCONMED3.Text = "<b>" + "Query closed by: " + "</b>" + dr["Username3"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Closed Remarks: " + "</b>" + dr["QueryResponse3"].ToString();
                PanelRaiseCONMED.Visible = true;
                PanelRaiseCONMED2.Visible = true;
                PanelRaiseCONMED3.Visible = true;
                PanelHideCONMED.Visible = false;
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                LabelRaiseCONMED.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
    ...
    protected void ImageQueryCONMED_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[ConcomitantMedication] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and CONMED = '" + RadioButtonListCONMED.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQueryCONMED.ImageUrl == "~/Data-Entry/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISECONMED.Visible = true;
                RAISECONMED.ShowPopupWindow();
                QueryRaiseCONMED.Visible = false;
                TextBoxRaiseCONMED.Visible = false;
                PanelRaiseCONMED.Visible = false;
                PanelRaiseCONMED2.Visible = false;
                PanelRaiseCONMED3.Visible = false;

                LabelRespondCONMED.Visible = false;
            }

            else if ((ImageQueryCONMED.ImageUrl == "~/Data-Entry/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECONMED.Visible = true;
                RAISECONMED.ShowPopupWindow();
                QueryRaiseCONMED.Visible = true;
                TextBoxRaiseCONMED.Visible = true;
                PanelRaiseCONMED.Visible = true;
                PanelRaiseCONMED2.Visible = false;
                PanelRaiseCONMED3.Visible = false;
                LabelRespondCONMED.Visible = true;
            }

            else if ((ImageQueryCONMED.ImageUrl == "~/Data-Entry/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECONMED.Visible = true;
                RAISECONMED.ShowPopupWindow();
                QueryRaiseCONMED.Visible = false;
            ...
            else if ((ImageQueryCONMED.ImageUrl == "~/Data-Entry/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECONMED.Visible = true;
                RAISECONMED.ShowPopupWindow();
                QueryRaiseCONMED.Visible = false;
    ...
    protected void QueryRaiseCONMED_Click(object sender, EventArgs e)
    {
        con.Close();
        con.Open();
        con1.Open();

        cmd = new SqlCommand("Update tblQuery set QueryResponse = '" + TextBoxRaiseCONMED.Text + "', Status ='Query Responded', Username2 ='" + LabelUserName.Text + "', Date2 ='" + DateTime.Today.ToString("dd-MMM-yyyy") + "' where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'and Field = '" + lblCONMED.Text + "' and QueryResponse IN (Select top 1 QueryResponse from tblQuery  where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'and Field = '" + lblCONMED.Text + "' order by ID desc)", con);

        cmd1 = new SqlCommand("Update [Visit6].[ConcomitantMedication] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and CONMED = '" + RadioButtonListCONMED.SelectedValue + "'", con1);
        ...
        RAISECONMEDMSG.ShowPopupWindow();
        RAISECONMED.Visible = false;
    ...
    protected void RadioButtonListCONMED_SelectedIndexChanged(object sender, EventArgs e)
    {
        if(RadioButtonListCONMED.SelectedValue == "Yes")
        {
            hideCDM.Visible = true;
