...
public partial class Data_Entry_Visit6_HRQoL_Questionnaire : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    private void PageStatus()
    {
        ...
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select EntryStatus,LockStatus from [Visit6].[HRQoL_Questionnaire] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt1);
        if (dt1.Rows.Count > 0)
        {
    ...
    public void OnConfirm(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select EntryStatus from [Visit6].[HRQoL_Questionnaire] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt2);
        if (dt2.Rows.Count > 0)
        {
            ...
            if (dt2.Rows[0]["EntryStatus"].ToString() == "Save")
            {
                ...
                {
                    con.Close();
                    cmd = new SqlCommand("[Visit6].[sp_HRQoL_Questionnaire]", con);
            ...
            if (dt2.Rows[0]["EntryStatus"].ToString() == "Submit")
            {
                ...
                if (confirmValue == "Yes")
                {
                    ...
                    DataTable dt1 = new DataTable();
                    con.Open();
                    sqlCmd = new SqlCommand("SELECT ActivefLag FROM [Visit6].[HRQoL_Questionnaire] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "' and (ActivefLag='0' or ActivefLag='1')", con);
    ...
    protected void ImageQueryHRPER_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HRPER = '" + RadioButtonListHRPER.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHRPER_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HRPER = '" + RadioButtonListHRPER.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR1OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR1OPT = '" + RadioButtonListHR1OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR1OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR1OPT = '" + RadioButtonListHR1OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR2OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR2OPT = '" + RadioButtonListHR2OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR2OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR2OPT = '" + RadioButtonListHR2OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR3OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR3OPT = '" + RadioButtonListHR3OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR3OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR3OPT = '" + RadioButtonListHR3OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR4OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR4OPT = '" + RadioButtonListHR4OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR4OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR4OPT = '" + RadioButtonListHR4OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR5OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR5OPT = '" + RadioButtonListHR5OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR5OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR5OPT = '" + RadioButtonListHR5OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR6OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR6OPT = '" + RadioButtonListHR6OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR6OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR6OPT = '" + RadioButtonListHR6OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR7OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR7OPT = '" + RadioButtonListHR7OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR7OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR7OPT = '" + RadioButtonListHR7OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR8OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR8OPT = '" + RadioButtonListHR8OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR8OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR8OPT = '" + RadioButtonListHR8OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR9OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR9OPT = '" + RadioButtonListHR9OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR9OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR9OPT = '" + RadioButtonListHR9OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR10OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR10OPT = '" + RadioButtonListHR10OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR10OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR10OPT = '" + RadioButtonListHR10OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR11OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR11OPT = '" + RadioButtonListHR11OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR11OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR11OPT = '" + RadioButtonListHR11OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR12OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR12OPT = '" + RadioButtonListHR12OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR12OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR12OPT = '" + RadioButtonListHR12OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR13OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR13OPT = '" + RadioButtonListHR13OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR13OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR13OPT = '" + RadioButtonListHR13OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR14OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR14OPT = '" + RadioButtonListHR14OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR14OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR14OPT = '" + RadioButtonListHR14OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR15OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR15OPT = '" + RadioButtonListHR15OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR15OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR15OPT = '" + RadioButtonListHR15OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR16OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR16OPT = '" + RadioButtonListHR16OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR16OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR16OPT = '" + RadioButtonListHR16OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR17OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR17OPT = '" + RadioButtonListHR17OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR17OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR17OPT = '" + RadioButtonListHR17OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR18OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR18OPT = '" + RadioButtonListHR18OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR18OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR18OPT = '" + RadioButtonListHR18OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR19OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR19OPT = '" + RadioButtonListHR19OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR19OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR19OPT = '" + RadioButtonListHR19OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR20OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR20OPT = '" + RadioButtonListHR20OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR20OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR20OPT = '" + RadioButtonListHR20OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR21OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR21OPT = '" + RadioButtonListHR21OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR21OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR21OPT = '" + RadioButtonListHR21OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR22OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR22OPT = '" + RadioButtonListHR22OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR22OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR22OPT = '" + RadioButtonListHR22OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR23OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR23OPT = '" + RadioButtonListHR23OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR23OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR23OPT = '" + RadioButtonListHR23OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR24OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR24OPT = '" + RadioButtonListHR24OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR24OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR24OPT = '" + RadioButtonListHR24OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR25OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR25OPT = '" + RadioButtonListHR25OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR25OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR25OPT = '" + RadioButtonListHR25OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR26OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR26OPT = '" + RadioButtonListHR26OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR26OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR26OPT = '" + RadioButtonListHR26OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR27OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR27OPT = '" + RadioButtonListHR27OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR27OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR27OPT = '" + RadioButtonListHR27OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR28OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR28OPT = '" + RadioButtonListHR28OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR28OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR28OPT = '" + RadioButtonListHR28OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR29OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR29OPT = '" + RadioButtonListHR29OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR29OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR29OPT = '" + RadioButtonListHR29OPT.SelectedValue + "'", con1);
    ...
    protected void ImageQueryHR30OPT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit6].[HRQoL_Questionnaire] where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR30OPT = '" + RadioButtonListHR30OPT.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
    ...
    protected void QueryRaiseHR30OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit6].[HRQoL_Questionnaire] set  QueryStatus = 'Query Responded'  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and HR30OPT = '" + RadioButtonListHR30OPT.SelectedValue + "'", con1);
