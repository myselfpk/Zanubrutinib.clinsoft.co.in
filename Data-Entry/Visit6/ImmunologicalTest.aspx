<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ImmunologicalTest.aspx.cs" Inherits="Data_Entry_Visit6_ImmunologicalTest" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Data Entry | Visit 6 | Immunological Test</title>
    ...
    <script type="text/javascript">
        function Confirm() {
            ...
            if (validated) {
                ...
                if (confirm("Do you want to Submit Immunological Test page?")) {
    ...
    <script type="text/javascript">
        function Confirm1() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to Save Immunological Test page?")) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
            ...
            <div class="page-title">
                <div>
                    <h1><i class="fa fa-edit"></i>
                        <asp:Label runat="server" ID="lblPage">Immunological Test</asp:Label><span> (Only for WM patients)</span></h1>
                                ...
                                <div class="text-center">
                                    ...
                                    <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                        ...
                                        <tr class="auto-style2">
                                            <td>
                                                <asp:Label runat="server" ID="lblIGMPER">Was IgM test performed for WM patient?</asp:Label>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorIGMPER" runat="server"
                                                    CssClass="Validators" Display="None" ErrorMessage="please mention Was IgM test performed for WM patient?"
                                                    ControlToValidate="RadioButtonListIGMPER"
                                                    ValidationGroup="IC"></asp:RequiredFieldValidator>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="RadioButtonListIGMPER" class="form-control" Height="45px" Width="90%" runat="server" ValidationGroup="IC" AutoPostBack="true" OnSelectedIndexChanged="RadioButtonListIGMPER_SelectedIndexChanged">
                                            ...
                                            <td>
                                                <asp:ImageButton ID="ImageQueryIGMPER" Height="25px" Width="25px" runat="server" OnClick="ImageQueryIGMPER_Click" />
                                            </td>
                                        </tr>
                                        <tr class="auto-style2" id="hideIGMRSLT" runat="server" visible="false">
                                            <td>
                                                <asp:Label runat="server" ID="lblIGMRSLT">Results (mg/dL)</asp:Label>

                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server"
                                                    CssClass="Validators" Display="None" ErrorMessage="Please mention Results (mg/dL)." ControlToValidate="TextBoxIGMRSLT"
                                                    ValidationGroup="IC"></asp:RequiredFieldValidator>

                                            </td>
                                            <td>
                                                <asp:TextBox ID="TextBoxIGMRSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:ImageButton ID="ImageQueryIGMRSLT" Height="25px" Width="25px" runat="server" OnClick="ImageQueryIGMRSLT_Click" /></td>
                                        </tr>
                                        <tr class="auto-style2" id="hideIGMRSN" runat="server" visible="false">
                                            <td>
                                                <asp:Label runat="server" ID="lblIGMRSN">Reason</asp:Label>

                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server"
                                                    CssClass="Validators" Display="None" ErrorMessage="Please mention Reason." ControlToValidate="TextBoxIGMRSN"
                                                    ValidationGroup="IC"></asp:RequiredFieldValidator>

                                            </td>
                                            <td>
                                                <asp:TextBox ID="TextBoxIGMRSN" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:ImageButton ID="ImageQueryIGMRSN" Height="25px" Width="25px" runat="server" OnClick="ImageQueryIGMRSN_Click" /></td>
                                        </tr>
    ...
    <!-- Query Was IgM test performed for WM patient?: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Was IgM test performed for WM patient?:" ID="RAISEIGMPER" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEIGMPER" runat="server">
                    <div align="left" style="width: 300px">
                        <asp:Panel ID="PanelRaiseIGMPER" runat="server" BorderStyle="Solid" BackColor="Red">
                            <asp:Label ID="LabelRaiseIGMPER" runat="server"> </asp:Label><br />
                        </asp:Panel>

                        <asp:Panel ID="PanelRaiseIGMPER2" runat="server" BorderStyle="Solid" BackColor="Yellow">
                            <asp:Label ID="LabelRaiseIGMPER2" runat="server"> </asp:Label><br />
                        </asp:Panel>

                        <asp:Panel ID="PanelRaiseIGMPER3" runat="server" BorderStyle="Solid" BackColor="#009933">
                            <asp:Label ID="LabelRaiseIGMPER3" runat="server"> </asp:Label><br />
                        </asp:Panel>
                        <asp:Panel ID="PanelHideIGMPER" runat="server" Visible="false">
                            <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                <colgroup>
                                ...
                                <tr class="auto-style2">
                                    <td>
                                        <asp:Label ID="LabelRespondIGMPER" runat="server" Text="Query Response"> </asp:Label>

                                    </td>
                                    <td>
                                        <center>
                                            <asp:TextBox ID="TextBoxRaiseIGMPER" class="form-control" runat="server" Height="50" Width="150" ValidationGroup="IC"
                                                TextMode="MultiLine">
                                            </asp:TextBox>

                                        </center>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" BackColor="Red" runat="server" ErrorMessage="*"
                                            ControlToValidate="TextBoxRaiseIGMPER" ValidationGroup="IC"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <center>
                                            <asp:Button ID="QueryRaiseIGMPER" class="btn btn-primary icon-btn" runat="server" Text="Respond Query" ValidationGroup="IC"
                                                OnClick="QueryRaiseIGMPER_Click" />
                                        </center>
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Was IgM test performed for WM patient?:" ID="RAISEIGMPERMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEIGMPERMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel3" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Was IgM test performed for WM patient? Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Results (mg/dL): -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Results (mg/dL):" ID="RAISEIGMRSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEIGMRSLT" runat="server">
                    <div align="left" style="width: 300px">
                        <asp:Panel ID="PanelRaiseIGMRSLT" runat="server" BorderStyle="Solid" BackColor="Red">
                            <asp:Label ID="LabelRaiseIGMRSLT" runat="server"> </asp:Label><br />
                        </asp:Panel>

                        <asp:Panel ID="PanelRaiseIGMRSLT2" runat="server" BorderStyle="Solid" BackColor="Yellow">
                            <asp:Label ID="LabelRaiseIGMRSLT2" runat="server"> </asp:Label><br />
                        </asp:Panel>

                        <asp:Panel ID="PanelRaiseIGMRSLT3" runat="server" BorderStyle="Solid" BackColor="#009933">
                            <asp:Label ID="LabelRaiseIGMRSLT3" runat="server"> </asp:Label><br />
                        </asp:Panel>
                        <asp:Panel ID="PanelHideIGMRSLT" runat="server" Visible="false">
                            <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                <colgroup>
                                ...
                                <tr class="auto-style2">
                                    <td>
                                        <asp:Label ID="LabelRespondIGMRSLT" runat="server" Text="Query Response"> </asp:Label>

                                    </td>
                                    <td>
                                        <center>
                                            <asp:TextBox ID="TextBoxRaiseIGMRSLT" class="form-control" runat="server" Height="50" Width="150" ValidationGroup="IC"
                                                TextMode="MultiLine">
                                            </asp:TextBox>

                                        </center>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" BackColor="Red" runat="server" ErrorMessage="*"
                                            ControlToValidate="TextBoxRaiseIGMRSLT" ValidationGroup="IC"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <center>
                                            <asp:Button ID="QueryRaiseIGMRSLT" class="btn btn-primary icon-btn" runat="server" Text="Respond Query" ValidationGroup="IC"
                                                OnClick="QueryRaiseIGMRSLT_Click" />
                                        </center>
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Results (mg/dL):" ID="RAISEIGMRSLTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEIGMRSLTMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Results (mg/dL) Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Reason: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Reason:" ID="RAISEIGMRSN" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEIGMRSN" runat="server">
                    <div align="left" style="width: 300px">
                        <asp:Panel ID="PanelRaiseIGMRSN" runat="server" BorderStyle="Solid" BackColor="Red">
                            <asp:Label ID="LabelRaiseIGMRSN" runat="server"> </asp:Label><br />
                        </asp:Panel>

                        <asp:Panel ID="PanelRaiseIGMRSN2" runat="server" BorderStyle="Solid" BackColor="Yellow">
                            <asp:Label ID="LabelRaiseIGMRSN2" runat="server"> </asp:Label><br />
                        </asp:Panel>

                        <asp:Panel ID="PanelRaiseIGMRSN3" runat="server" BorderStyle="Solid" BackColor="#009933">
                            <asp:Label ID="LabelRaiseIGMRSN3" runat="server"> </asp:Label><br />
                        </asp:Panel>
                        <asp:Panel ID="PanelHideIGMRSN" runat="server" Visible="false">
                            <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                <colgroup>
                                ...
                                <tr class="auto-style2">
                                    <td>
                                        <asp:Label ID="LabelRespondIGMRSN" runat="server" Text="Query Response"> </asp:Label>

                                    </td>
                                    <td>
                                        <center>
                                            <asp:TextBox ID="TextBoxRaiseIGMRSN" class="form-control" runat="server" Height="50" Width="150" ValidationGroup="IC"
                                                TextMode="MultiLine">
                                            </asp:TextBox>

                                        </center>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" BackColor="Red" runat="server" ErrorMessage="*"
                                            ControlToValidate="TextBoxRaiseIGMRSN" ValidationGroup="IC"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <center>
                                            <asp:Button ID="QueryRaiseIGMRSN" class="btn btn-primary icon-btn" runat="server" Text="Respond Query" ValidationGroup="IC"
                                                OnClick="QueryRaiseIGMRSN_Click" />
                                        </center>
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Reason:" ID="RAISEIGMRSNMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEIGMRSNMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
