<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SubjectDiaryRetrieval.aspx.cs" Inherits="Data_Entry_Visit9_SubjectDiaryRetrieval" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Data Entry | Visit 9 | Subject Diary Retrieval</title>
    ...
    <script type="text/javascript">
        function Confirm() {
            ...
            if (validated) {
                ...
                if (confirm("Do you want to Submit Subject Diary Retrieval page?")) {
    ...
    <script type="text/javascript">
        function Confirm1() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to Save Subject Diary Retrieval page?")) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
            ...
            <div class="page-title">
                <div>
                    <h1><i class="fa fa-edit"></i>
                        <asp:Label runat="server" ID="lblPage">Subject Diary Retrieval</asp:Label></h1>
                                ...
                                <div class="text-center">
                                    ...
                                    <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                        ...
                                        <tr class="auto-style2">
                                            <td>
                                                <asp:Label runat="server" ID="lblSDRLPER">Has the Study diary been retrieved by the site staff during the visit?</asp:Label>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorSDRLPER" runat="server"
                                                    CssClass="Validators" Display="None" ErrorMessage="please mention Has the Study diary been retrieved by the site staff during the visit?"
                                                    ControlToValidate="RadioButtonListSDRLPER"
                                                    ValidationGroup="IC"></asp:RequiredFieldValidator>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="RadioButtonListSDRLPER" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC">
                                            ...
                                            <td>
                                                <asp:ImageButton ID="ImageQuerySDRLPER" Height="25px" Width="25px" runat="server" OnClick="ImageQuerySDRLPER_Click" />
                                            </td>
                                        </tr>
    ...
    <!-- Query Has the Study diary been retrieved by the site staff during the visit?: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Has the Study diary been retrieved by the site staff during the visit?:" ID="RAISESDRLPER" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESDRLPER" runat="server">
                    <div align="left" style="width: 300px">
                        <asp:Panel ID="PanelRaiseSDRLPER" runat="server" BorderStyle="Solid" BackColor="Red">
                            <asp:Label ID="LabelRaiseSDRLPER" runat="server"> </asp:Label><br />
                        </asp:Panel>

                        <asp:Panel ID="PanelRaiseSDRLPER2" runat="server" BorderStyle="Solid" BackColor="Yellow">
                            <asp:Label ID="LabelRaiseSDRLPER2" runat="server"> </asp:Label><br />
                        </asp:Panel>

                        <asp:Panel ID="PanelRaiseSDRLPER3" runat="server" BorderStyle="Solid" BackColor="#009933">
                            <asp:Label ID="LabelRaiseSDRLPER3" runat="server"> </asp:Label><br />
                        </asp:Panel>
                        <asp:Panel ID="PanelHideSDRLPER" runat="server" Visible="false">
                            <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                <colgroup>
                                ...
                                <tr class="auto-style2">
                                    <td>
                                        <asp:Label ID="LabelRespondSDRLPER" runat="server" Text="Query Response"> </asp:Label>

                                    </td>
                                    <td>
                                        <center>
                                            <asp:TextBox ID="TextBoxRaiseSDRLPER" class="form-control" runat="server" Height="50" Width="150" ValidationGroup="IC"
                                                TextMode="MultiLine">
                                            </asp:TextBox>

                                        </center>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" BackColor="Red" runat="server" ErrorMessage="*"
                                            ControlToValidate="TextBoxRaiseSDRLPER" ValidationGroup="IC"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <center>
                                            <asp:Button ID="QueryRaiseSDRLPER" class="btn btn-primary icon-btn" runat="server" Text="Respond Query" ValidationGroup="IC"
                                                OnClick="QueryRaiseSDRLPER_Click" />
                                        </center>
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Has the Study diary been retrieved by the site staff during the visit?:" ID="RAISESDRLPERMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESDRLPERMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel3" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Has the Study diary been retrieved by the site staff during the visit? Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
