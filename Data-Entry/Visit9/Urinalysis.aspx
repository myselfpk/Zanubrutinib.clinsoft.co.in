<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Urinalysis.aspx.cs" Inherits="Data_Entry_Visit9_Urinalysis" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Data Entry | Visit 9 | Urinalysis</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <asp:ImageButton ID="AttachmentPageHistory" Height="25px" Width="25px" runat="server" OnClick="AttachmentPageHistory_Click" />
                                    ...
                                    <asp:Panel ID="hideURI" runat="server" Visible="false">
                                        <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                            <colgroup>
                                            ...
                                            <tr class="auto-style2">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListNAB18OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" AutoPostBack="true" OnSelectedIndexChanged="RadioButtonListNAB18OPT_SelectedIndexChanged">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>Normal</asp:ListItem>
                                                        <asp:ListItem>Abnormal</asp:ListItem>
                                                    </asp:DropDownList>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListABN18OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" Visible="false">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>CS</asp:ListItem>
                                                        <asp:ListItem>NCS</asp:ListItem>
                                                    </asp:DropDownList>
                                            ...
                                            <tr class="auto-style2">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListNAB19OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" AutoPostBack="true" OnSelectedIndexChanged="RadioButtonListNAB19OPT_SelectedIndexChanged">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>Normal</asp:ListItem>
                                                        <asp:ListItem>Abnormal</asp:ListItem>
                                                    </asp:DropDownList>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListABN19OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" Visible="false">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>CS</asp:ListItem>
                                                        <asp:ListItem>NCS</asp:ListItem>
                                                    </asp:DropDownList>
                                            ...
                                            <tr class="auto-style2">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListNAB20OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" AutoPostBack="true" OnSelectedIndexChanged="RadioButtonListNAB20OPT_SelectedIndexChanged">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>Normal</asp:ListItem>
                                                        <asp:ListItem>Abnormal</asp:ListItem>
                                                    </asp:DropDownList>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListABN20OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" Visible="false">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>CS</asp:ListItem>
                                                        <asp:ListItem>NCS</asp:ListItem>
                                                    </asp:DropDownList>
                                            ...
                                            <tr class="auto-style2">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListNAB21OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" AutoPostBack="true" OnSelectedIndexChanged="RadioButtonListNAB21OPT_SelectedIndexChanged">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>Normal</asp:ListItem>
                                                        <asp:ListItem>Abnormal</asp:ListItem>
                                                    </asp:DropDownList>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListABN21OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" Visible="false">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>CS</asp:ListItem>
                                                        <asp:ListItem>NCS</asp:ListItem>
                                                    </asp:DropDownList>
                                            ...
                                            <tr class="auto-style2">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListNAB22OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" AutoPostBack="true" OnSelectedIndexChanged="RadioButtonListNAB22OPT_SelectedIndexChanged">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>Normal</asp:ListItem>
                                                        <asp:ListItem>Abnormal</asp:ListItem>
                                                    </asp:DropDownList>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="RadioButtonListABN22OPT" class="form-control" Height="45px" Width="95%" runat="server" ValidationGroup="IC" Visible="false">
                                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                                        <asp:ListItem>CS</asp:ListItem>
                                                        <asp:ListItem>NCS</asp:ListItem>
                                                    </asp:DropDownList>
