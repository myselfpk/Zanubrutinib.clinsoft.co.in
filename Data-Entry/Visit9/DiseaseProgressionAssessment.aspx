<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DiseaseProgressionAssessment.aspx.cs" Inherits="Data_Entry_Visit9_DiseaseProgressionAssessment" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Data Entry | Visit 9 | Disease Progression Assessment</title>
    ...
    <script type="text/javascript">
        function Confirm() {
            ...
            if (validated) {
                ...
                if (confirm("Do you want to Submit Disease Progression Assessment page?")) {
    ...
    <script type="text/javascript">
        function Confirm1() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to Save Disease Progression Assessment page?")) {
            ...
            <div class="page-title">
                <div>
                    <h1><i class="fa fa-edit"></i>
                        <asp:Label runat="server" ID="lblPage">Disease Progression Assessment</asp:Label></h1>
...
<asp:ImageButton ID="AttachmentPageHistory" Height="25px" Width="25px" runat="server" OnClick="AttachmentPageHistory_Click" />
                            ...
                            <tr class="auto-style2">
                                <td>
                                    <asp:Label runat="server" ID="lblDPASS">Did the subject experience any disease progression since last visit?</asp:Label>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorDPASS" runat="server"
                                        CssClass="Validators" Display="None" ErrorMessage="please mention Did the subject experience any disease progression since last visit?"
                                        ControlToValidate="RadioButtonListDPASS"
                                        ValidationGroup="IC"></asp:RequiredFieldValidator>
                                </td>
                                <td>
                                    <asp:DropDownList ID="RadioButtonListDPASS" class="form-control" Height="45px" Width="90%" runat="server" ValidationGroup="IC" AutoPostBack="true" OnSelectedIndexChanged="RadioButtonListDPASS_SelectedIndexChanged">
                                ...
                                <td>
                                    <asp:ImageButton ID="ImageQueryDPASS" Height="25px" Width="25px" runat="server" OnClick="ImageQueryDPASS_Click" />
                                </td>
                            </tr>
                            <tr class="auto-style2" id="hideDPC" runat="server" visible="false">
                                <td>
                                    <asp:Label runat="server" ID="lblDPC">How was the Disease progression confirmed?</asp:Label>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorDPC" runat="server"
                                        CssClass="Validators" Display="None" ErrorMessage="please mention How was the Disease progression confirmed?"
                                        ControlToValidate="RadioButtonListDPC"
                                        ValidationGroup="IC"></asp:RequiredFieldValidator>
                                </td>
                                <td>
                                    <asp:DropDownList ID="RadioButtonListDPC" class="form-control" Height="45px" Width="90%" runat="server" ValidationGroup="IC">
                                        <asp:ListItem Value="">Please Select Option</asp:ListItem>
                                        <asp:ListItem>Blood test</asp:ListItem>
                                        <asp:ListItem>Biopsy</asp:ListItem>
                                        <asp:ListItem>CT scan (Imaging)</asp:ListItem>
                                        <asp:ListItem>Clinical Progression assessed by Investigator</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    <asp:ImageButton ID="ImageQueryDPC" Height="25px" Width="25px" runat="server" OnClick="ImageQueryDPC_Click" />
                                </td>
                            </tr>
                            <tr class="auto-style2">
                                <td>
                                    <asp:Label runat="server" ID="lblDPSF">Specify findings</asp:Label>

                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"
                                        CssClass="Validators" Display="None" ErrorMessage="Please mention Specify findings." ControlToValidate="TextBoxDPSF"
                                        ValidationGroup="IC"></asp:RequiredFieldValidator>

                                </td>
                                <td>
                                    <asp:TextBox ID="TextBoxDPSF" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:ImageButton ID="ImageQueryDPSF" Height="25px" Width="25px" runat="server" OnClick="ImageQueryDPSF_Click" /></td>
                            </tr>

                            <tr class="auto-style4" id="hideDPA" runat="server" visible="false">
                                <td colspan="3">
                                    <asp:Label runat="server" ID="lblError">Please fill the details in the Adverse Event Log and treatment should be discontinued with the subject with further line of management as per PI discretion to be followed.</asp:Label>
                                ...
                                <tr>
                                    <td>
                                        <asp:GridView Width="100%" ID="GridView1" runat="server" AutoGenerateColumns="False"
                                            HorizontalAlign="Center" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Groove" BorderWidth="1px" CellPadding="3" CssClass="table table-bordered table-responsive tablehover">
    ...
    <!-- Query Did the subject experience any disease progression since last visit?: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Did the subject experience any disease progression since last visit?:" ID="RAISEDPASS" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEDPASS" runat="server">
                    <div align="left" style="width: 300px">
                        <asp:Panel ID="PanelRaiseDPASS" runat="server" BorderStyle="Solid" BackColor="Red">
                            <asp:Label ID="LabelRaiseDPASS" runat="server"> </asp:Label><br />
                        </asp:Panel>

                        <asp:Panel ID="PanelRaiseDPASS2" runat="server" BorderStyle="Solid" BackColor="Yellow">
                            <asp:Label ID="LabelRaiseDPASS2" runat="server"> </asp:Label><br />
                        </asp:Panel>

                        <asp:Panel ID="PanelRaiseDPASS3" runat="server" BorderStyle="Solid" BackColor="#009933">
                            <asp:Label ID="LabelRaiseDPASS3" runat="server"> </asp:Label><br />
                        </asp:Panel>
                        <asp:Panel ID="PanelHideDPASS" runat="server" Visible="false">
                            <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                <colgroup>
                                ...
                                <tr class="auto-style2">
                                    <td>
                                        <asp:Label ID="LabelRespondDPASS" runat="server" Text="Query Response"> </asp:Label>

                                    </td>
                                    <td>
                                        <center>
                                            <asp:TextBox ID="TextBoxRaiseDPASS" class="form-control" runat="server" Height="50" Width="150" ValidationGroup="IC"
                                                TextMode="MultiLine">
                                            </asp:TextBox>

                                        </center>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" BackColor="Red" runat="server" ErrorMessage="*"
                                            ControlToValidate="TextBoxRaiseDPASS" ValidationGroup="IC"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <center>
                                            <asp:Button ID="QueryRaiseDPASS" class="btn btn-primary icon-btn" runat="server" Text="Respond Query" ValidationGroup="IC"
                                                OnClick="QueryRaiseDPASS_Click" />
                                        </center>
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Did the subject experience any disease progression since last visit?:" ID="RAISEDPASSMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEDPASSMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel3" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Did the subject experience any disease progression since last visit? Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query How was the Disease progression confirmed?: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: How was the Disease progression confirmed?:" ID="RAISEDPC" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEDPC" runat="server">
                    <div align="left" style="width: 300px">
                        <asp:Panel ID="PanelRaiseDPC" runat="server" BorderStyle="Solid" BackColor="Red">
                            <asp:Label ID="LabelRaiseDPC" runat="server"> </asp:Label><br />
                        </asp:Panel>

                        <asp:Panel ID="PanelRaiseDPC2" runat="server" BorderStyle="Solid" BackColor="Yellow">
                            <asp:Label ID="LabelRaiseDPC2" runat="server"> </asp:Label><br />
                        </asp:Panel>

                        <asp:Panel ID="PanelRaiseDPC3" runat="server" BorderStyle="Solid" BackColor="#009933">
                            <asp:Label ID="LabelRaiseDPC3" runat="server"> </asp:Label><br />
                        </asp:Panel>
                        <asp:Panel ID="PanelHideDPC" runat="server" Visible="false">
                            <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                <colgroup>
                                ...
                                <tr class="auto-style2">
                                    <td>
                                        <asp:Label ID="LabelRespondDPC" runat="server" Text="Query Response"> </asp:Label>

                                    </td>
                                    <td>
                                        <center>
                                            <asp:TextBox ID="TextBoxRaiseDPC" class="form-control" runat="server" Height="50" Width="150" ValidationGroup="IC"
                                                TextMode="MultiLine">
                                            </asp:TextBox>

                                        </center>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" BackColor="Red" runat="server" ErrorMessage="*"
                                            ControlToValidate="TextBoxRaiseDPC" ValidationGroup="IC"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <center>
                                            <asp:Button ID="QueryRaiseDPC" class="btn btn-primary icon-btn" runat="server" Text="Respond Query" ValidationGroup="IC"
                                                OnClick="QueryRaiseDPC_Click" />
                                        </center>
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: How was the Disease progression confirmed?:" ID="RAISEDPCMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEDPCMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid">
                            Query has been Responded of the How was the Disease progression confirmed? Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <!-- Query Specify findings: -->
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Specify findings:" ID="RAISEDPSF" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEDPSF" runat="server">
                    <div align="left" style="width: 300px">
                        <asp:Panel ID="PanelRaiseDPSF" runat="server" BorderStyle="Solid" BackColor="Red">
                            <asp:Label ID="LabelRaiseDPSF" runat="server"> </asp:Label><br />
                        </asp:Panel>

                        <asp:Panel ID="PanelRaiseDPSF2" runat="server" BorderStyle="Solid" BackColor="Yellow">
                            <asp:Label ID="LabelRaiseDPSF2" runat="server"> </asp:Label><br />
                        </asp:Panel>

                        <asp:Panel ID="PanelRaiseDPSF3" runat="server" BorderStyle="Solid" BackColor="#009933">
                            <asp:Label ID="LabelRaiseDPSF3" runat="server"> </asp:Label><br />
                        </asp:Panel>
                        <asp:Panel ID="PanelHideDPSF" runat="server" Visible="false">
                            <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                <colgroup>
                                ...
                                <tr class="auto-style2">
                                    <td>
                                        <asp:Label ID="LabelRespondDPSF" runat="server" Text="Query Response"> </asp:Label>

                                    </td>
                                    <td>
                                        <center>
                                            <asp:TextBox ID="TextBoxRaiseDPSF" class="form-control" runat="server" Height="50" Width="150" ValidationGroup="IC"
                                                TextMode="MultiLine">
                                            </asp:TextBox>

                                        </center>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" BackColor="Red" runat="server" ErrorMessage="*"
                                            ControlToValidate="TextBoxRaiseDPSF" ValidationGroup="IC"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <center>
                                            <asp:Button ID="QueryRaiseDPSF" class="btn btn-primary icon-btn" runat="server" Text="Respond Query" ValidationGroup="IC"
                                                OnClick="QueryRaiseDPSF_Click" />
                                        </center>
    ...
    <div id="ct100_PopupWindow1">
        <ASPP:PopupPanel HeaderText="Respond Query: Specify findings:" ID="RAISEDPSFMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEDPSFMSG" runat="server">
                    <div align="center" style="width: 300px; height: 200px">
                        <br />
                        <asp:Panel ID="Panel2" runat="server" BorderStyle="Solid">
                            Query has been Responded of the Specify findings Field
                        </asp:Panel>
                    </div>
                </ASPP:PopupWindow>
            </PopupWindow>
