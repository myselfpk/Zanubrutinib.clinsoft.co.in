<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AdverseEventRecord.aspx.cs" Inherits="Study_Monitor_AdVisit_AdverseEventRecord" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Study Monitor | Adverse Event | Adverse Event Record</title>
   ...
   <script type="text/javascript">
       function Confirm() {
           ...
           if (validated) {
               ...
               if (confirm("Do you want to Lock Adverse Event Record page?")) {
    ...
    <script type="text/javascript">
        function Confirm1() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to SDV Adverse Event Record page?")) {
    ...
    <script type="text/javascript">
        function Confirm2() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to Unlocked Adverse Event Record page?")) {
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEAEAEN" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseAEAEN"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseAEAEN" runat="server" Text="Raise Query" OnClick="QueryRaiseAEAEN_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedAEAEN" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedAEAENClose" runat="server" Text="Close Query"   OnClick="CloseQueryAEAEN_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseAEAEN" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseAEAEN_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEAEOCCUR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseAEOCCUR"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseAEOCCUR" runat="server" Text="Raise Query" OnClick="QueryRaiseAEOCCUR_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedAEOCCUR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedAEOCCURClose" runat="server" Text="Close Query"   OnClick="CloseQueryAEOCCUR_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseAEOCCUR" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseAEOCCUR_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEAEWT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseAEWT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseAEWT" runat="server" Text="Raise Query" OnClick="QueryRaiseAEWT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedAEWT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedAEWTClose" runat="server" Text="Close Query"   OnClick="CloseQueryAEWT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseAEWT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseAEWT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEAEDTOS" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseAEDTOS"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseAEDTOS" runat="server" Text="Raise Query" OnClick="QueryRaiseAEDTOS_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedAEDTOS" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedAEDTOSClose" runat="server" Text="Close Query"   OnClick="CloseQueryAEDTOS_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseAEDTOS" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseAEDTOS_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEAESVR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseAESVR"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseAESVR" runat="server" Text="Raise Query" OnClick="QueryRaiseAESVR_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedAESVR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedAESVRClose" runat="server" Text="Close Query"   OnClick="CloseQueryAESVR_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseAESVR" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseAESVR_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEAE1AT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseAE1AT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseAE1AT" runat="server" Text="Raise Query" OnClick="QueryRaiseAE1AT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedAE1AT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedAE1ATClose" runat="server" Text="Close Query"   OnClick="CloseQueryAE1AT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseAE1AT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseAE1AT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEAE2AT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseAE2AT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseAE2AT" runat="server" Text="Raise Query" OnClick="QueryRaiseAE2AT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedAE2AT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedAE2ATClose" runat="server" Text="Close Query"   OnClick="CloseQueryAE2AT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseAE2AT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseAE2AT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEAE3AT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseAE3AT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseAE3AT" runat="server" Text="Raise Query" OnClick="QueryRaiseAE3AT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedAE3AT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedAE3ATClose" runat="server" Text="Close Query"   OnClick="CloseQueryAE3AT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseAE3AT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseAE3AT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEAETG" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseAETG"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseAETG" runat="server" Text="Raise Query" OnClick="QueryRaiseAETG_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedAETG" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedAETGClose" runat="server" Text="Close Query"   OnClick="CloseQueryAETG_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseAETG" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseAETG_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEAEOAED" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseAEOAED"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseAEOAED" runat="server" Text="Raise Query" OnClick="QueryRaiseAEOAED_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedAEOAED" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedAEOAEDClose" runat="server" Text="Close Query"   OnClick="CloseQueryAEOAED_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseAEOAED" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseAEOAED_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEAESRMDR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseAESRMDR"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseAESRMDR" runat="server" Text="Raise Query" OnClick="QueryRaiseAESRMDR_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedAESRMDR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedAESRMDRClose" runat="server" Text="Close Query"   OnClick="CloseQueryAESRMDR_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseAESRMDR" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseAESRMDR_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEAECAUS" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseAECAUS"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseAECAUS" runat="server" Text="Raise Query" OnClick="QueryRaiseAECAUS_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedAECAUS" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedAECAUSClose" runat="server" Text="Close Query"   OnClick="CloseQueryAECAUS_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseAECAUS" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseAECAUS_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAEPDINI" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAEPDINI"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAEPDINI" runat="server" Text="Raise Query" OnClick="QueryRaiseSAEPDINI_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAEPDINI" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAEPDINIClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAEPDINI_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAEPDINI" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAEPDINI_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAEPDGNDR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAEPDGNDR"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAEPDGNDR" runat="server" Text="Raise Query" OnClick="QueryRaiseSAEPDGNDR_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAEPDGNDR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAEPDGNDRClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAEPDGNDR_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAEPDGNDR" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAEPDGNDR_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAEPDDOB" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAEPDDOB"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAEPDDOB" runat="server" Text="Raise Query" OnClick="QueryRaiseSAEPDDOB_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAEPDDOB" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAEPDDOBClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAEPDDOB_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAEPDDOB" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAEPDDOB_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAEPDAGE" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAEPDAGE"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAEPDAGE" runat="server" Text="Raise Query" OnClick="QueryRaiseSAEPDAGE_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAEPDAGE" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAEPDAGEClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAEPDAGE_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAEPDAGE" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAEPDAGE_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAEPDHEIGHT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAEPDHEIGHT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAEPDHEIGHT" runat="server" Text="Raise Query" OnClick="QueryRaiseSAEPDHEIGHT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAEPDHEIGHT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAEPDHEIGHTClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAEPDHEIGHT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAEPDHEIGHT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAEPDHEIGHT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAEPDWEIGHT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAEPDWEIGHT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAEPDWEIGHT" runat="server" Text="Raise Query" OnClick="QueryRaiseSAEPDWEIGHT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAEPDWEIGHT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAEPDWEIGHTClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAEPDWEIGHT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAEPDWEIGHT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAEPDWEIGHT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESDGND" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSDGND"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSDGND" runat="server" Text="Raise Query" OnClick="QueryRaiseSDGND_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSDGND" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSDGNDClose" runat="server" Text="Close Query"   OnClick="CloseQuerySDGND_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSDGND" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSDGND_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESCINDI" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSCINDI"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSCINDI" runat="server" Text="Raise Query" OnClick="QueryRaiseSCINDI_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSCINDI" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSCINDIClose" runat="server" Text="Close Query"   OnClick="CloseQuerySCINDI_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSCINDI" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSCINDI_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESDDFS" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSDDFS"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSDDFS" runat="server" Text="Raise Query" OnClick="QueryRaiseSDDFS_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSDDFS" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSDDFSClose" runat="server" Text="Close Query"   OnClick="CloseQuerySDDFS_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSDDFS" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSDDFS_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESDDDR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSDDDR"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSDDDR" runat="server" Text="Raise Query" OnClick="QueryRaiseSDDDR_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSDDDR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSDDDRClose" runat="server" Text="Close Query"   OnClick="CloseQuerySDDDR_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSDDDR" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSDDDR_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESDROA" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSDROA"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSDROA" runat="server" Text="Raise Query" OnClick="QueryRaiseSDROA_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSDROA" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSDROAClose" runat="server" Text="Close Query"   OnClick="CloseQuerySDROA_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSDROA" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSDROA_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESDSTD" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSDSTD"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSDSTD" runat="server" Text="Raise Query" OnClick="QueryRaiseSDSTD_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSDSTD" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSDSTDClose" runat="server" Text="Close Query"   OnClick="CloseQuerySDSTD_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSDSTD" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSDSTD_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESDSTT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSDSTT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSDSTT" runat="server" Text="Raise Query" OnClick="QueryRaiseSDSTT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSDSTT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSDSTTClose" runat="server" Text="Close Query"   OnClick="CloseQuerySDSTT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSDSTT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSDSTT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESDSPD" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSDSPD"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSDSPD" runat="server" Text="Raise Query" OnClick="QueryRaiseSDSPD_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSDSPD" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSDSPDClose" runat="server" Text="Close Query"   OnClick="CloseQuerySDSPD_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSDSPD" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSDSPD_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESDSPT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSDSPT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSDSPT" runat="server" Text="Raise Query" OnClick="QueryRaiseSDSPT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSDSPT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSDSPTClose" runat="server" Text="Close Query"   OnClick="CloseQuerySDSPT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSDSPT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSDSPT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEOT1SPT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseOT1SPT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseOT1SPT" runat="server" Text="Raise Query" OnClick="QueryRaiseOT1SPT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedOT1SPT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedOT1SPTClose" runat="server" Text="Close Query"   OnClick="CloseQueryOT1SPT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseOT1SPT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseOT1SPT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEOT2SPT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseOT2SPT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseOT2SPT" runat="server" Text="Raise Query" OnClick="QueryRaiseOT2SPT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedOT2SPT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedOT2SPTClose" runat="server" Text="Close Query"   OnClick="CloseQueryOT2SPT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseOT2SPT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseOT2SPT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEOT3SPT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseOT3SPT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseOT3SPT" runat="server" Text="Raise Query" OnClick="QueryRaiseOT3SPT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedOT3SPT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedOT3SPTClose" runat="server" Text="Close Query"   OnClick="CloseQueryOT3SPT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseOT3SPT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseOT3SPT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAEFDR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAEFDR"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAEFDR" runat="server" Text="Raise Query" OnClick="QueryRaiseSAEFDR_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAEFDR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAEFDRClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAEFDR_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAEFDR" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAEFDR_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAESDTR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAESDTR"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAESDTR" runat="server" Text="Raise Query" OnClick="QueryRaiseSAESDTR_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAESDTR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAESDTRClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAESDTR_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAESDTR" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAESDTR_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAESDTTR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAESDTTR"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAESDTTR" runat="server" Text="Raise Query" OnClick="QueryRaiseSAESDTTR_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAESDTTR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAESDTTRClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAESDTTR_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAESDTTR" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAESDTTR_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAESSPDR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAESSPDR"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAESSPDR" runat="server" Text="Raise Query" OnClick="QueryRaiseSAESSPDR_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAESSPDR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAESSPDRClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAESSPDR_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAESSPDR" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAESSPDR_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAESSOTR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAESSOTR"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAESSOTR" runat="server" Text="Raise Query" OnClick="QueryRaiseSAESSOTR_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAESSOTR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAESSOTRClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAESSOTR_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAESSOTR" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAESSOTR_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAEDARI" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAEDARI"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAEDARI" runat="server" Text="Raise Query" OnClick="QueryRaiseSAEDARI_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAEDARI" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAEDARIClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAEDARI_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAEDARI" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAEDARI_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAESTG" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAESTG"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAESTG" runat="server" Text="Raise Query" OnClick="QueryRaiseSAESTG_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAESTG" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAESTGClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAESTG_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAESTG" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAESTG_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAEIRAS" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAEIRAS"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAEIRAS" runat="server" Text="Raise Query" OnClick="QueryRaiseSAEIRAS_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAEIRAS" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAEIRASClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAEIRAS_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAEIRAS" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAEIRAS_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAEIFFO" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAEIFFO"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAEIFFO" runat="server" Text="Raise Query" OnClick="QueryRaiseSAEIFFO_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAEIFFO" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAEIFFOClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAEIFFO_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAEIFFO" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAEIFFO_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAEOI" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAEOI"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAEOI" runat="server" Text="Raise Query" OnClick="QueryRaiseSAEOI_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAEOI" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAEOIClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAEOI_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAEOI" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAEOI_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESAECAURU" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSAECAURU"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSAECAURU" runat="server" Text="Raise Query" OnClick="QueryRaiseSAECAURU_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSAECAURU" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSAECAURUClose" runat="server" Text="Close Query"   OnClick="CloseQuerySAECAURU_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSAECAURU" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSAECAURU_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEPINAME" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaisePINAME"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaisePINAME" runat="server" Text="Raise Query" OnClick="QueryRaisePINAME_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedPINAME" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedPINAMEClose" runat="server" Text="Close Query"   OnClick="CloseQueryPINAME_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonClosePINAME" runat="server" Text="Reraise Query"   OnClick="SubmitReRaisePINAME_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEPIADDRESS" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaisePIADDRESS"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaisePIADDRESS" runat="server" Text="Raise Query" OnClick="QueryRaisePIADDRESS_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedPIADDRESS" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedPIADDRESSClose" runat="server" Text="Close Query"   OnClick="CloseQueryPIADDRESS_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonClosePIADDRESS" runat="server" Text="Reraise Query"   OnClick="SubmitReRaisePIADDRESS_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEPINUMBER" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaisePINUMBER"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaisePINUMBER" runat="server" Text="Raise Query" OnClick="QueryRaisePINUMBER_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedPINUMBER" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedPINUMBERClose" runat="server" Text="Close Query"   OnClick="CloseQueryPINUMBER_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonClosePINUMBER" runat="server" Text="Reraise Query"   OnClick="SubmitReRaisePINUMBER_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEPTPROFESSION" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaisePTPROFESSION"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaisePTPROFESSION" runat="server" Text="Raise Query" OnClick="QueryRaisePTPROFESSION_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedPTPROFESSION" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedPTPROFESSIONClose" runat="server" Text="Close Query"   OnClick="CloseQueryPTPROFESSION_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonClosePTPROFESSION" runat="server" Text="Reraise Query"   OnClick="SubmitReRaisePTPROFESSION_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEPIDRELA" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaisePIDRELA"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaisePIDRELA" runat="server" Text="Raise Query" OnClick="QueryRaisePIDRELA_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedPIDRELA" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedPIDRELAClose" runat="server" Text="Close Query"   OnClick="CloseQueryPIDRELA_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonClosePIDRELA" runat="server" Text="Reraise Query"   OnClick="SubmitReRaisePIDRELA_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEPIDREECOS" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaisePIDREECOS"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaisePIDREECOS" runat="server" Text="Raise Query" OnClick="QueryRaisePIDREECOS_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedPIDREECOS" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedPIDREECOSClose" runat="server" Text="Close Query"   OnClick="CloseQueryPIDREECOS_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonClosePIDREECOS" runat="server" Text="Reraise Query"   OnClick="SubmitReRaisePIDREECOS_Click" />
                       </div>
