...
public partial class Study_Monitor_AdVisit_ConcomitantMedication : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    private void BindPage()
    {
        con.Close();
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("SELECT CONMEDNO ,CMBRNDNM ,CMINDI ,CMSTDT ,CMENDT ,CMRUTE ,CMDSE ,CMFREQ ,LockStatus FROM [Add].[ConmedRecord] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "' and [CONMEDNO]='" + Request.QueryString["f"] + "'", con);
    ...
    public void OnConfirm(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            con.Open();
            con1.Open();
            cmd = new SqlCommand("Update tblQuery set  LockStatus = 'Locked'   where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and SNO = '" + TextBoxCONMEDNO.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'", con);
            cmd1 = new SqlCommand("Update [Add].[ConmedRecord] set  LockStatus = 'Locked' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'and [CONMEDNO]='" + Request.QueryString["f"] + "'", con1);
    ...
    public void OnConfirm1(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            con.Open();
            con1.Open();
            cmd = new SqlCommand("Update tblQuery set  LockStatus = 'SDV'   where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and SNO = '" + TextBoxCONMEDNO.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'", con);
            cmd1 = new SqlCommand("Update [Add].[ConmedRecord] set  LockStatus = 'SDV' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'and [CONMEDNO]='" + Request.QueryString["f"] + "'", con1);
    ...
    public void OnConfirm2(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            con.Open();
            con1.Open();
            cmd = new SqlCommand("Update tblQuery set  LockStatus = 'Unlocked'   where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and SNO = '" + TextBoxCONMEDNO.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'", con);
            cmd1 = new SqlCommand("Update [Add].[ConmedRecord] set  LockStatus = 'Unlocked' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'and [CONMEDNO]='" + Request.QueryString["f"] + "'", con1);
    ...
    private void SetImageQueryCONMEDNO()
    {
        ...
        if (dr.Read())
        {
            ...
            {
                ImageQueryCONMEDNO.ImageUrl = "~/Study-Monitor/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryCONMEDNO.ImageUrl = "~/Study-Monitor/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryCONMEDNO.ImageUrl = "~/Study-Monitor/Images/Yellow.png";
            }
            else
            {
                ImageQueryCONMEDNO.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryCONMEDNO_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryCONMEDNO.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECONMEDNO.Visible = true;
                RAISECONMEDNO.ShowPopupWindow();
                QueryRaiseCONMEDNO.Visible = true;
                TextBoxRaiseCONMEDNO.Visible = true;
                PanelRaiseCONMEDNO.Visible = false;
                PanelRaiseCONMEDNO2.Visible = false;
                PanelRaiseCONMEDNO3.Visible = false;
            }

            else if ((ImageQueryCONMEDNO.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECONMEDNO.Visible = true;
                RAISECONMEDNO.ShowPopupWindow();
                QueryRaiseCONMEDNO.Visible = false;
                TextBoxRaiseCONMEDNO.Visible = false;
            }

            else if ((ImageQueryCONMEDNO.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedCONMEDNO.Visible = true;
                RespondedCONMEDNO.ShowPopupWindow();
            }
            else if ((ImageQueryCONMEDNO.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseCONMEDNO_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblCONMEDNO.Text + "','" + TextBoxRaiseCONMEDNO.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxCONMEDNO.Text + "')", con);
    ...
    protected void CloseQueryCONMEDNO_Click(object sender, EventArgs e)
    {
        ...
        RespondedCONMEDNOClose.Visible = false;
    }
    ...
    private void SetImageQueryCMBRNDNM()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryCMBRNDNM.ImageUrl = "~/Study-Monitor/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryCMBRNDNM.ImageUrl = "~/Study-Monitor/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryCMBRNDNM.ImageUrl = "~/Study-Monitor/Images/Yellow.png";
            }
            else
            {
                ImageQueryCMBRNDNM.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryCMBRNDNM_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryCMBRNDNM.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECMBRNDNM.Visible = true;
                RAISECMBRNDNM.ShowPopupWindow();
                QueryRaiseCMBRNDNM.Visible = true;
                TextBoxRaiseCMBRNDNM.Visible = true;
                PanelRaiseCMBRNDNM.Visible = false;
                PanelRaiseCMBRNDNM2.Visible = false;
                PanelRaiseCMBRNDNM3.Visible = false;
            }

            else if ((ImageQueryCMBRNDNM.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECMBRNDNM.Visible = true;
                RAISECMBRNDNM.ShowPopupWindow();
                QueryRaiseCMBRNDNM.Visible = false;
                TextBoxRaiseCMBRNDNM.Visible = false;
            }

            else if ((ImageQueryCMBRNDNM.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedCMBRNDNM.Visible = true;
                RespondedCMBRNDNM.ShowPopupWindow();
            }
            else if ((ImageQueryCMBRNDNM.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseCMBRNDNM_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblCMBRNDNM.Text + "','" + TextBoxRaiseCMBRNDNM.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxCONMEDNO.Text + "')", con);
    ...
    protected void CloseQueryCMBRNDNM_Click(object sender, EventArgs e)
    {
        ...
        RespondedCMBRNDNMClose.Visible = false;
    }
    ...
    private void SetImageQueryCMINDI()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryCMINDI.ImageUrl = "~/Study-Monitor/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryCMINDI.ImageUrl = "~/Study-Monitor/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryCMINDI.ImageUrl = "~/Study-Monitor/Images/Yellow.png";
            }
            else
            {
                ImageQueryCMINDI.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryCMINDI_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryCMINDI.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECMINDI.Visible = true;
                RAISECMINDI.ShowPopupWindow();
                QueryRaiseCMINDI.Visible = true;
                TextBoxRaiseCMINDI.Visible = true;
                PanelRaiseCMINDI.Visible = false;
                PanelRaiseCMINDI2.Visible = false;
                PanelRaiseCMINDI3.Visible = false;
            }

            else if ((ImageQueryCMINDI.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECMINDI.Visible = true;
                RAISECMINDI.ShowPopupWindow();
                QueryRaiseCMINDI.Visible = false;
                TextBoxRaiseCMINDI.Visible = false;
            }

            else if ((ImageQueryCMINDI.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedCMINDI.Visible = true;
                RespondedCMINDI.ShowPopupWindow();
            }
            else if ((ImageQueryCMINDI.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseCMINDI_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblCMINDI.Text + "','" + TextBoxRaiseCMINDI.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxCONMEDNO.Text + "')", con);
    ...
    protected void CloseQueryCMINDI_Click(object sender, EventArgs e)
    {
        ...
        RespondedCMINDIClose.Visible = false;
    }
    ...
    private void SetImageQueryCMSTDT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryCMSTDT.ImageUrl = "~/Study-Monitor/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryCMSTDT.ImageUrl = "~/Study-Monitor/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryCMSTDT.ImageUrl = "~/Study-Monitor/Images/Yellow.png";
            }
            else
            {
                ImageQueryCMSTDT.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryCMSTDT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryCMSTDT.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECMSTDT.Visible = true;
                RAISECMSTDT.ShowPopupWindow();
                QueryRaiseCMSTDT.Visible = true;
                TextBoxRaiseCMSTDT.Visible = true;
                PanelRaiseCMSTDT.Visible = false;
                PanelRaiseCMSTDT2.Visible = false;
                PanelRaiseCMSTDT3.Visible = false;
            }

            else if ((ImageQueryCMSTDT.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECMSTDT.Visible = true;
                RAISECMSTDT.ShowPopupWindow();
                QueryRaiseCMSTDT.Visible = false;
                TextBoxRaiseCMSTDT.Visible = false;
            }

            else if ((ImageQueryCMSTDT.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedCMSTDT.Visible = true;
                RespondedCMSTDT.ShowPopupWindow();
            }
            else if ((ImageQueryCMSTDT.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseCMSTDT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblCMSTDT.Text + "','" + TextBoxRaiseCMSTDT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxCONMEDNO.Text + "')", con);
    ...
    protected void CloseQueryCMSTDT_Click(object sender, EventArgs e)
    {
        ...
        RespondedCMSTDTClose.Visible = false;
    }
    ...
    private void SetImageQueryCMENDT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryCMENDT.ImageUrl = "~/Study-Monitor/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryCMENDT.ImageUrl = "~/Study-Monitor/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryCMENDT.ImageUrl = "~/Study-Monitor/Images/Yellow.png";
            }
            else
            {
                ImageQueryCMENDT.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryCMENDT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryCMENDT.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECMENDT.Visible = true;
                RAISECMENDT.ShowPopupWindow();
                QueryRaiseCMENDT.Visible = true;
                TextBoxRaiseCMENDT.Visible = true;
                PanelRaiseCMENDT.Visible = false;
                PanelRaiseCMENDT2.Visible = false;
                PanelRaiseCMENDT3.Visible = false;
            }

            else if ((ImageQueryCMENDT.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECMENDT.Visible = true;
                RAISECMENDT.ShowPopupWindow();
                QueryRaiseCMENDT.Visible = false;
                TextBoxRaiseCMENDT.Visible = false;
            }

            else if ((ImageQueryCMENDT.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedCMENDT.Visible = true;
                RespondedCMENDT.ShowPopupWindow();
            }
            else if ((ImageQueryCMENDT.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseCMENDT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblCMENDT.Text + "','" + TextBoxRaiseCMENDT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxCONMEDNO.Text + "')", con);
    ...
    protected void CloseQueryCMENDT_Click(object sender, EventArgs e)
    {
        ...
        RespondedCMENDTClose.Visible = false;
    }
    ...
    private void SetImageQueryCMRUTE()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryCMRUTE.ImageUrl = "~/Study-Monitor/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryCMRUTE.ImageUrl = "~/Study-Monitor/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryCMRUTE.ImageUrl = "~/Study-Monitor/Images/Yellow.png";
            }
            else
            {
                ImageQueryCMRUTE.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryCMRUTE_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryCMRUTE.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECMRUTE.Visible = true;
                RAISECMRUTE.ShowPopupWindow();
                QueryRaiseCMRUTE.Visible = true;
                TextBoxRaiseCMRUTE.Visible = true;
                PanelRaiseCMRUTE.Visible = false;
                PanelRaiseCMRUTE2.Visible = false;
                PanelRaiseCMRUTE3.Visible = false;
            }

            else if ((ImageQueryCMRUTE.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECMRUTE.Visible = true;
                RAISECMRUTE.ShowPopupWindow();
                QueryRaiseCMRUTE.Visible = false;
                TextBoxRaiseCMRUTE.Visible = false;
            }

            else if ((ImageQueryCMRUTE.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedCMRUTE.Visible = true;
                RespondedCMRUTE.ShowPopupWindow();
            }
            else if ((ImageQueryCMRUTE.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseCMRUTE_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblCMRUTE.Text + "','" + TextBoxRaiseCMRUTE.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxCONMEDNO.Text + "')", con);
    ...
    protected void CloseQueryCMRUTE_Click(object sender, EventArgs e)
    {
        ...
        RespondedCMRUTEClose.Visible = false;
    }
    ...
    private void SetImageQueryCMDSE()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryCMDSE.ImageUrl = "~/Study-Monitor/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryCMDSE.ImageUrl = "~/Study-Monitor/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryCMDSE.ImageUrl = "~/Study-Monitor/Images/Yellow.png";
            }
            else
            {
                ImageQueryCMDSE.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryCMDSE_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryCMDSE.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECMDSE.Visible = true;
                RAISECMDSE.ShowPopupWindow();
                QueryRaiseCMDSE.Visible = true;
                TextBoxRaiseCMDSE.Visible = true;
                PanelRaiseCMDSE.Visible = false;
                PanelRaiseCMDSE2.Visible = false;
                PanelRaiseCMDSE3.Visible = false;
            }

            else if ((ImageQueryCMDSE.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECMDSE.Visible = true;
                RAISECMDSE.ShowPopupWindow();
                QueryRaiseCMDSE.Visible = false;
                TextBoxRaiseCMDSE.Visible = false;
            }

            else if ((ImageQueryCMDSE.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedCMDSE.Visible = true;
                RespondedCMDSE.ShowPopupWindow();
            }
            else if ((ImageQueryCMDSE.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseCMDSE_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblCMDSE.Text + "','" + TextBoxRaiseCMDSE.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxCONMEDNO.Text + "')", con);
    ...
    protected void CloseQueryCMDSE_Click(object sender, EventArgs e)
    {
        ...
        RespondedCMDSEClose.Visible = false;
    }
    ...
    private void SetImageQueryCMFREQ()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryCMFREQ.ImageUrl = "~/Study-Monitor/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryCMFREQ.ImageUrl = "~/Study-Monitor/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryCMFREQ.ImageUrl = "~/Study-Monitor/Images/Yellow.png";
            }
            else
            {
                ImageQueryCMFREQ.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryCMFREQ_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryCMFREQ.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECMFREQ.Visible = true;
                RAISECMFREQ.ShowPopupWindow();
                QueryRaiseCMFREQ.Visible = true;
                TextBoxRaiseCMFREQ.Visible = true;
                PanelRaiseCMFREQ.Visible = false;
                PanelRaiseCMFREQ2.Visible = false;
                PanelRaiseCMFREQ3.Visible = false;
            }

            else if ((ImageQueryCMFREQ.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISECMFREQ.Visible = true;
                RAISECMFREQ.ShowPopupWindow();
                QueryRaiseCMFREQ.Visible = false;
                TextBoxRaiseCMFREQ.Visible = false;
            }

            else if ((ImageQueryCMFREQ.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedCMFREQ.Visible = true;
                RespondedCMFREQ.ShowPopupWindow();
            }
            else if ((ImageQueryCMFREQ.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseCMFREQ_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblCMFREQ.Text + "','" + TextBoxRaiseCMFREQ.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxCONMEDNO.Text + "')", con);
    ...
    protected void CloseQueryCMFREQ_Click(object sender, EventArgs e)
    {
        ...
        RespondedCMFREQClose.Visible = false;
    }
