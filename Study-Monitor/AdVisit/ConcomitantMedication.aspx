<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ConcomitantMedication.aspx.cs" Inherits="Study_Monitor_AdVisit_ConcomitantMedication" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Study Monitor | Concomitant Medication | Prior/Concomitant Medication Form</title>
    ...
    <script type="text/javascript">
        function Confirm() {
            ...
            if (validated) {
                ...
                if (confirm("Do you want to Lock Prior/Concomitant Medication Form page?")) {
    ...
    <script type="text/javascript">
        function Confirm1() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to SDV Prior/Concomitant Medication Form page?")) {
    ...
    <script type="text/javascript">
        function Confirm2() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to Unlocked Prior/Concomitant Medication Form page?")) {
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISECONMEDNO" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseCONMEDNO"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseCONMEDNO" runat="server" Text="Raise Query" OnClick="QueryRaiseCONMEDNO_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedCONMEDNO" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedCONMEDNOClose" runat="server" Text="Close Query"   OnClick="CloseQueryCONMEDNO_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseCONMEDNO" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseCONMEDNO_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISECMBRNDNM" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseCMBRNDNM"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseCMBRNDNM" runat="server" Text="Raise Query" OnClick="QueryRaiseCMBRNDNM_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedCMBRNDNM" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedCMBRNDNMClose" runat="server" Text="Close Query"   OnClick="CloseQueryCMBRNDNM_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseCMBRNDNM" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseCMBRNDNM_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISECMINDI" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseCMINDI"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseCMINDI" runat="server" Text="Raise Query" OnClick="QueryRaiseCMINDI_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedCMINDI" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedCMINDIClose" runat="server" Text="Close Query"   OnClick="CloseQueryCMINDI_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseCMINDI" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseCMINDI_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISECMSTDT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseCMSTDT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseCMSTDT" runat="server" Text="Raise Query" OnClick="QueryRaiseCMSTDT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedCMSTDT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedCMSTDTClose" runat="server" Text="Close Query"   OnClick="CloseQueryCMSTDT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseCMSTDT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseCMSTDT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISECMENDT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseCMENDT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseCMENDT" runat="server" Text="Raise Query" OnClick="QueryRaiseCMENDT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedCMENDT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedCMENDTClose" runat="server" Text="Close Query"   OnClick="CloseQueryCMENDT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseCMENDT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseCMENDT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISECMRUTE" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseCMRUTE"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseCMRUTE" runat="server" Text="Raise Query" OnClick="QueryRaiseCMRUTE_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedCMRUTE" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedCMRUTEClose" runat="server" Text="Close Query"   OnClick="CloseQueryCMRUTE_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseCMRUTE" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseCMRUTE_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISECMDSE" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseCMDSE"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseCMDSE" runat="server" Text="Raise Query" OnClick="QueryRaiseCMDSE_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedCMDSE" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedCMDSEClose" runat="server" Text="Close Query"   OnClick="CloseQueryCMDSE_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseCMDSE" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseCMDSE_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISECMFREQ" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseCMFREQ"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseCMFREQ" runat="server" Text="Raise Query" OnClick="QueryRaiseCMFREQ_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedCMFREQ" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedCMFREQClose" runat="server" Text="Close Query"   OnClick="CloseQueryCMFREQ_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseCMFREQ" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseCMFREQ_Click" />
                       </div>
