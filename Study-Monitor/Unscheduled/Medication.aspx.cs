...
public partial class Study_Monitor_Unscheduled_Medication : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    public void OnConfirm(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit2].[Medication] set  LockStatus = 'Locked' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "' and [FUVSTNM]='" + lblVisit.Text + "'", con1);
    ...
    public void OnConfirm1(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit2].[Medication] set  LockStatus = 'SDV' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "' and [FUVSTNM]='" + lblVisit.Text + "'", con1);
    ...
    public void OnConfirm2(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit2].[Medication] set  LockStatus = 'Unlocked' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "' and [FUVSTNM]='" + lblVisit.Text + "'", con1);
    ...
    private void SetImageQueryMEDI1FRQ()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI1FRQ.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI1FRQ.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI1FRQ.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI1FRQ.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI1FRQ_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI1FRQ.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMEDI1FRQ.Visible = true;
                RAISEMEDI1FRQ.ShowPopupWindow();
                QueryRaiseMEDI1FRQ.Visible = true;
                TextBoxRaiseMEDI1FRQ.Visible = true;
            ...
            else if ((ImageQueryMEDI1FRQ.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI1FRQ.Visible = true;
                RAISEMEDI1FRQ.ShowPopupWindow();
                QueryRaiseMEDI1FRQ.Visible = false;
                TextBoxRaiseMEDI1FRQ.Visible = false;
            }

            else if ((ImageQueryMEDI1FRQ.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI1FRQ.Visible = true;
                RespondedMEDI1FRQ.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI1FRQ.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI1FRQ_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI1FRQ.Text + "','" + TextBoxRaiseMEDI1FRQ.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMEDI1FRQ_Click(object sender, EventArgs e)
    {
        ...
        RespondedMEDI1FRQClose.Visible = false;
    ...
    private void SetImageQueryMEDI2FRQ()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI2FRQ.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI2FRQ.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI2FRQ.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI2FRQ.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI2FRQ_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI2FRQ.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMEDI2FRQ.Visible = true;
                RAISEMEDI2FRQ.ShowPopupWindow();
                QueryRaiseMEDI2FRQ.Visible = true;
                TextBoxRaiseMEDI2FRQ.Visible = true;
            ...
            else if ((ImageQueryMEDI2FRQ.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI2FRQ.Visible = true;
                RAISEMEDI2FRQ.ShowPopupWindow();
                QueryRaiseMEDI2FRQ.Visible = false;
                TextBoxRaiseMEDI2FRQ.Visible = false;
            }

            else if ((ImageQueryMEDI2FRQ.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI2FRQ.Visible = true;
                RespondedMEDI2FRQ.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI2FRQ.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI2FRQ_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI2FRQ.Text + "','" + TextBoxRaiseMEDI2FRQ.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMEDI2FRQ_Click(object sender, EventArgs e)
    {
        ...
        RespondedMEDI2FRQClose.Visible = false;
    ...
    private void SetImageQueryMEDI3FRQ()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI3FRQ.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI3FRQ.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI3FRQ.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI3FRQ.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI3FRQ_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI3FRQ.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMEDI3FRQ.Visible = true;
                RAISEMEDI3FRQ.ShowPopupWindow();
                QueryRaiseMEDI3FRQ.Visible = true;
                TextBoxRaiseMEDI3FRQ.Visible = true;
            ...
            else if ((ImageQueryMEDI3FRQ.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI3FRQ.Visible = true;
                RAISEMEDI3FRQ.ShowPopupWindow();
                QueryRaiseMEDI3FRQ.Visible = false;
                TextBoxRaiseMEDI3FRQ.Visible = false;
            }

            else if ((ImageQueryMEDI3FRQ.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI3FRQ.Visible = true;
                RespondedMEDI3FRQ.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI3FRQ.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI3FRQ_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI3FRQ.Text + "','" + TextBoxRaiseMEDI3FRQ.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMEDI3FRQ_Click(object sender, EventArgs e)
    {
        ...
        RespondedMEDI3FRQClose.Visible = false;
    ...
    private void SetImageQueryMEDI4FRQ()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI4FRQ.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI4FRQ.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI4FRQ.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI4FRQ.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI4FRQ_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI4FRQ.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMEDI4FRQ.Visible = true;
                RAISEMEDI4FRQ.ShowPopupWindow();
                QueryRaiseMEDI4FRQ.Visible = true;
                TextBoxRaiseMEDI4FRQ.Visible = true;
            ...
            else if ((ImageQueryMEDI4FRQ.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI4FRQ.Visible = true;
                RAISEMEDI4FRQ.ShowPopupWindow();
                QueryRaiseMEDI4FRQ.Visible = false;
                TextBoxRaiseMEDI4FRQ.Visible = false;
            }

            else if ((ImageQueryMEDI4FRQ.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI4FRQ.Visible = true;
                RespondedMEDI4FRQ.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI4FRQ.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI4FRQ_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI4FRQ.Text + "','" + TextBoxRaiseMEDI4FRQ.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMEDI4FRQ_Click(object sender, EventArgs e)
    {
        ...
        RespondedMEDI4FRQClose.Visible = false;
    ...
    private void SetImageQueryMEDI5FRQ()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI5FRQ.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI5FRQ.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI5FRQ.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI5FRQ.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI5FRQ_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI5FRQ.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMEDI5FRQ.Visible = true;
                RAISEMEDI5FRQ.ShowPopupWindow();
                QueryRaiseMEDI5FRQ.Visible = true;
                TextBoxRaiseMEDI5FRQ.Visible = true;
            ...
            else if ((ImageQueryMEDI5FRQ.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI5FRQ.Visible = true;
                RAISEMEDI5FRQ.ShowPopupWindow();
                QueryRaiseMEDI5FRQ.Visible = false;
                TextBoxRaiseMEDI5FRQ.Visible = false;
            }

            else if ((ImageQueryMEDI5FRQ.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI5FRQ.Visible = true;
                RespondedMEDI5FRQ.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI5FRQ.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI5FRQ_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI5FRQ.Text + "','" + TextBoxRaiseMEDI5FRQ.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMEDI5FRQ_Click(object sender, EventArgs e)
    {
        ...
        RespondedMEDI5FRQClose.Visible = false;
    ...
    private void SetImageQueryMEDI6FRQ()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI6FRQ.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI6FRQ.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI6FRQ.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI6FRQ.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI6FRQ_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI6FRQ.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMEDI6FRQ.Visible = true;
                RAISEMEDI6FRQ.ShowPopupWindow();
                QueryRaiseMEDI6FRQ.Visible = true;
                TextBoxRaiseMEDI6FRQ.Visible = true;
            ...
            else if ((ImageQueryMEDI6FRQ.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI6FRQ.Visible = true;
                RAISEMEDI6FRQ.ShowPopupWindow();
                QueryRaiseMEDI6FRQ.Visible = false;
                TextBoxRaiseMEDI6FRQ.Visible = false;
            }

            else if ((ImageQueryMEDI6FRQ.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI6FRQ.Visible = true;
                RespondedMEDI6FRQ.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI6FRQ.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI6FRQ_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI6FRQ.Text + "','" + TextBoxRaiseMEDI6FRQ.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMEDI6FRQ_Click(object sender, EventArgs e)
    {
        ...
        RespondedMEDI6FRQClose.Visible = false;
    ...
    private void SetImageQueryMEDI7FRQ()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI7FRQ.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI7FRQ.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI7FRQ.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI7FRQ.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI7FRQ_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI7FRQ.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMEDI7FRQ.Visible = true;
                RAISEMEDI7FRQ.ShowPopupWindow();
                QueryRaiseMEDI7FRQ.Visible = true;
                TextBoxRaiseMEDI7FRQ.Visible = true;
            ...
            else if ((ImageQueryMEDI7FRQ.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI7FRQ.Visible = true;
                RAISEMEDI7FRQ.ShowPopupWindow();
                QueryRaiseMEDI7FRQ.Visible = false;
                TextBoxRaiseMEDI7FRQ.Visible = false;
            }

            else if ((ImageQueryMEDI7FRQ.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI7FRQ.Visible = true;
                RespondedMEDI7FRQ.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI7FRQ.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI7FRQ_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI7FRQ.Text + "','" + TextBoxRaiseMEDI7FRQ.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMEDI7FRQ_Click(object sender, EventArgs e)
    {
        ...
        RespondedMEDI7FRQClose.Visible = false;
    ...
    private void SetImageQueryMEDI8FRQ()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI8FRQ.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI8FRQ.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI8FRQ.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI8FRQ.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI8FRQ_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI8FRQ.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMEDI8FRQ.Visible = true;
                RAISEMEDI8FRQ.ShowPopupWindow();
                QueryRaiseMEDI8FRQ.Visible = true;
                TextBoxRaiseMEDI8FRQ.Visible = true;
            ...
            else if ((ImageQueryMEDI8FRQ.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI8FRQ.Visible = true;
                RAISEMEDI8FRQ.ShowPopupWindow();
                QueryRaiseMEDI8FRQ.Visible = false;
                TextBoxRaiseMEDI8FRQ.Visible = false;
            }

            else if ((ImageQueryMEDI8FRQ.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI8FRQ.Visible = true;
                RespondedMEDI8FRQ.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI8FRQ.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI8FRQ_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI8FRQ.Text + "','" + TextBoxRaiseMEDI8FRQ.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMEDI8FRQ_Click(object sender, EventArgs e)
    {
        ...
        RespondedMEDI8FRQClose.Visible = false;
    ...
    private void SetImageQueryMEDI9FRQ()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI9FRQ.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI9FRQ.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI9FRQ.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI9FRQ.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI9FRQ_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI9FRQ.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMEDI9FRQ.Visible = true;
                RAISEMEDI9FRQ.ShowPopupWindow();
                QueryRaiseMEDI9FRQ.Visible = true;
                TextBoxRaiseMEDI9FRQ.Visible = true;
            ...
            else if ((ImageQueryMEDI9FRQ.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI9FRQ.Visible = true;
                RAISEMEDI9FRQ.ShowPopupWindow();
                QueryRaiseMEDI9FRQ.Visible = false;
                TextBoxRaiseMEDI9FRQ.Visible = false;
            }

            else if ((ImageQueryMEDI9FRQ.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI9FRQ.Visible = true;
                RespondedMEDI9FRQ.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI9FRQ.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI9FRQ_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI9FRQ.Text + "','" + TextBoxRaiseMEDI9FRQ.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMEDI9FRQ_Click(object sender, EventArgs e)
    {
        ...
        RespondedMEDI9FRQClose.Visible = false;
    ...
    private void SetImageQueryMEDI10FRQ()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI10FRQ.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI10FRQ.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI10FRQ.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI10FRQ.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI10FRQ_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI10FRQ.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMEDI10FRQ.Visible = true;
                RAISEMEDI10FRQ.ShowPopupWindow();
                QueryRaiseMEDI10FRQ.Visible = true;
                TextBoxRaiseMEDI10FRQ.Visible = true;
            ...
            else if ((ImageQueryMEDI10FRQ.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI10FRQ.Visible = true;
                RAISEMEDI10FRQ.ShowPopupWindow();
                QueryRaiseMEDI10FRQ.Visible = false;
                TextBoxRaiseMEDI10FRQ.Visible = false;
            }

            else if ((ImageQueryMEDI10FRQ.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI10FRQ.Visible = true;
                RespondedMEDI10FRQ.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI10FRQ.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI10FRQ_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI10FRQ.Text + "','" + TextBoxRaiseMEDI10FRQ.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMEDI10FRQ_Click(object sender, EventArgs e)
    {
        ...
        RespondedMEDI10FRQClose.Visible = false;
    ...
    private void SetImageQueryMEDI11FRQ()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI11FRQ.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI11FRQ.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI11FRQ.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI11FRQ.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI11FRQ_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI11FRQ.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMEDI11FRQ.Visible = true;
                RAISEMEDI11FRQ.ShowPopupWindow();
                QueryRaiseMEDI11FRQ.Visible = true;
                TextBoxRaiseMEDI11FRQ.Visible = true;
            ...
            else if ((ImageQueryMEDI11FRQ.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI11FRQ.Visible = true;
                RAISEMEDI11FRQ.ShowPopupWindow();
                QueryRaiseMEDI11FRQ.Visible = false;
                TextBoxRaiseMEDI11FRQ.Visible = false;
            }

            else if ((ImageQueryMEDI11FRQ.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI11FRQ.Visible = true;
                RespondedMEDI11FRQ.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI11FRQ.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI11FRQ_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI11FRQ.Text + "','" + TextBoxRaiseMEDI11FRQ.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMEDI11FRQ_Click(object sender, EventArgs e)
    {
        ...
        RespondedMEDI11FRQClose.Visible = false;
    ...
    private void SetImageQueryMEDI12FRQ()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI12FRQ.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI12FRQ.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI12FRQ.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI12FRQ.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI12FRQ_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI12FRQ.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMEDI12FRQ.Visible = true;
                RAISEMEDI12FRQ.ShowPopupWindow();
                QueryRaiseMEDI12FRQ.Visible = true;
                TextBoxRaiseMEDI12FRQ.Visible = true;
            ...
            else if ((ImageQueryMEDI12FRQ.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI12FRQ.Visible = true;
                RAISEMEDI12FRQ.ShowPopupWindow();
                QueryRaiseMEDI12FRQ.Visible = false;
                TextBoxRaiseMEDI12FRQ.Visible = false;
            }

            else if ((ImageQueryMEDI12FRQ.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI12FRQ.Visible = true;
                RespondedMEDI12FRQ.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI12FRQ.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI12FRQ_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI12FRQ.Text + "','" + TextBoxRaiseMEDI12FRQ.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMEDI12FRQ_Click(object sender, EventArgs e)
    {
        ...
        RespondedMEDI12FRQClose.Visible = false;
    ...
    private void SetImageQueryMEDI13FRQ()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI13FRQ.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI13FRQ.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI13FRQ.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI13FRQ.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI13FRQ_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI13FRQ.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMEDI13FRQ.Visible = true;
                RAISEMEDI13FRQ.ShowPopupWindow();
                QueryRaiseMEDI13FRQ.Visible = true;
                TextBoxRaiseMEDI13FRQ.Visible = true;
            ...
            else if ((ImageQueryMEDI13FRQ.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI13FRQ.Visible = true;
                RAISEMEDI13FRQ.ShowPopupWindow();
                QueryRaiseMEDI13FRQ.Visible = false;
                TextBoxRaiseMEDI13FRQ.Visible = false;
            }

            else if ((ImageQueryMEDI13FRQ.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI13FRQ.Visible = true;
                RespondedMEDI13FRQ.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI13FRQ.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI13FRQ_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI13FRQ.Text + "','" + TextBoxRaiseMEDI13FRQ.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMEDI13FRQ_Click(object sender, EventArgs e)
    {
        ...
        RespondedMEDI13FRQClose.Visible = false;
