...
public partial class Study_Monitor_Visit1_PatientPresentationSymptomsAndSigns : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    public void OnConfirm(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  LockStatus = 'Locked' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con1);
    ...
    public void OnConfirm1(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  LockStatus = 'SDV' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con1);
    ...
    public void OnConfirm2(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  LockStatus = 'Unlocked' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con1);
    ...
    private void SetImageQueryPSSASYMP()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryPSSASYMP.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryPSSASYMP.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryPSSASYMP.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryPSSASYMP.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryPSSASYMP_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryPSSASYMP.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEPSSASYMP.Visible = true;
                RAISEPSSASYMP.ShowPopupWindow();
                QueryRaisePSSASYMP.Visible = true;
                TextBoxRaisePSSASYMP.Visible = true;
            ...
            else if ((ImageQueryPSSASYMP.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEPSSASYMP.Visible = true;
                RAISEPSSASYMP.ShowPopupWindow();
                QueryRaisePSSASYMP.Visible = false;
                TextBoxRaisePSSASYMP.Visible = false;
            }

            else if ((ImageQueryPSSASYMP.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedPSSASYMP.Visible = true;
                RespondedPSSASYMP.ShowPopupWindow();
            }
            else if ((ImageQueryPSSASYMP.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaisePSSASYMP_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblPSSASYMP.Text + "','" + TextBoxRaisePSSASYMP.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryPSSASYMP_Click(object sender, EventArgs e)
    {
        ...
        RespondedPSSASYMPClose.Visible = false;
