...
public partial class Study_Monitor_Visit1_EligibilityCriteria : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    private void BindPage()
    {
        con.Close();
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("SELECT IN1Question ,IN2Question ,IN3Question ,EC1Question ,EC2Question ,EC3Question, LockStatus FROM [Visit1].[EligibilityCriteria] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
    ...
    public void OnConfirm(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit1].[EligibilityCriteria] set  LockStatus = 'Locked' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con1);
    ...
    public void OnConfirm1(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit1].[EligibilityCriteria] set  LockStatus = 'SDV' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con1);
    ...
    public void OnConfirm2(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit1].[EligibilityCriteria] set  LockStatus = 'Unlocked' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con1);
    ...
    private void SetImageQueryIN1Question()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryIN1Question.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryIN1Question.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryIN1Question.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryIN1Question.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryIN1Question_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryIN1Question.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEIN1Question.Visible = true;
                RAISEIN1Question.ShowPopupWindow();
                QueryRaiseIN1Question.Visible = true;
                TextBoxRaiseIN1Question.Visible = true;
            ...
            else if ((ImageQueryIN1Question.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEIN1Question.Visible = true;
                RAISEIN1Question.ShowPopupWindow();
                QueryRaiseIN1Question.Visible = false;
                TextBoxRaiseIN1Question.Visible = false;
            }

            else if ((ImageQueryIN1Question.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedIN1Question.Visible = true;
                RespondedIN1Question.ShowPopupWindow();
            }
            else if ((ImageQueryIN1Question.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseIN1Question_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblIN1Question.Text + "','" + TextBoxRaiseIN1Question.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryIN1Question_Click(object sender, EventArgs e)
    {
        ...
        RespondedIN1QuestionClose.Visible = false;
    ...
    private void SetImageQueryIN2Question()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryIN2Question.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryIN2Question.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryIN2Question.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryIN2Question.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryIN2Question_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryIN2Question.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEIN2Question.Visible = true;
                RAISEIN2Question.ShowPopupWindow();
                QueryRaiseIN2Question.Visible = true;
                TextBoxRaiseIN2Question.Visible = true;
            ...
            else if ((ImageQueryIN2Question.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEIN2Question.Visible = true;
                RAISEIN2Question.ShowPopupWindow();
                QueryRaiseIN2Question.Visible = false;
                TextBoxRaiseIN2Question.Visible = false;
            }

            else if ((ImageQueryIN2Question.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedIN2Question.Visible = true;
                RespondedIN2Question.ShowPopupWindow();
            }
            else if ((ImageQueryIN2Question.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseIN2Question_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblIN2Question.Text + "','" + TextBoxRaiseIN2Question.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryIN2Question_Click(object sender, EventArgs e)
    {
        ...
        RespondedIN2QuestionClose.Visible = false;
    ...
    private void SetImageQueryIN3Question()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryIN3Question.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryIN3Question.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryIN3Question.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryIN3Question.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryIN3Question_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryIN3Question.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEIN3Question.Visible = true;
                RAISEIN3Question.ShowPopupWindow();
                QueryRaiseIN3Question.Visible = true;
                TextBoxRaiseIN3Question.Visible = true;
            ...
            else if ((ImageQueryIN3Question.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEIN3Question.Visible = true;
                RAISEIN3Question.ShowPopupWindow();
                QueryRaiseIN3Question.Visible = false;
                TextBoxRaiseIN3Question.Visible = false;
            }

            else if ((ImageQueryIN3Question.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedIN3Question.Visible = true;
                RespondedIN3Question.ShowPopupWindow();
            }
            else if ((ImageQueryIN3Question.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseIN3Question_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblIN3Question.Text + "','" + TextBoxRaiseIN3Question.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryIN3Question_Click(object sender, EventArgs e)
    {
        ...
        RespondedIN3QuestionClose.Visible = false;
    ...
    private void SetImageQueryEC1Question()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryEC1Question.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryEC1Question.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryEC1Question.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryEC1Question.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryEC1Question_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryEC1Question.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEEC1Question.Visible = true;
                RAISEEC1Question.ShowPopupWindow();
                QueryRaiseEC1Question.Visible = true;
                TextBoxRaiseEC1Question.Visible = true;
            ...
            else if ((ImageQueryEC1Question.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEEC1Question.Visible = true;
                RAISEEC1Question.ShowPopupWindow();
                QueryRaiseEC1Question.Visible = false;
                TextBoxRaiseEC1Question.Visible = false;
            }

            else if ((ImageQueryEC1Question.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedEC1Question.Visible = true;
                RespondedEC1Question.ShowPopupWindow();
            }
            else if ((ImageQueryEC1Question.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseEC1Question_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblEC1Question.Text + "','" + TextBoxRaiseEC1Question.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryEC1Question_Click(object sender, EventArgs e)
    {
        ...
        RespondedEC1QuestionClose.Visible = false;
    ...
    private void SetImageQueryEC2Question()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryEC2Question.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryEC2Question.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryEC2Question.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryEC2Question.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryEC2Question_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryEC2Question.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEEC2Question.Visible = true;
                RAISEEC2Question.ShowPopupWindow();
                QueryRaiseEC2Question.Visible = true;
                TextBoxRaiseEC2Question.Visible = true;
            ...
            else if ((ImageQueryEC2Question.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEEC2Question.Visible = true;
                RAISEEC2Question.ShowPopupWindow();
                QueryRaiseEC2Question.Visible = false;
                TextBoxRaiseEC2Question.Visible = false;
            }

            else if ((ImageQueryEC2Question.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedEC2Question.Visible = true;
                RespondedEC2Question.ShowPopupWindow();
            }
            else if ((ImageQueryEC2Question.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseEC2Question_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblEC2Question.Text + "','" + TextBoxRaiseEC2Question.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryEC2Question_Click(object sender, EventArgs e)
    {
        ...
        RespondedEC2QuestionClose.Visible = false;
    ...
    private void SetImageQueryEC3Question()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryEC3Question.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryEC3Question.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryEC3Question.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryEC3Question.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryEC3Question_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryEC3Question.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEEC3Question.Visible = true;
                RAISEEC3Question.ShowPopupWindow();
                QueryRaiseEC3Question.Visible = true;
                TextBoxRaiseEC3Question.Visible = true;
            ...
            else if ((ImageQueryEC3Question.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEEC3Question.Visible = true;
                RAISEEC3Question.ShowPopupWindow();
                QueryRaiseEC3Question.Visible = false;
                TextBoxRaiseEC3Question.Visible = false;
            }

            else if ((ImageQueryEC3Question.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedEC3Question.Visible = true;
                RespondedEC3Question.ShowPopupWindow();
            }
            else if ((ImageQueryEC3Question.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseEC3Question_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblEC3Question.Text + "','" + TextBoxRaiseEC3Question.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryEC3Question_Click(object sender, EventArgs e)
    {
        ...
        RespondedEC3QuestionClose.Visible = false;
