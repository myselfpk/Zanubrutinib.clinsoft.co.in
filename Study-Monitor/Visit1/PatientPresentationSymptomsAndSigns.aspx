<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PatientPresentationSymptomsAndSigns.aspx.cs" Inherits="Study_Monitor_Visit1_PatientPresentationSymptomsAndSigns" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Study Monitor | Visit 1 | Patient Presentation (Symptoms And Signs)</title>
   ...
   <script type="text/javascript">
       function Confirm() {
           ...
           if (validated) {
               ...
               if (confirm("Do you want to Lock Patient Presentation (Symptoms And Signs) page?")) {
    ...
    <script type="text/javascript">
        function Confirm1() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to SDV Patient Presentation (Symptoms And Signs) page?")) {
    ...
    <script type="text/javascript">
        function Confirm2() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to Unlocked Patient Presentation (Symptoms And Signs) page?")) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
                            ...
                            <div class="row">
                                <div class="text-center">
                                    ...
                                    <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                        ...
                                        <tr>
                                            <td align="center" class="auto-style2">
                                                <asp:Label runat="server" ID="lblPSSASYMP">Asymptomatic</asp:Label>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                                    CssClass="Validators" Display="None" ErrorMessage="Please mention Asymptomatic" ControlToValidate="RadioButtonListPSSASYMP"
                                                    ValidationGroup="IC"></asp:RequiredFieldValidator>
                                            </td>

                                            <td align="center" class="auto-style2">

                                                <asp:DropDownList ID="RadioButtonListPSSASYMP" class="form-control" Height="45px" Width="350px" runat="server" ValidationGroup="IC">
                                            ...
                                            <td>
                                                <asp:ImageButton ID="ImageQueryPSSASYMP" Height="25px" Width="25px" runat="server" OnClick="ImageQueryPSSASYMP_Click" />
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td align="center" class="auto-style20">
                                                <asp:Label ID="lblSIGN2DAT" runat="server">Third heart sound (gallop rhythm)</asp:Label>
                                            </td>
                                            <td>
    ...
    <div id="ct100_PopupWindow2">
        ...
        <!-- Query Asymptomatic-->
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel  HeaderText="Raise Query: Asymptomatic" ID="RAISEPSSASYMP" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEPSSASYMP" runat="server">
                    <div align="left" style="width: 300px"  >
                        <asp:Panel ID="PanelRaisePSSASYMP" runat="server" BorderStyle="Solid" BackColor="Red">
                        <asp:Label ID="LabelRaisePSSASYMP" runat="server"  > </asp:Label>
                            </asp:Panel>
                        <br />
                          <asp:Panel ID="PanelRaisePSSASYMP2" runat="server" BorderStyle="Solid" BackColor="Yellow">
                         <asp:Label ID="LabelRaisePSSASYMP2" runat="server"  > </asp:Label>
                              </asp:Panel>
                        <br />
                                <asp:Panel ID="PanelRaisePSSASYMP3" runat="server" BorderStyle="Solid" BackColor="#009933">
                         <asp:Label ID="LabelRaisePSSASYMP3" runat="server"   > </asp:Label>
                                    </asp:Panel>
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaisePSSASYMP"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaisePSSASYMP" runat="server" Text="Raise Query" OnClick="QueryRaisePSSASYMP_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Asymptomatic" ID="RAISEPSSASYMPMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEPSSASYMPMSG" runat="server">
                     <div align="center" style="width: 300px; height: 200px">
                        <br />
                    <asp:Panel ID="Panel2" runat="server" BorderStyle="Solid" >

                             Query has been Raised to the Asymptomatic Field
                             </asp:Panel>
                         </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel HeaderText="Raise Query: Asymptomatic" ID="RespondedPSSASYMP" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRespondedPSSASYMP" runat="server">
                    <div align="left" style="width: 300px"  >
                        <asp:Panel ID="PanelRespondedPSSASYMP" runat="server" BorderStyle="Solid" BackColor="Red">
                        <asp:Label ID="LabelRespondedPSSASYMP" runat="server"  > </asp:Label>
                            </asp:Panel>
                        <br />
                          <asp:Panel ID="PanelRespondedPSSASYMP2" runat="server" BorderStyle="Solid" BackColor="Yellow">
                         <asp:Label ID="LabelRespondedPSSASYMP2" runat="server"  > </asp:Label>
                              </asp:Panel>
                        <br />
                                <asp:Panel ID="PanelRespondedPSSASYMP3" runat="server" BorderStyle="Solid" BackColor="#009933">
                         <asp:Label ID="LabelRespondedPSSASYMP3" runat="server"   > </asp:Label>
                                    </asp:Panel>
                          <br />
                        
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedPSSASYMPClose" runat="server" Text="Close Query"   OnClick="CloseQueryPSSASYMP_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Asymptomatic" ID="CLOSEPSSASYMPMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowCLOSEPSSASYMPMSG" runat="server">
                     <div align="center" style="width: 300px; height: 200px">
                        <br />
                    <asp:Panel ID="PanelCLOSEPSSASYMPMSG" runat="server" BorderStyle="Solid" >

                            Query is Closed of the Asymptomatic Field
                             </asp:Panel>
                         </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel HeaderText="Raise Query: Asymptomatic" ID="ClosePSSASYMP" runat="server" OnCloseWindowClick="MycloseWindow">
           <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowClosePSSASYMP" runat="server">
                    <div align="left" style="width: 300px"  >
                        <asp:Panel ID="PanelClosePSSASYMP" runat="server" BorderStyle="Solid" BackColor="Red">
                        <asp:Label ID="LabelClosePSSASYMP" runat="server"  > </asp:Label>
                            </asp:Panel>
                        <br />
                          <asp:Panel ID="PanelClosePSSASYMP2" runat="server" BorderStyle="Solid" BackColor="Yellow">
                         <asp:Label ID="LabelClosePSSASYMP2" runat="server"  > </asp:Label>
                              </asp:Panel>
                        <br />
                                <asp:Panel ID="PanelClosePSSASYMP3" runat="server" BorderStyle="Solid" BackColor="#009933">
                         <asp:Label ID="LabelClosePSSASYMP3" runat="server"   > </asp:Label>
                                    </asp:Panel>
                      <br />
                        
                         <div style="margin-top: 10px">
                       
                              <asp:Button ID="ButtonClosePSSASYMP" runat="server" Text="Reraise Query"   OnClick="SubmitReRaisePSSASYMP_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Asymptomatic" ID="LockPSSASYMP" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowLockPSSASYMP" runat="server">
                    <div align="left" style="width: 300px"  >
                        <asp:Panel ID="PanelLockPSSASYMP" runat="server" BorderStyle="Solid" BackColor="Red">
                        <asp:Label ID="LabelLockPSSASYMP" runat="server"  > </asp:Label>
                            </asp:Panel>
                        <br />
                          <asp:Panel ID="PanelLockPSSASYMP2" runat="server" BorderStyle="Solid" BackColor="Yellow">
                         <asp:Label ID="LabelLockPSSASYMP2" runat="server"  > </asp:Label>
                              </asp:Panel>
                        <br />
                                <asp:Panel ID="PanelLockPSSASYMP3" runat="server" BorderStyle="Solid" BackColor="#009933">
                         <asp:Label ID="LabelLockPSSASYMP3" runat="server"   > </asp:Label>
                                    </asp:Panel>
                      <br />
                        <asp:Panel ID="PanelLockPSSASYMPText" runat="server" BorderStyle="Solid" >
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESYMP1DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSYMP1DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSYMP1DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSYMP1DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSYMP1DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSYMP1DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySYMP1DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSYMP1DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSYMP1DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESIGN1DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSIGN1DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSIGN1DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSIGN1DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSIGN1DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSIGN1DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySIGN1DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSIGN1DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSIGN1DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESYMP2DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSYMP2DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSYMP2DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSYMP2DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSYMP2DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSYMP2DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySYMP2DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSYMP2DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSYMP2DAT_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
        ...
        <!-- Query Third heart sound (gallop rhythm)-->
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel  HeaderText="Raise Query: Third heart sound (gallop rhythm)" ID="RAISESIGN2DAT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESIGN2DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSIGN2DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSIGN2DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSIGN2DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Third heart sound (gallop rhythm)" ID="RAISESIGN2DATMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESIGN2DATMSG" runat="server">
                    ...
                    <asp:Panel ID="Panel5" runat="server" BorderStyle="Solid" >
                             ...
                             Query has been Raised to the Third heart sound (gallop rhythm) Field
                             </asp:Panel>
                         </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel HeaderText="Raise Query: Third heart sound (gallop rhythm)" ID="RespondedSIGN2DAT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRespondedSIGN2DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSIGN2DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySIGN2DAT_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Third heart sound (gallop rhythm)" ID="CLOSESIGN2DATMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowCLOSESIGN2DATMSG" runat="server">
                    ...
                    <asp:Panel ID="PanelCLOSESIGN2DATMSG" runat="server" BorderStyle="Solid" >
                            ...
                            Query is Closed of the Third heart sound (gallop rhythm) Field
                             </asp:Panel>
                         </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel HeaderText="Raise Query: Third heart sound (gallop rhythm)" ID="CloseSIGN2DAT" runat="server" OnCloseWindowClick="MycloseWindow">
           <PopupWindow runat="server">
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSIGN2DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSIGN2DAT_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Third heart sound (gallop rhythm)" ID="LockSIGN2DAT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESYMP3DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSYMP3DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSYMP3DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSYMP3DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSYMP3DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSYMP3DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySYMP3DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSYMP3DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSYMP3DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESIGN3DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSIGN3DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSIGN3DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSIGN3DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSIGN3DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSIGN3DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySIGN3DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSIGN3DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSIGN3DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESYMP4DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSYMP4DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSYMP4DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSYMP4DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSYMP4DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSYMP4DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySYMP4DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSYMP4DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSYMP4DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESIGN4DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSIGN4DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSIGN4DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSIGN4DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSIGN4DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSIGN4DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySIGN4DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSIGN4DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSIGN4DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESYMP5DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSYMP5DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSYMP5DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSYMP5DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSYMP5DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSYMP5DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySYMP5DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSYMP5DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSYMP5DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESIGN5DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSIGN5DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSIGN5DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSIGN5DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSIGN5DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSIGN5DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySIGN5DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSIGN5DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSIGN5DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESYMP6DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSYMP6DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSYMP6DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSYMP6DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSYMP6DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSYMP6DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySYMP6DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSYMP6DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSYMP6DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESIGN6DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSIGN6DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSIGN6DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSIGN6DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSIGN6DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSIGN6DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySIGN6DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSIGN6DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSIGN6DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESYMP7DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSYMP7DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSYMP7DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSYMP7DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSYMP7DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSYMP7DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySYMP7DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSYMP7DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSYMP7DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESIGN7DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSIGN7DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSIGN7DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSIGN7DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSIGN7DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSIGN7DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySIGN7DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSIGN7DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSIGN7DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESYMP8DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSYMP8DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSYMP8DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSYMP8DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSYMP8DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSYMP8DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySYMP8DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSYMP8DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSYMP8DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESIGN8DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSIGN8DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSIGN8DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSIGN8DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSIGN8DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSIGN8DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySIGN8DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSIGN8DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSIGN8DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESYMP9DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSYMP9DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSYMP9DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSYMP9DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSYMP9DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSYMP9DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySYMP9DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSYMP9DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSYMP9DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESIGN9DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSIGN9DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSIGN9DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSIGN9DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSIGN9DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSIGN9DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySIGN9DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSIGN9DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSIGN9DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESYMP10DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSYMP10DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSYMP10DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSYMP10DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSYMP10DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSYMP10DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySYMP10DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSYMP10DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSYMP10DAT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISESIGN10DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseSIGN10DAT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseSIGN10DAT" runat="server" Text="Raise Query" OnClick="QueryRaiseSIGN10DAT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedSIGN10DAT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedSIGN10DATClose" runat="server" Text="Close Query"   OnClick="CloseQuerySIGN10DAT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseSIGN10DAT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseSIGN10DAT_Click" />
                       </div>
