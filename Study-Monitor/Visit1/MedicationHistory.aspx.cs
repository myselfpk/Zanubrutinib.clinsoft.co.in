...
public partial class Study_Monitor_Visit1_MedicationHistory : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    public void OnConfirm(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit1].[MedicalHistory]  set  LockStatus = 'Locked' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con1);
    ...
    public void OnConfirm1(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit1].[MedicalHistory]  set  LockStatus = 'SDV' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con1);
    ...
    public void OnConfirm2(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit1].[MedicalHistory]  set  LockStatus = 'Unlocked' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con1);
    ...
    private void SetImageQueryMH1DURA()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMH1DURA.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMH1DURA.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMH1DURA.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMH1DURA.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMH1DURA_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMH1DURA.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMH1DURA.Visible = true;
                RAISEMH1DURA.ShowPopupWindow();
                QueryRaiseMH1DURA.Visible = true;
                TextBoxRaiseMH1DURA.Visible = true;
            ...
            else if ((ImageQueryMH1DURA.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMH1DURA.Visible = true;
                RAISEMH1DURA.ShowPopupWindow();
                QueryRaiseMH1DURA.Visible = false;
                TextBoxRaiseMH1DURA.Visible = false;
            }

            else if ((ImageQueryMH1DURA.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMH1DURA.Visible = true;
                RespondedMH1DURA.ShowPopupWindow();
            }
            else if ((ImageQueryMH1DURA.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMH1DURA_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMH1DURA.Text + "','" + TextBoxRaiseMH1DURA.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMH1DURA_Click(object sender, EventArgs e)
    {
        ...
        RespondedMH1DURAClose.Visible = false;
    ...
    private void SetImageQueryMH2DURA()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMH2DURA.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMH2DURA.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMH2DURA.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMH2DURA.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMH2DURA_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMH2DURA.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMH2DURA.Visible = true;
                RAISEMH2DURA.ShowPopupWindow();
                QueryRaiseMH2DURA.Visible = true;
                TextBoxRaiseMH2DURA.Visible = true;
            ...
            else if ((ImageQueryMH2DURA.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMH2DURA.Visible = true;
                RAISEMH2DURA.ShowPopupWindow();
                QueryRaiseMH2DURA.Visible = false;
                TextBoxRaiseMH2DURA.Visible = false;
            }

            else if ((ImageQueryMH2DURA.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMH2DURA.Visible = true;
                RespondedMH2DURA.ShowPopupWindow();
            }
            else if ((ImageQueryMH2DURA.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMH2DURA_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMH2DURA.Text + "','" + TextBoxRaiseMH2DURA.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMH2DURA_Click(object sender, EventArgs e)
    {
        ...
        RespondedMH2DURAClose.Visible = false;
    ...
    private void SetImageQueryMH3DURA()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMH3DURA.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMH3DURA.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMH3DURA.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMH3DURA.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMH3DURA_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMH3DURA.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMH3DURA.Visible = true;
                RAISEMH3DURA.ShowPopupWindow();
                QueryRaiseMH3DURA.Visible = true;
                TextBoxRaiseMH3DURA.Visible = true;
            ...
            else if ((ImageQueryMH3DURA.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMH3DURA.Visible = true;
                RAISEMH3DURA.ShowPopupWindow();
                QueryRaiseMH3DURA.Visible = false;
                TextBoxRaiseMH3DURA.Visible = false;
            }

            else if ((ImageQueryMH3DURA.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMH3DURA.Visible = true;
                RespondedMH3DURA.ShowPopupWindow();
            }
            else if ((ImageQueryMH3DURA.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMH3DURA_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMH3DURA.Text + "','" + TextBoxRaiseMH3DURA.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMH3DURA_Click(object sender, EventArgs e)
    {
        ...
        RespondedMH3DURAClose.Visible = false;
    ...
    private void SetImageQueryMH4DURA()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMH4DURA.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMH4DURA.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMH4DURA.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMH4DURA.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMH4DURA_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMH4DURA.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMH4DURA.Visible = true;
                RAISEMH4DURA.ShowPopupWindow();
                QueryRaiseMH4DURA.Visible = true;
                TextBoxRaiseMH4DURA.Visible = true;
            ...
            else if ((ImageQueryMH4DURA.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMH4DURA.Visible = true;
                RAISEMH4DURA.ShowPopupWindow();
                QueryRaiseMH4DURA.Visible = false;
                TextBoxRaiseMH4DURA.Visible = false;
            }

            else if ((ImageQueryMH4DURA.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMH4DURA.Visible = true;
                RespondedMH4DURA.ShowPopupWindow();
            }
            else if ((ImageQueryMH4DURA.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMH4DURA_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMH4DURA.Text + "','" + TextBoxRaiseMH4DURA.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMH4DURA_Click(object sender, EventArgs e)
    {
        ...
        RespondedMH4DURAClose.Visible = false;
    ...
    private void SetImageQueryMH5DURA()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMH5DURA.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMH5DURA.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMH5DURA.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMH5DURA.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMH5DURA_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMH5DURA.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMH5DURA.Visible = true;
                RAISEMH5DURA.ShowPopupWindow();
                QueryRaiseMH5DURA.Visible = true;
                TextBoxRaiseMH5DURA.Visible = true;
            ...
            else if ((ImageQueryMH5DURA.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMH5DURA.Visible = true;
                RAISEMH5DURA.ShowPopupWindow();
                QueryRaiseMH5DURA.Visible = false;
                TextBoxRaiseMH5DURA.Visible = false;
            }

            else if ((ImageQueryMH5DURA.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMH5DURA.Visible = true;
                RespondedMH5DURA.ShowPopupWindow();
            }
            else if ((ImageQueryMH5DURA.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMH5DURA_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMH5DURA.Text + "','" + TextBoxRaiseMH5DURA.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMH5DURA_Click(object sender, EventArgs e)
    {
        ...
        RespondedMH5DURAClose.Visible = false;
    ...
    private void SetImageQueryMH6DURA()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMH6DURA.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMH6DURA.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMH6DURA.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMH6DURA.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMH6DURA_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMH6DURA.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMH6DURA.Visible = true;
                RAISEMH6DURA.ShowPopupWindow();
                QueryRaiseMH6DURA.Visible = true;
                TextBoxRaiseMH6DURA.Visible = true;
            ...
            else if ((ImageQueryMH6DURA.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMH6DURA.Visible = true;
                RAISEMH6DURA.ShowPopupWindow();
                QueryRaiseMH6DURA.Visible = false;
                TextBoxRaiseMH6DURA.Visible = false;
            }

            else if ((ImageQueryMH6DURA.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMH6DURA.Visible = true;
                RespondedMH6DURA.ShowPopupWindow();
            }
            else if ((ImageQueryMH6DURA.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMH6DURA_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMH6DURA.Text + "','" + TextBoxRaiseMH6DURA.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMH6DURA_Click(object sender, EventArgs e)
    {
        ...
        RespondedMH6DURAClose.Visible = false;
    ...
    private void SetImageQueryMH7DURA()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMH7DURA.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMH7DURA.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMH7DURA.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMH7DURA.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMH7DURA_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMH7DURA.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMH7DURA.Visible = true;
                RAISEMH7DURA.ShowPopupWindow();
                QueryRaiseMH7DURA.Visible = true;
                TextBoxRaiseMH7DURA.Visible = true;
            ...
            else if ((ImageQueryMH7DURA.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMH7DURA.Visible = true;
                RAISEMH7DURA.ShowPopupWindow();
                QueryRaiseMH7DURA.Visible = false;
                TextBoxRaiseMH7DURA.Visible = false;
            }

            else if ((ImageQueryMH7DURA.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMH7DURA.Visible = true;
                RespondedMH7DURA.ShowPopupWindow();
            }
            else if ((ImageQueryMH7DURA.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMH7DURA_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMH7DURA.Text + "','" + TextBoxRaiseMH7DURA.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMH7DURA_Click(object sender, EventArgs e)
    {
        ...
        RespondedMH7DURAClose.Visible = false;
    ...
    private void SetImageQueryMH8DURA()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMH8DURA.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMH8DURA.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMH8DURA.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMH8DURA.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMH8DURA_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMH8DURA.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMH8DURA.Visible = true;
                RAISEMH8DURA.ShowPopupWindow();
                QueryRaiseMH8DURA.Visible = true;
                TextBoxRaiseMH8DURA.Visible = true;
            ...
            else if ((ImageQueryMH8DURA.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMH8DURA.Visible = true;
                RAISEMH8DURA.ShowPopupWindow();
                QueryRaiseMH8DURA.Visible = false;
                TextBoxRaiseMH8DURA.Visible = false;
            }

            else if ((ImageQueryMH8DURA.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMH8DURA.Visible = true;
                RespondedMH8DURA.ShowPopupWindow();
            }
            else if ((ImageQueryMH8DURA.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMH8DURA_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMH8DURA.Text + "','" + TextBoxRaiseMH8DURA.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMH8DURA_Click(object sender, EventArgs e)
    {
        ...
        RespondedMH8DURAClose.Visible = false;
    ...
    private void SetImageQueryMH9DURA()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMH9DURA.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMH9DURA.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMH9DURA.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMH9DURA.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMH9DURA_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMH9DURA.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMH9DURA.Visible = true;
                RAISEMH9DURA.ShowPopupWindow();
                QueryRaiseMH9DURA.Visible = true;
                TextBoxRaiseMH9DURA.Visible = true;
            ...
            else if ((ImageQueryMH9DURA.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMH9DURA.Visible = true;
                RAISEMH9DURA.ShowPopupWindow();
                QueryRaiseMH9DURA.Visible = false;
                TextBoxRaiseMH9DURA.Visible = false;
            }

            else if ((ImageQueryMH9DURA.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMH9DURA.Visible = true;
                RespondedMH9DURA.ShowPopupWindow();
            }
            else if ((ImageQueryMH9DURA.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMH9DURA_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMH9DURA.Text + "','" + TextBoxRaiseMH9DURA.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMH9DURA_Click(object sender, EventArgs e)
    {
        ...
        RespondedMH9DURAClose.Visible = false;
    ...
    private void SetImageQueryMH10DURA()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMH10DURA.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMH10DURA.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMH10DURA.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryMH10DURA.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryMH10DURA_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMH10DURA.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEMH10DURA.Visible = true;
                RAISEMH10DURA.ShowPopupWindow();
                QueryRaiseMH10DURA.Visible = true;
                TextBoxRaiseMH10DURA.Visible = true;
            ...
            else if ((ImageQueryMH10DURA.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMH10DURA.Visible = true;
                RAISEMH10DURA.ShowPopupWindow();
                QueryRaiseMH10DURA.Visible = false;
                TextBoxRaiseMH10DURA.Visible = false;
            }

            else if ((ImageQueryMH10DURA.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMH10DURA.Visible = true;
                RespondedMH10DURA.ShowPopupWindow();
            }
            else if ((ImageQueryMH10DURA.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMH10DURA_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMH10DURA.Text + "','" + TextBoxRaiseMH10DURA.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryMH10DURA_Click(object sender, EventArgs e)
    {
        ...
        RespondedMH10DURAClose.Visible = false;
