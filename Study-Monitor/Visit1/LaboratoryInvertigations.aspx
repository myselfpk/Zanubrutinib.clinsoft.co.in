<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LaboratoryInvertigations.aspx.cs" Inherits="Study_Monitor_Visit1_LaboratoryInvertigations" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Study Monitor | Visit 1 | Laboratory Investigations</title>
  ...
  <script type="text/javascript">
      function Confirm() {
          ...
          if (validated) {
              ...
              if (confirm("Do you want to Lock Laboratory Investigations page?")) {
    ...
    <script type="text/javascript">
        function Confirm1() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to SDV Laboratory Investigations page?")) {
    ...
    <script type="text/javascript">
        function Confirm2() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to Unlocked Laboratory Investigations page?")) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
                                    ...
                                    <table cellpadding="5px;" cellspacing="0" border="Solid" width="100%" class="CSSTableGenerator">
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB1RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB2RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB3RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB4RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB5RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB6RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>

                                                <br />
                                                <br />
                                                <asp:DropDownList ID="RadioButtonListLAB6PN" class="form-control" Height="45px" Width="90%" runat="server" ValidationGroup="IC">
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB7RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB8RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB9RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB10RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
    ...
    <td colspan="6">If any other Laboratory investigations are present, please provide details below:
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB11PARA" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>

                                            </td>
                                            <td>

                                                <asp:TextBox ID="TextBoxLAB11RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB12PARA" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>

                                            </td>
                                            <td>

                                                <asp:TextBox ID="TextBoxLAB12RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB13PARA" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>

                                            </td>
                                            <td>

                                                <asp:TextBox ID="TextBoxLAB13RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB14PARA" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>

                                            </td>
                                            <td>

                                                <asp:TextBox ID="TextBoxLAB14RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
                                        ...
                                        <tr class="auto-style2">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="TextBoxLAB15PARA" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>

                                            </td>
                                            <td>

                                                <asp:TextBox ID="TextBoxLAB15RSLT" runat="server" class="form-control" Height="45px" Width="90%" ValidationGroup="IC"></asp:TextBox>
    ...
    <asp:Label runat="server" ID="lblLAB11RSLT" Text="Other Lab Result 1" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblLAB12RSLT" Text="Other Lab Result 2" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblLAB13RSLT" Text="Other Lab Result 3" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblLAB14RSLT" Text="Other Lab Result 4" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblLAB15RSLT" Text="Other Lab Result 5" Visible="false"></asp:Label>

    <asp:Label runat="server" ID="lblLAB11PARA" Text="Other Lab Parameter 1" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblLAB12PARA" Text="Other Lab Parameter 2" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblLAB13PARA" Text="Other Lab Parameter 3" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblLAB14PARA" Text="Other Lab Parameter 4" Visible="false"></asp:Label>
    <asp:Label runat="server" ID="lblLAB15PARA" Text="Other Lab Parameter 5" Visible="false"></asp:Label>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB1RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB1RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB1RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB1RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB1RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB1RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB1RSLT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB1RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB1RSLT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB2RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB2RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB2RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB2RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB2RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB2RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB2RSLT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB2RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB2RSLT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB3RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB3RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB3RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB3RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB3RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB3RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB3RSLT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB3RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB3RSLT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB4RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB4RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB4RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB4RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB4RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB4RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB4RSLT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB4RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB4RSLT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB5RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB5RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB5RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB5RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB5RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB5RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB5RSLT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB5RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB5RSLT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB6RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB6RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB6RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB6RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB6RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB6RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB6RSLT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB6RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB6RSLT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB7RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB7RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB7RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB7RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB7RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB7RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB7RSLT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB7RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB7RSLT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB8RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB8RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB8RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB8RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB8RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB8RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB8RSLT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB8RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB8RSLT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB9RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB9RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB9RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB9RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB9RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB9RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB9RSLT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB9RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB9RSLT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB10RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB10RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB10RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB10RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB10RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB10RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB10RSLT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB10RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB10RSLT_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel  HeaderText="Raise Query: Other Lab Parameter & Result 1" ID="RAISELAB11RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB11RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB11RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB11RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB11RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 1" ID="RAISELAB11RSLTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 1" ID="RespondedLAB11RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB11RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB11RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB11RSLT_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 1" ID="CLOSELAB11RSLTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 1" ID="CloseLAB11RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
           <PopupWindow runat="server">
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB11RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB11RSLT_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 1" ID="LockLAB11RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel  HeaderText="Raise Query: Other Lab Parameter & Result 2" ID="RAISELAB12RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB12RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB12RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB12RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB12RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 2" ID="RAISELAB12RSLTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 2" ID="RespondedLAB12RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB12RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB12RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB12RSLT_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 2" ID="CLOSELAB12RSLTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 2" ID="CloseLAB12RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
           <PopupWindow runat="server">
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB12RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB12RSLT_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 2" ID="LockLAB12RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel  HeaderText="Raise Query: Other Lab Parameter & Result 3" ID="RAISELAB13RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB13RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB13RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB13RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB13RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 3" ID="RAISELAB13RSLTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 3" ID="RespondedLAB13RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB13RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB13RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB13RSLT_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 3" ID="CLOSELAB13RSLTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 3" ID="CloseLAB13RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
           <PopupWindow runat="server">
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB13RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB13RSLT_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 3" ID="LockLAB13RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel  HeaderText="Raise Query: Other Lab Parameter & Result 4" ID="RAISELAB14RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB14RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB14RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB14RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB14RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 4" ID="RAISELAB14RSLTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 4" ID="RespondedLAB14RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB14RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB14RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB14RSLT_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 4" ID="CLOSELAB14RSLTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 4" ID="CloseLAB14RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
           <PopupWindow runat="server">
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB14RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB14RSLT_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 4" ID="LockLAB14RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
       ...
       <!-- Query Other Lab Parameter & Result 5-->
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel  HeaderText="Raise Query: Other Lab Parameter & Result 5" ID="RAISELAB15RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB15RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseLAB15RSLT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseLAB15RSLT" runat="server" Text="Raise Query" OnClick="QueryRaiseLAB15RSLT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 5" ID="RAISELAB15RSLTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISELAB15RSLTMSG" runat="server">
                    ...
                    <asp:Panel ID="Panel15" runat="server" BorderStyle="Solid" >
                             ...
                             Query has been Raised to the Other Lab Parameter & Result 5 Field
                             </asp:Panel>
                         </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 5" ID="RespondedLAB15RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRespondedLAB15RSLT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedLAB15RSLTClose" runat="server" Text="Close Query"   OnClick="CloseQueryLAB15RSLT_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 5" ID="CLOSELAB15RSLTMSG" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowCLOSELAB15RSLTMSG" runat="server">
                    ...
                    <asp:Panel ID="PanelCLOSELAB15RSLTMSG" runat="server" BorderStyle="Solid" >
                            ...
                            Query is Closed of the Other Lab Parameter & Result 5 Field
                             </asp:Panel>
                         </div>
                </ASPP:PopupWindow>
            </PopupWindow>
    ...
    <div id="ct100_PopupWindow1">
          <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 5" ID="CloseLAB15RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
           <PopupWindow runat="server">
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseLAB15RSLT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseLAB15RSLT_Click" />
                       </div>
    ...
    <div id="ct100_PopupWindow1">
                        <ASPP:PopupPanel HeaderText="Raise Query: Other Lab Parameter & Result 5" ID="LockLAB15RSLT" runat="server" OnCloseWindowClick="MycloseWindow">
            <PopupWindow runat="server">
