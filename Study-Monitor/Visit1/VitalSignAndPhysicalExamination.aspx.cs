...
public partial class Study_Monitor_Visit1_VitalSignAndPhysicalExamination : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    private void BindPage()
    {
        con.Close();
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("SELECT PEHEIGHT ,PEWEIGHT ,PEBMI ,VSSBP ,VSDBP ,VSPR ,ST1OPT ,FIND1OPT ,JVPEVAL ,VTVF ,ST2OPT ,FINE1OPT ,OTRFIND, LockStatus FROM [Visit1].[VitalSignAndPhysicalExamination] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
    ...
    public void OnConfirm(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit1].[VitalSignAndPhysicalExamination]  set  LockStatus = 'Locked' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con1);
    ...
    public void OnConfirm1(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit1].[VitalSignAndPhysicalExamination]  set  LockStatus = 'SDV' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con1);
    ...
    public void OnConfirm2(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            cmd1 = new SqlCommand("Update [Visit1].[VitalSignAndPhysicalExamination]  set  LockStatus = 'Unlocked' where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con1);
    ...
    private void SetImageQueryPEHEIGHT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryPEHEIGHT.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryPEHEIGHT.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryPEHEIGHT.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryPEHEIGHT.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryPEHEIGHT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryPEHEIGHT.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEPEHEIGHT.Visible = true;
                RAISEPEHEIGHT.ShowPopupWindow();
                QueryRaisePEHEIGHT.Visible = true;
                TextBoxRaisePEHEIGHT.Visible = true;
            ...
            else if ((ImageQueryPEHEIGHT.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEPEHEIGHT.Visible = true;
                RAISEPEHEIGHT.ShowPopupWindow();
                QueryRaisePEHEIGHT.Visible = false;
                TextBoxRaisePEHEIGHT.Visible = false;
            }

            else if ((ImageQueryPEHEIGHT.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedPEHEIGHT.Visible = true;
                RespondedPEHEIGHT.ShowPopupWindow();
            }
            else if ((ImageQueryPEHEIGHT.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaisePEHEIGHT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblPEHEIGHT.Text + "','" + TextBoxRaisePEHEIGHT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryPEHEIGHT_Click(object sender, EventArgs e)
    {
        ...
        RespondedPEHEIGHTClose.Visible = false;
    ...
    private void SetImageQueryPEWEIGHT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryPEWEIGHT.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryPEWEIGHT.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryPEWEIGHT.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryPEWEIGHT.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryPEWEIGHT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryPEWEIGHT.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEPEWEIGHT.Visible = true;
                RAISEPEWEIGHT.ShowPopupWindow();
                QueryRaisePEWEIGHT.Visible = true;
                TextBoxRaisePEWEIGHT.Visible = true;
            ...
            else if ((ImageQueryPEWEIGHT.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEPEWEIGHT.Visible = true;
                RAISEPEWEIGHT.ShowPopupWindow();
                QueryRaisePEWEIGHT.Visible = false;
                TextBoxRaisePEWEIGHT.Visible = false;
            }

            else if ((ImageQueryPEWEIGHT.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedPEWEIGHT.Visible = true;
                RespondedPEWEIGHT.ShowPopupWindow();
            }
            else if ((ImageQueryPEWEIGHT.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaisePEWEIGHT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblPEWEIGHT.Text + "','" + TextBoxRaisePEWEIGHT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryPEWEIGHT_Click(object sender, EventArgs e)
    {
        ...
        RespondedPEWEIGHTClose.Visible = false;
    ...
    private void SetImageQueryPEBMI()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryPEBMI.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryPEBMI.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryPEBMI.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryPEBMI.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryPEBMI_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryPEBMI.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEPEBMI.Visible = true;
                RAISEPEBMI.ShowPopupWindow();
                QueryRaisePEBMI.Visible = true;
                TextBoxRaisePEBMI.Visible = true;
            ...
            else if ((ImageQueryPEBMI.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEPEBMI.Visible = true;
                RAISEPEBMI.ShowPopupWindow();
                QueryRaisePEBMI.Visible = false;
                TextBoxRaisePEBMI.Visible = false;
            }

            else if ((ImageQueryPEBMI.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedPEBMI.Visible = true;
                RespondedPEBMI.ShowPopupWindow();
            }
            else if ((ImageQueryPEBMI.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaisePEBMI_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblPEBMI.Text + "','" + TextBoxRaisePEBMI.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryPEBMI_Click(object sender, EventArgs e)
    {
        ...
        RespondedPEBMIClose.Visible = false;
    ...
    private void SetImageQueryVSSBP()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryVSSBP.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryVSSBP.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryVSSBP.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryVSSBP.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryVSSBP_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryVSSBP.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryVSSBP.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEVSSBP.Visible = true;
                RAISEVSSBP.ShowPopupWindow();
            ...
            else if ((ImageQueryVSSBP.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedVSSBP.Visible = true;
                RespondedVSSBP.ShowPopupWindow();
            }
            else if ((ImageQueryVSSBP.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseVSSBP_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblVSSBP.Text + "','" + TextBoxRaiseVSSBP.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryVSSBP_Click(object sender, EventArgs e)
    {
        ...
        RespondedVSSBPClose.Visible = false;
    ...
    private void SetImageQueryVSDBP()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryVSDBP.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryVSDBP.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryVSDBP.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryVSDBP.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryVSDBP_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryVSDBP.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryVSDBP.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEVSDBP.Visible = true;
                RAISEVSDBP.ShowPopupWindow();
            ...
            else if ((ImageQueryVSDBP.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedVSDBP.Visible = true;
                RespondedVSDBP.ShowPopupWindow();
            }
            else if ((ImageQueryVSDBP.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseVSDBP_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblVSDBP.Text + "','" + TextBoxRaiseVSDBP.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryVSDBP_Click(object sender, EventArgs e)
    {
        ...
        RespondedVSDBPClose.Visible = false;
    ...
    private void SetImageQueryVSPR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryVSPR.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryVSPR.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryVSPR.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryVSPR.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryVSPR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryVSPR.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryVSPR.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEVSPR.Visible = true;
                RAISEVSPR.ShowPopupWindow();
            ...
            else if ((ImageQueryVSPR.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedVSPR.Visible = true;
                RespondedVSPR.ShowPopupWindow();
            }
            else if ((ImageQueryVSPR.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseVSPR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblVSPR.Text + "','" + TextBoxRaiseVSPR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryVSPR_Click(object sender, EventArgs e)
    {
        ...
        RespondedVSPRClose.Visible = false;
    ...
    private void SetImageQueryST1OPT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryST1OPT.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryST1OPT.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryST1OPT.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryST1OPT.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryST1OPT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryST1OPT.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEST1OPT.Visible = true;
                RAISEST1OPT.ShowPopupWindow();
                QueryRaiseST1OPT.Visible = true;
                TextBoxRaiseST1OPT.Visible = true;
            ...
            else if ((ImageQueryST1OPT.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEST1OPT.Visible = true;
                RAISEST1OPT.ShowPopupWindow();
                QueryRaiseST1OPT.Visible = false;
                TextBoxRaiseST1OPT.Visible = false;
            }

            else if ((ImageQueryST1OPT.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedST1OPT.Visible = true;
                RespondedST1OPT.ShowPopupWindow();
            }
            else if ((ImageQueryST1OPT.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseST1OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblST1OPT.Text + "','" + TextBoxRaiseST1OPT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryST1OPT_Click(object sender, EventArgs e)
    {
        ...
        RespondedST1OPTClose.Visible = false;
    ...
    private void SetImageQueryFIND1OPT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryFIND1OPT.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryFIND1OPT.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryFIND1OPT.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryFIND1OPT.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryFIND1OPT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryFIND1OPT.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEFIND1OPT.Visible = true;
                RAISEFIND1OPT.ShowPopupWindow();
                QueryRaiseFIND1OPT.Visible = true;
                TextBoxRaiseFIND1OPT.Visible = true;
            ...
            else if ((ImageQueryFIND1OPT.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEFIND1OPT.Visible = true;
                RAISEFIND1OPT.ShowPopupWindow();
                QueryRaiseFIND1OPT.Visible = false;
                TextBoxRaiseFIND1OPT.Visible = false;
            }

            else if ((ImageQueryFIND1OPT.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedFIND1OPT.Visible = true;
                RespondedFIND1OPT.ShowPopupWindow();
            }
            else if ((ImageQueryFIND1OPT.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseFIND1OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblFIND1OPT.Text + "','" + TextBoxRaiseFIND1OPT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryFIND1OPT_Click(object sender, EventArgs e)
    {
        ...
        RespondedFIND1OPTClose.Visible = false;
    ...
    private void SetImageQueryJVPEVAL()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryJVPEVAL.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryJVPEVAL.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryJVPEVAL.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryJVPEVAL.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryJVPEVAL_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryJVPEVAL.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEJVPEVAL.Visible = true;
                RAISEJVPEVAL.ShowPopupWindow();
                QueryRaiseJVPEVAL.Visible = true;
                TextBoxRaiseJVPEVAL.Visible = true;
            ...
            else if ((ImageQueryJVPEVAL.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEJVPEVAL.Visible = true;
                RAISEJVPEVAL.ShowPopupWindow();
                QueryRaiseJVPEVAL.Visible = false;
                TextBoxRaiseJVPEVAL.Visible = false;
            }

            else if ((ImageQueryJVPEVAL.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedJVPEVAL.Visible = true;
                RespondedJVPEVAL.ShowPopupWindow();
            }
            else if ((ImageQueryJVPEVAL.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseJVPEVAL_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblJVPEVAL.Text + "','" + TextBoxRaiseJVPEVAL.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryJVPEVAL_Click(object sender, EventArgs e)
    {
        ...
        RespondedJVPEVALClose.Visible = false;
    ...
    private void SetImageQueryVTVF()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryVTVF.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryVTVF.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryVTVF.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryVTVF.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryVTVF_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryVTVF.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEVTVF.Visible = true;
                RAISEVTVF.ShowPopupWindow();
                QueryRaiseVTVF.Visible = true;
                TextBoxRaiseVTVF.Visible = true;
            ...
            else if ((ImageQueryVTVF.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEVTVF.Visible = true;
                RAISEVTVF.ShowPopupWindow();
                QueryRaiseVTVF.Visible = false;
                TextBoxRaiseVTVF.Visible = false;
            }

            else if ((ImageQueryVTVF.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedVTVF.Visible = true;
                RespondedVTVF.ShowPopupWindow();
            }
            else if ((ImageQueryVTVF.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseVTVF_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblVTVF.Text + "','" + TextBoxRaiseVTVF.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryVTVF_Click(object sender, EventArgs e)
    {
        ...
        RespondedVTVFClose.Visible = false;
    ...
    private void SetImageQueryST2OPT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryST2OPT.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryST2OPT.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryST2OPT.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryST2OPT.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryST2OPT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryST2OPT.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEST2OPT.Visible = true;
                RAISEST2OPT.ShowPopupWindow();
                QueryRaiseST2OPT.Visible = true;
                TextBoxRaiseST2OPT.Visible = true;
            ...
            else if ((ImageQueryST2OPT.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEST2OPT.Visible = true;
                RAISEST2OPT.ShowPopupWindow();
                QueryRaiseST2OPT.Visible = false;
                TextBoxRaiseST2OPT.Visible = false;
            }

            else if ((ImageQueryST2OPT.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedST2OPT.Visible = true;
                RespondedST2OPT.ShowPopupWindow();
            }
            else if ((ImageQueryST2OPT.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseST2OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblST2OPT.Text + "','" + TextBoxRaiseST2OPT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryST2OPT_Click(object sender, EventArgs e)
    {
        ...
        RespondedST2OPTClose.Visible = false;
    ...
    private void SetImageQueryFINE1OPT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryFINE1OPT.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryFINE1OPT.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryFINE1OPT.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryFINE1OPT.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryFINE1OPT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryFINE1OPT.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEFINE1OPT.Visible = true;
                RAISEFINE1OPT.ShowPopupWindow();
                QueryRaiseFINE1OPT.Visible = true;
                TextBoxRaiseFINE1OPT.Visible = true;
            ...
            else if ((ImageQueryFINE1OPT.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEFINE1OPT.Visible = true;
                RAISEFINE1OPT.ShowPopupWindow();
                QueryRaiseFINE1OPT.Visible = false;
                TextBoxRaiseFINE1OPT.Visible = false;
            }

            else if ((ImageQueryFINE1OPT.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedFINE1OPT.Visible = true;
                RespondedFINE1OPT.ShowPopupWindow();
            }
            else if ((ImageQueryFINE1OPT.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseFINE1OPT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblFINE1OPT.Text + "','" + TextBoxRaiseFINE1OPT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryFINE1OPT_Click(object sender, EventArgs e)
    {
        ...
        RespondedFINE1OPTClose.Visible = false;
    ...
    private void SetImageQueryOTRFIND()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryOTRFIND.ImageUrl = "~/Study-Monitor/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryOTRFIND.ImageUrl = "~/Study-Monitor/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryOTRFIND.ImageUrl = "~/Study-Monitor/Images/Yellow.png";

            }
            else
            {
                ImageQueryOTRFIND.ImageUrl = "~/Study-Monitor/Images/Blue.jpg";
    ...
    protected void ImageQueryOTRFIND_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryOTRFIND.ImageUrl == "~/Study-Monitor/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEOTRFIND.Visible = true;
                RAISEOTRFIND.ShowPopupWindow();
                QueryRaiseOTRFIND.Visible = true;
                TextBoxRaiseOTRFIND.Visible = true;
            ...
            else if ((ImageQueryOTRFIND.ImageUrl == "~/Study-Monitor/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEOTRFIND.Visible = true;
                RAISEOTRFIND.ShowPopupWindow();
                QueryRaiseOTRFIND.Visible = false;
                TextBoxRaiseOTRFIND.Visible = false;
            }

            else if ((ImageQueryOTRFIND.ImageUrl == "~/Study-Monitor/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedOTRFIND.Visible = true;
                RespondedOTRFIND.ShowPopupWindow();
            }
            else if ((ImageQueryOTRFIND.ImageUrl == "~/Study-Monitor/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseOTRFIND_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblOTRFIND.Text + "','" + TextBoxRaiseOTRFIND.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    protected void CloseQueryOTRFIND_Click(object sender, EventArgs e)
    {
        ...
        RespondedOTRFINDClose.Visible = false;
