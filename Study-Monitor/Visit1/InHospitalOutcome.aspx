<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="InHospitalOutcome.aspx.cs" Inherits="Study_Monitor_Visit1_InHospitalOutcome" MaintainScrollPositionOnPostback="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="ASP.Web.UI.PopupControl" Namespace="ASP.Web.UI.PopupControl" TagPrefix="ASPP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Clinsoft | Study Monitor | Visit 1 | Date Of Patient Visit And ICF</title>
  ...
  <script type="text/javascript">
      function Confirm() {
          ...
          if (validated) {
              ...
              if (confirm("Do you want to Lock Date Of Patient Visit And ICF page?")) {
    ...
    <script type="text/javascript">
        function Confirm1() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to SDV Date Of Patient Visit And ICF page?")) {
    ...
    <script type="text/javascript">
        function Confirm2() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to Unlocked Date Of Patient Visit And ICF page?")) {
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEDIADR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseDIADR"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseDIADR" runat="server" Text="Raise Query" OnClick="QueryRaiseDIADR_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedDIADR" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedDIADRClose" runat="server" Text="Close Query"   OnClick="CloseQueryDIADR_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseDIADR" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseDIADR_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISEIHOTCM" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseIHOTCM"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseIHOTCM" runat="server" Text="Raise Query" OnClick="QueryRaiseIHOTCM_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedIHOTCM" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedIHOTCMClose" runat="server" Text="Close Query"   OnClick="CloseQueryIHOTCM_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseIHOTCM" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseIHOTCM_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISECAUDT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseCAUDT"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseCAUDT" runat="server" Text="Raise Query" OnClick="QueryRaiseCAUDT_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedCAUDT" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedCAUDTClose" runat="server" Text="Close Query"   OnClick="CloseQueryCAUDT_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseCAUDT" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseCAUDT_Click" />
                       </div>
            ...
            <PopupWindow runat="server">
                <ASPP:PopupWindow ID="PopupWindowRAISECAUTRSPY" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                       &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBoxRaiseCAUTRSPY"  runat="server" Height="50" Width="200" TextMode="MultiLine"></asp:TextBox>
                       
                         <br />
                         <div style="margin-top: 10px">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="QueryRaiseCAUTRSPY" runat="server" Text="Raise Query" OnClick="QueryRaiseCAUTRSPY_Click"/>
                       </div>
                    </div>
                     <br />
                </ASPP:PopupWindow>
                ...
                <ASPP:PopupWindow ID="PopupWindowRespondedCAUTRSPY" runat="server">
                    <div align="left" style="width: 300px"  >
                        ...
                        <br />
                         ...
                         <div style="margin-top: 10px">
                        <asp:Button ID="RespondedCAUTRSPYClose" runat="server" Text="Close Query"   OnClick="CloseQueryCAUTRSPY_Click" />
                       </div>
                    ...
                    <div align="left" style="width: 300px"  >
                      ...
                      <br />
                         ...
                         <div style="margin-top: 10px">
                              ...
                              <asp:Button ID="ButtonCloseCAUTRSPY" runat="server" Text="Reraise Query"   OnClick="SubmitReRaiseCAUTRSPY_Click" />
                       </div>
