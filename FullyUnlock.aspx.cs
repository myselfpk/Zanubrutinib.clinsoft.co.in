...
public partial class DataView_Day1_FullyUnlock : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    {
        if (RadioButtonListPI.SelectedValue == "Database fully Unlock by the Data Manager")
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                cmd.Parameters.AddWithValue("@mode", "Unlock");
                cmd.Parameters.AddWithValue("@Action", "Database Unlock");
                ...
                cmd.Parameters.AddWithValue("@Description", "Fully Database Unlock by the Data Manager and the Data Manager is Mr. " + Session["UserName"]);
                con.Open();
        ...
        {
            dvMessage.Visible = true;
            lblMessage.Text = "Please click on Database fully Unlock by the Data Manager";
            ClientScript.RegisterStartupScript(this.GetType(), "JS", "$(function () { $('#LoginModal').modal('show'); });", true);
        }
