<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PISIteLockUndertaking.aspx.cs" Inherits="DatabaseLock_PIUndertaking" %>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    &nbsp;<div class="col-md-9">
                                       ...
                                       <b>I  hereby confirm that i have reviewed the entire database. All queries are resolved and all subjects are lcoked by CRA and Signed electronically by PI. After locking the database by datamanger no more changes can be done in database. </b>      <script type="text/javascript">
