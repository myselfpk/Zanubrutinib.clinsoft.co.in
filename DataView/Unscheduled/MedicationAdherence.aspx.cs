...
public partial class DataView_Unscheduled_MedicationAdherence : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    private void BindPage()
    {
        con.Close();
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("Select MDPCM from [Visit2].[MedicationAdherence] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "' and [FUVSTNM]='"+ lblVisit .Text+ "'", con);
    ...
    private void SetImageQueryMDPCM()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMDPCM.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMDPCM.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMDPCM.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMDPCM.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMDPCM_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMDPCM.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMDPCM.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMDPCM.Visible = true;
                RAISEMDPCM.ShowPopupWindow();
            }

            else if ((ImageQueryMDPCM.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMDPCM.Visible = true;
                RespondedMDPCM.ShowPopupWindow();
            }
            else if ((ImageQueryMDPCM.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMDPCM_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMDPCM.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
