...
public partial class DataView_AdVisit_StudyCompletionForm : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    private void BindPage()
    {
        con.Close();
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("SELECT SCFYN ,SCFDSCF ,SCFRSN ,SCFDOFLC ,SCFRSNDT ,SCFRSNSPY FROM [Add].[StudyCompletionForm] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
    ...
    private void SetImageQuerySCFYN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySCFYN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySCFYN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySCFYN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySCFYN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySCFYN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQuerySCFYN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySCFYN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESCFYN.Visible = true;
                RAISESCFYN.ShowPopupWindow();
            }

            else if ((ImageQuerySCFYN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSCFYN.Visible = true;
                RespondedSCFYN.ShowPopupWindow();
            }
            else if ((ImageQuerySCFYN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSCFYN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSCFYN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQuerySCFDSCF()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySCFDSCF.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySCFDSCF.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySCFDSCF.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySCFDSCF.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySCFDSCF_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQuerySCFDSCF.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySCFDSCF.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESCFDSCF.Visible = true;
                RAISESCFDSCF.ShowPopupWindow();
            }

            else if ((ImageQuerySCFDSCF.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSCFDSCF.Visible = true;
                RespondedSCFDSCF.ShowPopupWindow();
            }
            else if ((ImageQuerySCFDSCF.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSCFDSCF_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSCFDSCF.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQuerySCFRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySCFRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySCFRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySCFRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySCFRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySCFRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQuerySCFRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySCFRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESCFRSN.Visible = true;
                RAISESCFRSN.ShowPopupWindow();
            }

            else if ((ImageQuerySCFRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSCFRSN.Visible = true;
                RespondedSCFRSN.ShowPopupWindow();
            }
            else if ((ImageQuerySCFRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSCFRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSCFRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQuerySCFDOFLC()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySCFDOFLC.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySCFDOFLC.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySCFDOFLC.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySCFDOFLC.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySCFDOFLC_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQuerySCFDOFLC.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySCFDOFLC.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESCFDOFLC.Visible = true;
                RAISESCFDOFLC.ShowPopupWindow();
            }

            else if ((ImageQuerySCFDOFLC.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSCFDOFLC.Visible = true;
                RespondedSCFDOFLC.ShowPopupWindow();
            }
            else if ((ImageQuerySCFDOFLC.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSCFDOFLC_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSCFDOFLC.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQuerySCFRSNDT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySCFRSNDT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySCFRSNDT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySCFRSNDT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySCFRSNDT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySCFRSNDT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQuerySCFRSNDT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySCFRSNDT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESCFRSNDT.Visible = true;
                RAISESCFRSNDT.ShowPopupWindow();
            }

            else if ((ImageQuerySCFRSNDT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSCFRSNDT.Visible = true;
                RespondedSCFRSNDT.ShowPopupWindow();
            }
            else if ((ImageQuerySCFRSNDT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSCFRSNDT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSCFRSNDT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQuerySCFRSNSPY()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySCFRSNSPY.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySCFRSNSPY.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySCFRSNSPY.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySCFRSNSPY.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySCFRSNSPY_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQuerySCFRSNSPY.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySCFRSNSPY.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESCFRSNSPY.Visible = true;
                RAISESCFRSNSPY.ShowPopupWindow();
            }

            else if ((ImageQuerySCFRSNSPY.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSCFRSNSPY.Visible = true;
                RespondedSCFRSNSPY.ShowPopupWindow();
            }
            else if ((ImageQuerySCFRSNSPY.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSCFRSNSPY_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSCFRSNSPY.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
