...
public partial class DataView_AdVisit_AdverseEventRecord : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    private void SetImageQueryAEOCCUR()
    {
        ...
        if (dr.Read())
        {
            ...
            {
                ImageQueryAEOCCUR.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryAEOCCUR.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryAEOCCUR.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryAEOCCUR.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryAEOCCUR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryAEOCCUR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryAEOCCUR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEAEOCCUR.Visible = true;
                RAISEAEOCCUR.ShowPopupWindow();
            }

            else if ((ImageQueryAEOCCUR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedAEOCCUR.Visible = true;
                RespondedAEOCCUR.ShowPopupWindow();
            }
            else if ((ImageQueryAEOCCUR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseAEOCCUR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblAEOCCUR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryAEWT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryAEWT.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryAEWT.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryAEWT.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryAEWT.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryAEWT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryAEWT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryAEWT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEAEWT.Visible = true;
                RAISEAEWT.ShowPopupWindow();
            }

            else if ((ImageQueryAEWT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedAEWT.Visible = true;
                RespondedAEWT.ShowPopupWindow();
            }
            else if ((ImageQueryAEWT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseAEWT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblAEWT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryAEDTOS()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryAEDTOS.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryAEDTOS.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryAEDTOS.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryAEDTOS.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryAEDTOS_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryAEDTOS.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryAEDTOS.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEAEDTOS.Visible = true;
                RAISEAEDTOS.ShowPopupWindow();
            }

            else if ((ImageQueryAEDTOS.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedAEDTOS.Visible = true;
                RespondedAEDTOS.ShowPopupWindow();
            }
            else if ((ImageQueryAEDTOS.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseAEDTOS_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblAEDTOS.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryAESVR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryAESVR.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryAESVR.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryAESVR.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryAESVR.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryAESVR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryAESVR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryAESVR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEAESVR.Visible = true;
                RAISEAESVR.ShowPopupWindow();
            }

            else if ((ImageQueryAESVR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedAESVR.Visible = true;
                RespondedAESVR.ShowPopupWindow();
            }
            else if ((ImageQueryAESVR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseAESVR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblAESVR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryAE1AT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryAE1AT.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryAE1AT.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryAE1AT.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryAE1AT.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryAE1AT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryAE1AT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryAE1AT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEAE1AT.Visible = true;
                RAISEAE1AT.ShowPopupWindow();
            }

            else if ((ImageQueryAE1AT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedAE1AT.Visible = true;
                RespondedAE1AT.ShowPopupWindow();
            }
            else if ((ImageQueryAE1AT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseAE1AT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblAE1AT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryAE2AT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryAE2AT.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryAE2AT.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryAE2AT.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryAE2AT.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryAE2AT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryAE2AT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryAE2AT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEAE2AT.Visible = true;
                RAISEAE2AT.ShowPopupWindow();
            }

            else if ((ImageQueryAE2AT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedAE2AT.Visible = true;
                RespondedAE2AT.ShowPopupWindow();
            }
            else if ((ImageQueryAE2AT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseAE2AT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblAE2AT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryAE3AT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryAE3AT.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryAE3AT.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryAE3AT.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryAE3AT.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryAE3AT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryAE3AT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryAE3AT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEAE3AT.Visible = true;
                RAISEAE3AT.ShowPopupWindow();
            }

            else if ((ImageQueryAE3AT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedAE3AT.Visible = true;
                RespondedAE3AT.ShowPopupWindow();
            }
            else if ((ImageQueryAE3AT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseAE3AT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblAE3AT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryAETG()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryAETG.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryAETG.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryAETG.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryAETG.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryAETG_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryAETG.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryAETG.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEAETG.Visible = true;
                RAISEAETG.ShowPopupWindow();
            }

            else if ((ImageQueryAETG.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedAETG.Visible = true;
                RespondedAETG.ShowPopupWindow();
            }
            else if ((ImageQueryAETG.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseAETG_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblAETG.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryAEOAED()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryAEOAED.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryAEOAED.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryAEOAED.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryAEOAED.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryAEOAED_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryAEOAED.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryAEOAED.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEAEOAED.Visible = true;
                RAISEAEOAED.ShowPopupWindow();
            }

            else if ((ImageQueryAEOAED.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedAEOAED.Visible = true;
                RespondedAEOAED.ShowPopupWindow();
            }
            else if ((ImageQueryAEOAED.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseAEOAED_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblAEOAED.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryAESRMDR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryAESRMDR.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryAESRMDR.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryAESRMDR.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryAESRMDR.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryAESRMDR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryAESRMDR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryAESRMDR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEAESRMDR.Visible = true;
                RAISEAESRMDR.ShowPopupWindow();
            }

            else if ((ImageQueryAESRMDR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedAESRMDR.Visible = true;
                RespondedAESRMDR.ShowPopupWindow();
            }
            else if ((ImageQueryAESRMDR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseAESRMDR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblAESRMDR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryAECAUS()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryAECAUS.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryAECAUS.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryAECAUS.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryAECAUS.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryAECAUS_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryAECAUS.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryAECAUS.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEAECAUS.Visible = true;
                RAISEAECAUS.ShowPopupWindow();
            }

            else if ((ImageQueryAECAUS.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedAECAUS.Visible = true;
                RespondedAECAUS.ShowPopupWindow();
            }
            else if ((ImageQueryAECAUS.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseAECAUS_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblAECAUS.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAEPDINI()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAEPDINI.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAEPDINI.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAEPDINI.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAEPDINI.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAEPDINI_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAEPDINI.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAEPDINI.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAEPDINI.Visible = true;
                RAISESAEPDINI.ShowPopupWindow();
            }

            else if ((ImageQuerySAEPDINI.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAEPDINI.Visible = true;
                RespondedSAEPDINI.ShowPopupWindow();
            }
            else if ((ImageQuerySAEPDINI.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAEPDINI_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAEPDINI.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAEPDGNDR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAEPDGNDR.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAEPDGNDR.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAEPDGNDR.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAEPDGNDR.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAEPDGNDR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAEPDGNDR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAEPDGNDR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAEPDGNDR.Visible = true;
                RAISESAEPDGNDR.ShowPopupWindow();
            }

            else if ((ImageQuerySAEPDGNDR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAEPDGNDR.Visible = true;
                RespondedSAEPDGNDR.ShowPopupWindow();
            }
            else if ((ImageQuerySAEPDGNDR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAEPDGNDR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAEPDGNDR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAEPDDOB()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAEPDDOB.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAEPDDOB.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAEPDDOB.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAEPDDOB.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAEPDDOB_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAEPDDOB.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAEPDDOB.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAEPDDOB.Visible = true;
                RAISESAEPDDOB.ShowPopupWindow();
            }

            else if ((ImageQuerySAEPDDOB.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAEPDDOB.Visible = true;
                RespondedSAEPDDOB.ShowPopupWindow();
            }
            else if ((ImageQuerySAEPDDOB.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAEPDDOB_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAEPDDOB.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAEPDAGE()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAEPDAGE.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAEPDAGE.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAEPDAGE.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAEPDAGE.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAEPDAGE_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAEPDAGE.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAEPDAGE.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAEPDAGE.Visible = true;
                RAISESAEPDAGE.ShowPopupWindow();
            }

            else if ((ImageQuerySAEPDAGE.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAEPDAGE.Visible = true;
                RespondedSAEPDAGE.ShowPopupWindow();
            }
            else if ((ImageQuerySAEPDAGE.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAEPDAGE_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAEPDAGE.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAEPDHEIGHT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAEPDHEIGHT.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAEPDHEIGHT.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAEPDHEIGHT.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAEPDHEIGHT.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAEPDHEIGHT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAEPDHEIGHT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAEPDHEIGHT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAEPDHEIGHT.Visible = true;
                RAISESAEPDHEIGHT.ShowPopupWindow();
            }

            else if ((ImageQuerySAEPDHEIGHT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAEPDHEIGHT.Visible = true;
                RespondedSAEPDHEIGHT.ShowPopupWindow();
            }
            else if ((ImageQuerySAEPDHEIGHT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAEPDHEIGHT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAEPDHEIGHT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAEPDWEIGHT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAEPDWEIGHT.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAEPDWEIGHT.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAEPDWEIGHT.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAEPDWEIGHT.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAEPDWEIGHT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAEPDWEIGHT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAEPDWEIGHT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAEPDWEIGHT.Visible = true;
                RAISESAEPDWEIGHT.ShowPopupWindow();
            }

            else if ((ImageQuerySAEPDWEIGHT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAEPDWEIGHT.Visible = true;
                RespondedSAEPDWEIGHT.ShowPopupWindow();
            }
            else if ((ImageQuerySAEPDWEIGHT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAEPDWEIGHT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAEPDWEIGHT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySDGND()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySDGND.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySDGND.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySDGND.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySDGND.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySDGND_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySDGND.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySDGND.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESDGND.Visible = true;
                RAISESDGND.ShowPopupWindow();
            }

            else if ((ImageQuerySDGND.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSDGND.Visible = true;
                RespondedSDGND.ShowPopupWindow();
            }
            else if ((ImageQuerySDGND.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSDGND_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSDGND.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySCINDI()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySCINDI.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySCINDI.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySCINDI.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySCINDI.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySCINDI_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySCINDI.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySCINDI.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESCINDI.Visible = true;
                RAISESCINDI.ShowPopupWindow();
            }

            else if ((ImageQuerySCINDI.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSCINDI.Visible = true;
                RespondedSCINDI.ShowPopupWindow();
            }
            else if ((ImageQuerySCINDI.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSCINDI_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSCINDI.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySDDFS()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySDDFS.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySDDFS.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySDDFS.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySDDFS.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySDDFS_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySDDFS.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySDDFS.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESDDFS.Visible = true;
                RAISESDDFS.ShowPopupWindow();
            }

            else if ((ImageQuerySDDFS.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSDDFS.Visible = true;
                RespondedSDDFS.ShowPopupWindow();
            }
            else if ((ImageQuerySDDFS.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSDDFS_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSDDFS.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySDDDR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySDDDR.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySDDDR.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySDDDR.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySDDDR.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySDDDR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySDDDR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySDDDR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESDDDR.Visible = true;
                RAISESDDDR.ShowPopupWindow();
            }

            else if ((ImageQuerySDDDR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSDDDR.Visible = true;
                RespondedSDDDR.ShowPopupWindow();
            }
            else if ((ImageQuerySDDDR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSDDDR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSDDDR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySDROA()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySDROA.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySDROA.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySDROA.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySDROA.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySDROA_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySDROA.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySDROA.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESDROA.Visible = true;
                RAISESDROA.ShowPopupWindow();
            }

            else if ((ImageQuerySDROA.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSDROA.Visible = true;
                RespondedSDROA.ShowPopupWindow();
            }
            else if ((ImageQuerySDROA.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSDROA_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSDROA.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySDSTD()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySDSTD.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySDSTD.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySDSTD.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySDSTD.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySDSTD_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySDSTD.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySDSTD.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESDSTD.Visible = true;
                RAISESDSTD.ShowPopupWindow();
            }

            else if ((ImageQuerySDSTD.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSDSTD.Visible = true;
                RespondedSDSTD.ShowPopupWindow();
            }
            else if ((ImageQuerySDSTD.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSDSTD_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSDSTD.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySDSTT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySDSTT.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySDSTT.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySDSTT.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySDSTT.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySDSTT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySDSTT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySDSTT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESDSTT.Visible = true;
                RAISESDSTT.ShowPopupWindow();
            }

            else if ((ImageQuerySDSTT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSDSTT.Visible = true;
                RespondedSDSTT.ShowPopupWindow();
            }
            else if ((ImageQuerySDSTT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSDSTT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSDSTT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySDSPD()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySDSPD.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySDSPD.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySDSPD.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySDSPD.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySDSPD_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySDSPD.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySDSPD.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESDSPD.Visible = true;
                RAISESDSPD.ShowPopupWindow();
            }

            else if ((ImageQuerySDSPD.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSDSPD.Visible = true;
                RespondedSDSPD.ShowPopupWindow();
            }
            else if ((ImageQuerySDSPD.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSDSPD_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSDSPD.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySDSPT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySDSPT.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySDSPT.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySDSPT.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySDSPT.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySDSPT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySDSPT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySDSPT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESDSPT.Visible = true;
                RAISESDSPT.ShowPopupWindow();
            }

            else if ((ImageQuerySDSPT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSDSPT.Visible = true;
                RespondedSDSPT.ShowPopupWindow();
            }
            else if ((ImageQuerySDSPT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSDSPT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSDSPT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryOT1SPT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryOT1SPT.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryOT1SPT.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryOT1SPT.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryOT1SPT.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryOT1SPT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryOT1SPT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryOT1SPT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEOT1SPT.Visible = true;
                RAISEOT1SPT.ShowPopupWindow();
            }

            else if ((ImageQueryOT1SPT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedOT1SPT.Visible = true;
                RespondedOT1SPT.ShowPopupWindow();
            }
            else if ((ImageQueryOT1SPT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseOT1SPT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblOT1SPT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryOT2SPT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryOT2SPT.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryOT2SPT.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryOT2SPT.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryOT2SPT.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryOT2SPT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryOT2SPT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryOT2SPT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEOT2SPT.Visible = true;
                RAISEOT2SPT.ShowPopupWindow();
            }

            else if ((ImageQueryOT2SPT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedOT2SPT.Visible = true;
                RespondedOT2SPT.ShowPopupWindow();
            }
            else if ((ImageQueryOT2SPT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseOT2SPT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblOT2SPT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryOT3SPT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryOT3SPT.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryOT3SPT.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryOT3SPT.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryOT3SPT.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryOT3SPT_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryOT3SPT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryOT3SPT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEOT3SPT.Visible = true;
                RAISEOT3SPT.ShowPopupWindow();
            }

            else if ((ImageQueryOT3SPT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedOT3SPT.Visible = true;
                RespondedOT3SPT.ShowPopupWindow();
            }
            else if ((ImageQueryOT3SPT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseOT3SPT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblOT3SPT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAEFDR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAEFDR.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAEFDR.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAEFDR.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAEFDR.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAEFDR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAEFDR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAEFDR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAEFDR.Visible = true;
                RAISESAEFDR.ShowPopupWindow();
            }

            else if ((ImageQuerySAEFDR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAEFDR.Visible = true;
                RespondedSAEFDR.ShowPopupWindow();
            }
            else if ((ImageQuerySAEFDR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAEFDR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAEFDR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAESDTR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAESDTR.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAESDTR.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAESDTR.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAESDTR.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAESDTR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAESDTR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAESDTR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAESDTR.Visible = true;
                RAISESAESDTR.ShowPopupWindow();
            }

            else if ((ImageQuerySAESDTR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAESDTR.Visible = true;
                RespondedSAESDTR.ShowPopupWindow();
            }
            else if ((ImageQuerySAESDTR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAESDTR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAESDTR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAESDTTR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAESDTTR.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAESDTTR.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAESDTTR.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAESDTTR.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAESDTTR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAESDTTR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAESDTTR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAESDTTR.Visible = true;
                RAISESAESDTTR.ShowPopupWindow();
            }

            else if ((ImageQuerySAESDTTR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAESDTTR.Visible = true;
                RespondedSAESDTTR.ShowPopupWindow();
            }
            else if ((ImageQuerySAESDTTR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAESDTTR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAESDTTR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAESSPDR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAESSPDR.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAESSPDR.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAESSPDR.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAESSPDR.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAESSPDR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAESSPDR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAESSPDR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAESSPDR.Visible = true;
                RAISESAESSPDR.ShowPopupWindow();
            }

            else if ((ImageQuerySAESSPDR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAESSPDR.Visible = true;
                RespondedSAESSPDR.ShowPopupWindow();
            }
            else if ((ImageQuerySAESSPDR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAESSPDR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAESSPDR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAESSOTR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAESSOTR.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAESSOTR.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAESSOTR.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAESSOTR.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAESSOTR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAESSOTR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAESSOTR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAESSOTR.Visible = true;
                RAISESAESSOTR.ShowPopupWindow();
            }

            else if ((ImageQuerySAESSOTR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAESSOTR.Visible = true;
                RespondedSAESSOTR.ShowPopupWindow();
            }
            else if ((ImageQuerySAESSOTR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAESSOTR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAESSOTR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAEDARI()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAEDARI.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAEDARI.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAEDARI.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAEDARI.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAEDARI_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAEDARI.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAEDARI.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAEDARI.Visible = true;
                RAISESAEDARI.ShowPopupWindow();
            }

            else if ((ImageQuerySAEDARI.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAEDARI.Visible = true;
                RespondedSAEDARI.ShowPopupWindow();
            }
            else if ((ImageQuerySAEDARI.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAEDARI_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAEDARI.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAESTG()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAESTG.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAESTG.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAESTG.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAESTG.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAESTG_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAESTG.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAESTG.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAESTG.Visible = true;
                RAISESAESTG.ShowPopupWindow();
            }

            else if ((ImageQuerySAESTG.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAESTG.Visible = true;
                RespondedSAESTG.ShowPopupWindow();
            }
            else if ((ImageQuerySAESTG.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAESTG_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAESTG.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAEIRAS()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAEIRAS.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAEIRAS.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAEIRAS.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAEIRAS.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAEIRAS_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAEIRAS.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAEIRAS.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAEIRAS.Visible = true;
                RAISESAEIRAS.ShowPopupWindow();
            }

            else if ((ImageQuerySAEIRAS.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAEIRAS.Visible = true;
                RespondedSAEIRAS.ShowPopupWindow();
            }
            else if ((ImageQuerySAEIRAS.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAEIRAS_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAEIRAS.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAEIFFO()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAEIFFO.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAEIFFO.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAEIFFO.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAEIFFO.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAEIFFO_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAEIFFO.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAEIFFO.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAEIFFO.Visible = true;
                RAISESAEIFFO.ShowPopupWindow();
            }

            else if ((ImageQuerySAEIFFO.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAEIFFO.Visible = true;
                RespondedSAEIFFO.ShowPopupWindow();
            }
            else if ((ImageQuerySAEIFFO.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAEIFFO_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAEIFFO.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAEOI()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAEOI.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAEOI.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAEOI.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAEOI.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAEOI_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAEOI.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAEOI.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAEOI.Visible = true;
                RAISESAEOI.ShowPopupWindow();
            }

            else if ((ImageQuerySAEOI.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAEOI.Visible = true;
                RespondedSAEOI.ShowPopupWindow();
            }
            else if ((ImageQuerySAEOI.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAEOI_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAEOI.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQuerySAECAURU()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQuerySAECAURU.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySAECAURU.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySAECAURU.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQuerySAECAURU.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQuerySAECAURU_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQuerySAECAURU.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySAECAURU.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESAECAURU.Visible = true;
                RAISESAECAURU.ShowPopupWindow();
            }

            else if ((ImageQuerySAECAURU.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSAECAURU.Visible = true;
                RespondedSAECAURU.ShowPopupWindow();
            }
            else if ((ImageQuerySAECAURU.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSAECAURU_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSAECAURU.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryPINAME()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryPINAME.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryPINAME.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryPINAME.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryPINAME.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryPINAME_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryPINAME.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryPINAME.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEPINAME.Visible = true;
                RAISEPINAME.ShowPopupWindow();
            }

            else if ((ImageQueryPINAME.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedPINAME.Visible = true;
                RespondedPINAME.ShowPopupWindow();
            }
            else if ((ImageQueryPINAME.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaisePINAME_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblPINAME.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryPIADDRESS()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryPIADDRESS.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryPIADDRESS.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryPIADDRESS.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryPIADDRESS.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryPIADDRESS_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryPIADDRESS.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryPIADDRESS.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEPIADDRESS.Visible = true;
                RAISEPIADDRESS.ShowPopupWindow();
            }

            else if ((ImageQueryPIADDRESS.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedPIADDRESS.Visible = true;
                RespondedPIADDRESS.ShowPopupWindow();
            }
            else if ((ImageQueryPIADDRESS.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaisePIADDRESS_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblPIADDRESS.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryPINUMBER()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryPINUMBER.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryPINUMBER.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryPINUMBER.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryPINUMBER.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryPINUMBER_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryPINUMBER.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryPINUMBER.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEPINUMBER.Visible = true;
                RAISEPINUMBER.ShowPopupWindow();
            }

            else if ((ImageQueryPINUMBER.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedPINUMBER.Visible = true;
                RespondedPINUMBER.ShowPopupWindow();
            }
            else if ((ImageQueryPINUMBER.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaisePINUMBER_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblPINUMBER.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryPTPROFESSION()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryPTPROFESSION.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryPTPROFESSION.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryPTPROFESSION.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryPTPROFESSION.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryPTPROFESSION_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryPTPROFESSION.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryPTPROFESSION.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEPTPROFESSION.Visible = true;
                RAISEPTPROFESSION.ShowPopupWindow();
            }

            else if ((ImageQueryPTPROFESSION.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedPTPROFESSION.Visible = true;
                RespondedPTPROFESSION.ShowPopupWindow();
            }
            else if ((ImageQueryPTPROFESSION.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaisePTPROFESSION_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblPTPROFESSION.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryPIDRELA()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryPIDRELA.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryPIDRELA.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryPIDRELA.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryPIDRELA.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryPIDRELA_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryPIDRELA.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryPIDRELA.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEPIDRELA.Visible = true;
                RAISEPIDRELA.ShowPopupWindow();
            }

            else if ((ImageQueryPIDRELA.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedPIDRELA.Visible = true;
                RespondedPIDRELA.ShowPopupWindow();
            }
            else if ((ImageQueryPIDRELA.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaisePIDRELA_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblPIDRELA.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryPIDREECOS()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryPIDREECOS.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryPIDREECOS.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryPIDREECOS.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryPIDREECOS.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryPIDREECOS_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryPIDREECOS.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryPIDREECOS.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEPIDREECOS.Visible = true;
                RAISEPIDREECOS.ShowPopupWindow();
            }

            else if ((ImageQueryPIDREECOS.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedPIDREECOS.Visible = true;
                RespondedPIDREECOS.ShowPopupWindow();
            }
            else if ((ImageQueryPIDREECOS.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaisePIDREECOS_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblPIDREECOS.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
    ...
    private void SetImageQueryAEAEN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ImageQueryAEAEN.ImageUrl = "~/DataView/Images/red.png";
            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryAEAEN.ImageUrl = "~/DataView/Images/close.png";
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryAEAEN.ImageUrl = "~/DataView/Images/Yellow.png";
            }
            else
            {
                ImageQueryAEAEN.ImageUrl = "~/DataView/Images/Blue.jpg";
            }
        }
        else
        {
    ...
    protected void ImageQueryAEAEN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            if ((ImageQueryAEAEN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryAEAEN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEAEAEN.Visible = true;
                RAISEAEAEN.ShowPopupWindow();
            }

            else if ((ImageQueryAEAEN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedAEAEN.Visible = true;
                RespondedAEAEN.ShowPopupWindow();
            }
            else if ((ImageQueryAEAEN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseAEAEN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblAEAEN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','" + TextBoxAEAEN.Text + "')", con);
