...
public partial class DataView_Visit1_Medication : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    private void SetImageQueryMEDI1SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI1SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI1SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI1SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI1SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI1SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI1SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI1SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI1SPRSN.Visible = true;
                RAISEMEDI1SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI1SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI1SPRSN.Visible = true;
                RespondedMEDI1SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI1SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI1SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI1SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI2SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI2SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI2SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI2SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI2SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI2SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI2SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI2SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI2SPRSN.Visible = true;
                RAISEMEDI2SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI2SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI2SPRSN.Visible = true;
                RespondedMEDI2SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI2SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI2SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI2SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI3SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI3SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI3SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI3SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI3SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI3SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI3SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI3SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI3SPRSN.Visible = true;
                RAISEMEDI3SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI3SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI3SPRSN.Visible = true;
                RespondedMEDI3SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI3SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI3SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI3SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI4SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI4SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI4SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI4SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI4SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI4SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI4SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI4SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI4SPRSN.Visible = true;
                RAISEMEDI4SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI4SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI4SPRSN.Visible = true;
                RespondedMEDI4SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI4SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI4SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI4SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI5SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI5SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI5SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI5SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI5SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI5SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI5SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI5SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI5SPRSN.Visible = true;
                RAISEMEDI5SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI5SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI5SPRSN.Visible = true;
                RespondedMEDI5SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI5SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI5SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI5SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI6SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI6SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI6SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI6SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI6SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI6SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI6SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI6SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI6SPRSN.Visible = true;
                RAISEMEDI6SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI6SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI6SPRSN.Visible = true;
                RespondedMEDI6SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI6SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI6SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI6SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI7SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI7SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI7SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI7SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI7SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI7SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI7SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI7SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI7SPRSN.Visible = true;
                RAISEMEDI7SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI7SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI7SPRSN.Visible = true;
                RespondedMEDI7SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI7SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI7SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI7SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI8SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI8SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI8SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI8SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI8SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI8SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI8SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI8SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI8SPRSN.Visible = true;
                RAISEMEDI8SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI8SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI8SPRSN.Visible = true;
                RespondedMEDI8SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI8SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI8SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI8SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI9SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI9SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI9SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI9SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI9SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI9SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI9SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI9SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI9SPRSN.Visible = true;
                RAISEMEDI9SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI9SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI9SPRSN.Visible = true;
                RespondedMEDI9SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI9SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI9SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI9SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI10SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI10SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI10SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI10SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI10SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI10SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI10SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI10SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI10SPRSN.Visible = true;
                RAISEMEDI10SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI10SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI10SPRSN.Visible = true;
                RespondedMEDI10SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI10SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI10SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI10SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI11SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI11SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI11SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI11SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI11SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI11SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI11SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI11SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI11SPRSN.Visible = true;
                RAISEMEDI11SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI11SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI11SPRSN.Visible = true;
                RespondedMEDI11SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI11SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI11SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI11SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI12SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI12SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI12SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI12SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI12SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI12SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI12SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI12SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI12SPRSN.Visible = true;
                RAISEMEDI12SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI12SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI12SPRSN.Visible = true;
                RespondedMEDI12SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI12SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI12SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI12SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI13SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI13SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI13SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI13SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI13SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI13SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI13SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI13SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI13SPRSN.Visible = true;
                RAISEMEDI13SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI13SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI13SPRSN.Visible = true;
                RespondedMEDI13SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI13SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI13SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI13SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI14SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI14SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI14SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI14SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI14SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI14SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI14SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI14SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI14SPRSN.Visible = true;
                RAISEMEDI14SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI14SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI14SPRSN.Visible = true;
                RespondedMEDI14SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI14SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI14SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI14SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI15SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI15SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI15SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI15SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI15SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI15SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI15SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI15SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI15SPRSN.Visible = true;
                RAISEMEDI15SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI15SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI15SPRSN.Visible = true;
                RespondedMEDI15SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI15SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI15SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI15SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI16SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI16SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI16SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI16SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI16SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI16SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI16SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI16SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI16SPRSN.Visible = true;
                RAISEMEDI16SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI16SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI16SPRSN.Visible = true;
                RespondedMEDI16SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI16SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI16SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI16SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI17SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI17SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI17SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI17SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI17SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI17SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI17SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI17SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI17SPRSN.Visible = true;
                RAISEMEDI17SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI17SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI17SPRSN.Visible = true;
                RespondedMEDI17SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI17SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI17SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI17SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI18SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI18SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI18SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI18SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI18SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI18SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI18SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI18SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI18SPRSN.Visible = true;
                RAISEMEDI18SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI18SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI18SPRSN.Visible = true;
                RespondedMEDI18SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI18SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI18SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI18SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI19SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI19SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI19SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI19SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI19SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI19SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI19SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI19SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI19SPRSN.Visible = true;
                RAISEMEDI19SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI19SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI19SPRSN.Visible = true;
                RespondedMEDI19SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI19SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI19SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI19SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI20SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI20SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI20SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI20SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI20SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI20SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI20SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI20SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI20SPRSN.Visible = true;
                RAISEMEDI20SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI20SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI20SPRSN.Visible = true;
                RespondedMEDI20SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI20SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI20SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI20SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI21SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI21SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI21SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI21SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI21SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI21SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI21SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI21SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI21SPRSN.Visible = true;
                RAISEMEDI21SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI21SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI21SPRSN.Visible = true;
                RespondedMEDI21SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI21SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI21SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI21SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI22SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI22SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI22SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI22SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI22SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI22SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI22SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI22SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI22SPRSN.Visible = true;
                RAISEMEDI22SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI22SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI22SPRSN.Visible = true;
                RespondedMEDI22SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI22SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI22SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI22SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI23SPRSN()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI23SPRSN.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI23SPRSN.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI23SPRSN.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI23SPRSN.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI23SPRSN_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI23SPRSN.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI23SPRSN.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI23SPRSN.Visible = true;
                RAISEMEDI23SPRSN.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI23SPRSN.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI23SPRSN.Visible = true;
                RespondedMEDI23SPRSN.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI23SPRSN.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI23SPRSN_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI23SPRSN.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI1INDR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI1INDR.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI1INDR.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI1INDR.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI1INDR.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI1INDR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI1INDR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI1INDR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI1INDR.Visible = true;
                RAISEMEDI1INDR.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI1INDR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI1INDR.Visible = true;
                RespondedMEDI1INDR.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI1INDR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI1INDR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI1INDR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI2INDR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI2INDR.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI2INDR.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI2INDR.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI2INDR.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI2INDR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI2INDR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI2INDR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI2INDR.Visible = true;
                RAISEMEDI2INDR.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI2INDR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI2INDR.Visible = true;
                RespondedMEDI2INDR.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI2INDR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI2INDR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI2INDR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI3INDR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI3INDR.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI3INDR.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI3INDR.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI3INDR.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI3INDR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI3INDR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI3INDR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI3INDR.Visible = true;
                RAISEMEDI3INDR.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI3INDR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI3INDR.Visible = true;
                RespondedMEDI3INDR.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI3INDR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI3INDR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI3INDR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI4INDR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI4INDR.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI4INDR.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI4INDR.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI4INDR.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI4INDR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI4INDR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI4INDR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI4INDR.Visible = true;
                RAISEMEDI4INDR.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI4INDR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI4INDR.Visible = true;
                RespondedMEDI4INDR.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI4INDR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI4INDR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI4INDR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI5INDR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI5INDR.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI5INDR.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI5INDR.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI5INDR.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI5INDR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI5INDR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI5INDR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI5INDR.Visible = true;
                RAISEMEDI5INDR.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI5INDR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI5INDR.Visible = true;
                RespondedMEDI5INDR.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI5INDR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI5INDR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI5INDR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI6INDR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI6INDR.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI6INDR.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI6INDR.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI6INDR.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI6INDR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI6INDR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI6INDR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI6INDR.Visible = true;
                RAISEMEDI6INDR.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI6INDR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI6INDR.Visible = true;
                RespondedMEDI6INDR.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI6INDR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI6INDR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI6INDR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI7INDR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI7INDR.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI7INDR.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI7INDR.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI7INDR.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI7INDR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI7INDR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI7INDR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI7INDR.Visible = true;
                RAISEMEDI7INDR.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI7INDR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI7INDR.Visible = true;
                RespondedMEDI7INDR.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI7INDR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI7INDR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI7INDR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
    ...
    private void SetImageQueryMEDI8INDR()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryMEDI8INDR.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryMEDI8INDR.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryMEDI8INDR.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryMEDI8INDR.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQueryMEDI8INDR_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (dr.Read())
        {
            ...
            if ((ImageQueryMEDI8INDR.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQueryMEDI8INDR.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEMEDI8INDR.Visible = true;
                RAISEMEDI8INDR.ShowPopupWindow();
            }

            else if ((ImageQueryMEDI8INDR.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedMEDI8INDR.Visible = true;
                RespondedMEDI8INDR.ShowPopupWindow();
            }
            else if ((ImageQueryMEDI8INDR.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseMEDI8INDR_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblMEDI8INDR.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
