...
public partial class DataView_Visit1_PatientPresentationSymptomsAndSigns : System.Web.UI.Page
{
...
(ConfigurationManager.ConnectionStrings["constr"].ToString());
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SetImageQueryPSSASYMP();
        BindQueryDataPSSASYMP();
    ...
    private void BindPage()
    {
        con.Close();
        con.Open();
        SqlCommand sqlCmd = new SqlCommand("SELECT PSSASYMP,SYMP1DAT ,SIGN1DAT ,SYMP2DAT ,SIGN2DAT ,SYMP3DAT ,SIGN3DAT ,SYMP4DAT ,SIGN4DAT ,SYMP5DAT ,SIGN5DAT ,SYMP6DAT ,SIGN6DAT,SYMP7OPT ,SYMP7DAT ,SIGN7OPT ,SIGN7DAT ,SYMP8OPT ,SYMP8DAT ,SIGN8OPT ,SIGN8DAT ,SYMP9OPT ,SYMP9DAT ,SIGN9OPT ,SIGN9DAT ,SYMP10OPT ,SYMP10DAT ,SIGN10OPT ,SIGN10DAT FROM [Visit1].[PatientPresentationSymptomsAndSigns] where [SITENUM] ='" + Request.QueryString["a"] + "' and [SUBNUM]='" + Request.QueryString["b"] + "'and [SUBINI]='" + Request.QueryString["c"] + "'", con);
        SqlDataAdapter sqlDa = new SqlDataAdapter(sqlCmd);
        sqlDa.Fill(dt);
        if (dt.Rows.Count > 0)
        {

            RadioButtonListPSSASYMP.SelectedValue = dt.Rows[0]["PSSASYMP"].ToString();
    ...
    #region QueryPSSASYMP
    private void SetImageQueryPSSASYMP()
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select top 1 * from tblQuery  where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'and Field = '" + lblPSSASYMP.Text + "' order by ID desc", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQueryPSSASYMP.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQueryPSSASYMP.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQueryPSSASYMP.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQueryPSSASYMP.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    private void BindQueryDataPSSASYMP()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                LabelRaisePSSASYMP.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                LabelRespondedPSSASYMP.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                LabelClosePSSASYMP.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                LabelLockPSSASYMP.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                PanelRaisePSSASYMP.Visible = true;
                PanelRaisePSSASYMP2.Visible = false;
                PanelRaisePSSASYMP3.Visible = false;
            ...
            else if (dr["Status"].ToString() == "Close")
            {
                LabelRaisePSSASYMP.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                LabelRespondedPSSASYMP.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                LabelRaisePSSASYMP2.Text = "<b>" + "Query Resolved by: " + "</b>" + dr["Username2"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Reply: " + "</b>" + dr["QueryResponse"].ToString() + "" + "<br />";
                LabelRespondedPSSASYMP2.Text = "<b>" + "Query Resolved by: " + "</b>" + dr["Username2"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Reply: " + "</b>" + dr["QueryResponse"].ToString() + "" + "<br />";
                LabelRaisePSSASYMP3.Text = "<b>" + "Query closed by: " + "</b>" + dr["Username3"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Closed Remarks: " + "</b>" + dr["QueryResponse3"].ToString();
                LabelRespondedPSSASYMP3.Text = "<b>" + "Query closed by: " + "</b>" + dr["Username3"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Closed Remarks: " + "</b>" + dr["QueryResponse3"].ToString();
                LabelClosePSSASYMP.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                LabelClosePSSASYMP2.Text = "<b>" + "Query Resolved by: " + "</b>" + dr["Username2"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Reply: " + "</b>" + dr["QueryResponse"].ToString() + "" + "<br />";
                LabelClosePSSASYMP3.Text = "<b>" + "Query closed by: " + "</b>" + dr["Username3"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Closed Remarks: " + "</b>" + dr["QueryResponse3"].ToString();
                LabelLockPSSASYMP.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
                LabelLockPSSASYMP2.Text = "<b>" + "Query Resolved by: " + "</b>" + dr["Username2"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Reply: " + "</b>" + dr["QueryResponse"].ToString() + "" + "<br />";
                LabelLockPSSASYMP3.Text = "<b>" + "Query closed by: " + "</b>" + dr["Username3"].ToString() + "" + "<br />" + "<b>" + "<br />" + "<b>" + " Closed Remarks: " + "</b>" + dr["QueryResponse3"].ToString();
                PanelRaisePSSASYMP.Visible = true;
                PanelRaisePSSASYMP2.Visible = true;
                PanelRaisePSSASYMP3.Visible = true;
            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                LabelRaisePSSASYMP.Text = "<b>" + "Query Raised by: " + "</b>" + dr["Username"].ToString() + "" + "<br />" + "<b>" + "<b>" + " Query Description: " + "</b>" + dr["Query"].ToString();
    ...
    protected void ImageQueryPSSASYMP_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and PSSASYMP = '" + RadioButtonListPSSASYMP.SelectedValue + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQueryPSSASYMP.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {

                RAISEPSSASYMP.Visible = true;
                RAISEPSSASYMP.ShowPopupWindow();
                PanelRaisePSSASYMP.Visible = false;
                PanelRaisePSSASYMP2.Visible = false;
                PanelRaisePSSASYMP3.Visible = false;

            }

            else if ((ImageQueryPSSASYMP.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISEPSSASYMP.Visible = true;
                RAISEPSSASYMP.ShowPopupWindow();
            }

            else if ((ImageQueryPSSASYMP.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedPSSASYMP.Visible = true;
                RespondedPSSASYMP.ShowPopupWindow();
            }
            else if ((ImageQueryPSSASYMP.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                ClosePSSASYMP.Visible = true;
                ClosePSSASYMP.ShowPopupWindow();
            }
            else
            {
                LockPSSASYMP.Visible = true;
                LockPSSASYMP.ShowPopupWindow();

            }
        }

    }
    protected void QueryRaisePSSASYMP_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblPSSASYMP.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and PSSASYMP = '" + RadioButtonListPSSASYMP.SelectedValue + "'", con1);
        ...
        RAISEPSSASYMPMSG.ShowPopupWindow();
        RAISEPSSASYMP.Visible = false;
    }

    protected void CloseQueryPSSASYMP_Click(object sender, EventArgs e)
    {
        con.Close();
        con.Open();
        con1.Open();
        cmd = new SqlCommand(" Update tblQuery set  QueryResponse3 = 'Query Closed',  Status = 'Close', Username3 ='" + LabelUserName.Text + "', Date3 ='" + DateTime.Today.ToString("dd-MMM-yyyy") + "' where Site='" + lblCenterNumber.Text + "' and ScreenID = '" + lblScreeningNo.Text + "' and SubInitial = '" + lblSubjectInitial.Text + "' and Visit = '" + lblVisit.Text + "' and Page = '" + lblPage.Text + "'and Field = '" + lblPSSASYMP.Text + "'", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and PSSASYMP = '" + RadioButtonListPSSASYMP.SelectedValue + "'", con1);
        ...
        CLOSEPSSASYMPMSG.ShowPopupWindow();
        RespondedPSSASYMP.Visible = false;
    }

    protected void SubmitReRaisePSSASYMP_Click(object sender, EventArgs e)
    {
        ClosePSSASYMP.Visible = false;
    ...
    private void SetImageQuerySYMP1DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySYMP1DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySYMP1DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySYMP1DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySYMP1DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySYMP1DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP1DAT = '" + TextBoxSYMP1DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySYMP1DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySYMP1DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESYMP1DAT.Visible = true;
                RAISESYMP1DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySYMP1DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSYMP1DAT.Visible = true;
                RespondedSYMP1DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySYMP1DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSYMP1DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSYMP1DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP1DAT = '" + TextBoxSYMP1DAT.Text + "'", con1);
    ...
    protected void CloseQuerySYMP1DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP1DAT = '" + TextBoxSYMP1DAT.Text + "'", con1);
    ...
    private void SetImageQuerySIGN1DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySIGN1DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySIGN1DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySIGN1DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySIGN1DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySIGN1DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN1DAT = '" + TextBoxSIGN1DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySIGN1DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySIGN1DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESIGN1DAT.Visible = true;
                RAISESIGN1DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySIGN1DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSIGN1DAT.Visible = true;
                RespondedSIGN1DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySIGN1DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSIGN1DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSIGN1DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN1DAT = '" + TextBoxSIGN1DAT.Text + "'", con1);
    ...
    protected void CloseQuerySIGN1DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN1DAT = '" + TextBoxSIGN1DAT.Text + "'", con1);
    ...
    private void SetImageQuerySYMP2DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySYMP2DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySYMP2DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySYMP2DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySYMP2DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySYMP2DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP2DAT = '" + TextBoxSYMP2DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySYMP2DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySYMP2DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESYMP2DAT.Visible = true;
                RAISESYMP2DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySYMP2DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSYMP2DAT.Visible = true;
                RespondedSYMP2DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySYMP2DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSYMP2DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSYMP2DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP2DAT = '" + TextBoxSYMP2DAT.Text + "'", con1);
    ...
    protected void CloseQuerySYMP2DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP2DAT = '" + TextBoxSYMP2DAT.Text + "'", con1);
    ...
    private void SetImageQuerySIGN2DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySIGN2DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySIGN2DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySIGN2DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySIGN2DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySIGN2DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN2DAT = '" + TextBoxSIGN2DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySIGN2DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySIGN2DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESIGN2DAT.Visible = true;
                RAISESIGN2DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySIGN2DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSIGN2DAT.Visible = true;
                RespondedSIGN2DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySIGN2DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSIGN2DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSIGN2DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN2DAT = '" + TextBoxSIGN2DAT.Text + "'", con1);
    ...
    protected void CloseQuerySIGN2DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN2DAT = '" + TextBoxSIGN2DAT.Text + "'", con1);
    ...
    private void SetImageQuerySYMP3DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySYMP3DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySYMP3DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySYMP3DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySYMP3DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySYMP3DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP3DAT = '" + TextBoxSYMP3DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySYMP3DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySYMP3DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESYMP3DAT.Visible = true;
                RAISESYMP3DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySYMP3DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSYMP3DAT.Visible = true;
                RespondedSYMP3DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySYMP3DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSYMP3DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSYMP3DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP3DAT = '" + TextBoxSYMP3DAT.Text + "'", con1);
    ...
    protected void CloseQuerySYMP3DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP3DAT = '" + TextBoxSYMP3DAT.Text + "'", con1);
    ...
    private void SetImageQuerySIGN3DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySIGN3DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySIGN3DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySIGN3DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySIGN3DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySIGN3DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN3DAT = '" + TextBoxSIGN3DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySIGN3DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySIGN3DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESIGN3DAT.Visible = true;
                RAISESIGN3DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySIGN3DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSIGN3DAT.Visible = true;
                RespondedSIGN3DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySIGN3DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSIGN3DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSIGN3DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN3DAT = '" + TextBoxSIGN3DAT.Text + "'", con1);
    ...
    protected void CloseQuerySIGN3DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN3DAT = '" + TextBoxSIGN3DAT.Text + "'", con1);
    ...
    private void SetImageQuerySYMP4DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySYMP4DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySYMP4DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySYMP4DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySYMP4DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySYMP4DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP4DAT = '" + TextBoxSYMP4DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySYMP4DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySYMP4DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESYMP4DAT.Visible = true;
                RAISESYMP4DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySYMP4DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSYMP4DAT.Visible = true;
                RespondedSYMP4DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySYMP4DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSYMP4DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSYMP4DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP4DAT = '" + TextBoxSYMP4DAT.Text + "'", con1);
    ...
    protected void CloseQuerySYMP4DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP4DAT = '" + TextBoxSYMP4DAT.Text + "'", con1);
    ...
    private void SetImageQuerySIGN4DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySIGN4DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySIGN4DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySIGN4DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySIGN4DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySIGN4DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN4DAT = '" + TextBoxSIGN4DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySIGN4DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySIGN4DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESIGN4DAT.Visible = true;
                RAISESIGN4DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySIGN4DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSIGN4DAT.Visible = true;
                RespondedSIGN4DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySIGN4DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSIGN4DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSIGN4DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN4DAT = '" + TextBoxSIGN4DAT.Text + "'", con1);
    ...
    protected void CloseQuerySIGN4DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN4DAT = '" + TextBoxSIGN4DAT.Text + "'", con1);
    ...
    private void SetImageQuerySYMP5DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySYMP5DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySYMP5DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySYMP5DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySYMP5DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySYMP5DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP5DAT = '" + TextBoxSYMP5DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySYMP5DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySYMP5DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESYMP5DAT.Visible = true;
                RAISESYMP5DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySYMP5DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSYMP5DAT.Visible = true;
                RespondedSYMP5DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySYMP5DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSYMP5DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSYMP5DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP5DAT = '" + TextBoxSYMP5DAT.Text + "'", con1);
    ...
    protected void CloseQuerySYMP5DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP5DAT = '" + TextBoxSYMP5DAT.Text + "'", con1);
    ...
    private void SetImageQuerySIGN5DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySIGN5DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySIGN5DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySIGN5DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySIGN5DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySIGN5DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN5DAT = '" + TextBoxSIGN5DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySIGN5DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySIGN5DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESIGN5DAT.Visible = true;
                RAISESIGN5DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySIGN5DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSIGN5DAT.Visible = true;
                RespondedSIGN5DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySIGN5DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSIGN5DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSIGN5DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN5DAT = '" + TextBoxSIGN5DAT.Text + "'", con1);
    ...
    protected void CloseQuerySIGN5DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN5DAT = '" + TextBoxSIGN5DAT.Text + "'", con1);
    ...
    private void SetImageQuerySYMP6DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySYMP6DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySYMP6DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySYMP6DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySYMP6DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySYMP6DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP6DAT = '" + TextBoxSYMP6DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySYMP6DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySYMP6DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESYMP6DAT.Visible = true;
                RAISESYMP6DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySYMP6DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSYMP6DAT.Visible = true;
                RespondedSYMP6DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySYMP6DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSYMP6DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSYMP6DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP6DAT = '" + TextBoxSYMP6DAT.Text + "'", con1);
    ...
    protected void CloseQuerySYMP6DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP6DAT = '" + TextBoxSYMP6DAT.Text + "'", con1);
    ...
    private void SetImageQuerySIGN6DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySIGN6DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySIGN6DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySIGN6DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySIGN6DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySIGN6DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN6DAT = '" + TextBoxSIGN6DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySIGN6DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySIGN6DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESIGN6DAT.Visible = true;
                RAISESIGN6DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySIGN6DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSIGN6DAT.Visible = true;
                RespondedSIGN6DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySIGN6DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSIGN6DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSIGN6DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN6DAT = '" + TextBoxSIGN6DAT.Text + "'", con1);
    ...
    protected void CloseQuerySIGN6DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN6DAT = '" + TextBoxSIGN6DAT.Text + "'", con1);
    ...
    private void SetImageQuerySYMP7DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySYMP7DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySYMP7DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySYMP7DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySYMP7DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySYMP7DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP7DAT = '" + TextBoxSYMP7DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySYMP7DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySYMP7DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESYMP7DAT.Visible = true;
                RAISESYMP7DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySYMP7DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSYMP7DAT.Visible = true;
                RespondedSYMP7DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySYMP7DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSYMP7DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSYMP7DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP7DAT = '" + TextBoxSYMP7DAT.Text + "'", con1);
    ...
    protected void CloseQuerySYMP7DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP7DAT = '" + TextBoxSYMP7DAT.Text + "'", con1);
    ...
    private void SetImageQuerySIGN7DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySIGN7DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySIGN7DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySIGN7DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySIGN7DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySIGN7DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN7DAT = '" + TextBoxSIGN7DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySIGN7DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySIGN7DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESIGN7DAT.Visible = true;
                RAISESIGN7DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySIGN7DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSIGN7DAT.Visible = true;
                RespondedSIGN7DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySIGN7DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSIGN7DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSIGN7DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN7DAT = '" + TextBoxSIGN7DAT.Text + "'", con1);
    ...
    protected void CloseQuerySIGN7DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN7DAT = '" + TextBoxSIGN7DAT.Text + "'", con1);
    ...
    private void SetImageQuerySYMP8DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySYMP8DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySYMP8DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySYMP8DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySYMP8DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySYMP8DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP8DAT = '" + TextBoxSYMP8DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySYMP8DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySYMP8DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESYMP8DAT.Visible = true;
                RAISESYMP8DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySYMP8DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSYMP8DAT.Visible = true;
                RespondedSYMP8DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySYMP8DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSYMP8DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSYMP8DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP8DAT = '" + TextBoxSYMP8DAT.Text + "'", con1);
    ...
    protected void CloseQuerySYMP8DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP8DAT = '" + TextBoxSYMP8DAT.Text + "'", con1);
    ...
    private void SetImageQuerySIGN8DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySIGN8DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySIGN8DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySIGN8DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySIGN8DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySIGN8DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN8DAT = '" + TextBoxSIGN8DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySIGN8DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySIGN8DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESIGN8DAT.Visible = true;
                RAISESIGN8DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySIGN8DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSIGN8DAT.Visible = true;
                RespondedSIGN8DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySIGN8DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSIGN8DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSIGN8DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN8DAT = '" + TextBoxSIGN8DAT.Text + "'", con1);
    ...
    protected void CloseQuerySIGN8DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN8DAT = '" + TextBoxSIGN8DAT.Text + "'", con1);
    ...
    private void SetImageQuerySYMP9DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySYMP9DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySYMP9DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySYMP9DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySYMP9DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySYMP9DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP9DAT = '" + TextBoxSYMP9DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySYMP9DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySYMP9DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESYMP9DAT.Visible = true;
                RAISESYMP9DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySYMP9DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSYMP9DAT.Visible = true;
                RespondedSYMP9DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySYMP9DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSYMP9DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSYMP9DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP9DAT = '" + TextBoxSYMP9DAT.Text + "'", con1);
    ...
    protected void CloseQuerySYMP9DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP9DAT = '" + TextBoxSYMP9DAT.Text + "'", con1);
    ...
    private void SetImageQuerySIGN9DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySIGN9DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySIGN9DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySIGN9DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySIGN9DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySIGN9DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN9DAT = '" + TextBoxSIGN9DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySIGN9DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySIGN9DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESIGN9DAT.Visible = true;
                RAISESIGN9DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySIGN9DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSIGN9DAT.Visible = true;
                RespondedSIGN9DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySIGN9DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSIGN9DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSIGN9DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN9DAT = '" + TextBoxSIGN9DAT.Text + "'", con1);
    ...
    protected void CloseQuerySIGN9DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN9DAT = '" + TextBoxSIGN9DAT.Text + "'", con1);
    ...
    private void SetImageQuerySYMP10DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySYMP10DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySYMP10DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySYMP10DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySYMP10DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySYMP10DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP10DAT = '" + TextBoxSYMP10DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySYMP10DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySYMP10DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESYMP10DAT.Visible = true;
                RAISESYMP10DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySYMP10DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSYMP10DAT.Visible = true;
                RespondedSYMP10DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySYMP10DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSYMP10DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSYMP10DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP10DAT = '" + TextBoxSYMP10DAT.Text + "'", con1);
    ...
    protected void CloseQuerySYMP10DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SYMP10DAT = '" + TextBoxSYMP10DAT.Text + "'", con1);
    ...
    private void SetImageQuerySIGN10DAT()
    {
        ...
        if (dr.Read())
        {
            if (dr["Status"].ToString() == "Open")
            {
                ...
                ImageQuerySIGN10DAT.ImageUrl = "~/DataView/Images/red.png";


            }
            else if (dr["Status"].ToString() == "Close")
            {
                ImageQuerySIGN10DAT.ImageUrl = "~/DataView/Images/close.png";

            }
            else if (dr["Status"].ToString() == "Query Responded")
            {
                ImageQuerySIGN10DAT.ImageUrl = "~/DataView/Images/Yellow.png";

            }
            else
            {
                ImageQuerySIGN10DAT.ImageUrl = "~/DataView/Images/Blue.jpg";
    ...
    protected void ImageQuerySIGN10DAT_Click(object sender, ImageClickEventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("Select * from [Visit1].[PatientPresentationSymptomsAndSigns]  where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN10DAT = '" + TextBoxSIGN10DAT.Text + "'", con);
        SqlDataReader dr;
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {

            if ((ImageQuerySIGN10DAT.ImageUrl == "~/DataView/Images/Blue.jpg") && (dr["LockStatus"].ToString() != "Locked"))
            {
            ...
            else if ((ImageQuerySIGN10DAT.ImageUrl == "~/DataView/Images/red.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RAISESIGN10DAT.Visible = true;
                RAISESIGN10DAT.ShowPopupWindow();
            }

            else if ((ImageQuerySIGN10DAT.ImageUrl == "~/DataView/Images/Yellow.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
                RespondedSIGN10DAT.Visible = true;
                RespondedSIGN10DAT.ShowPopupWindow();
            }
            else if ((ImageQuerySIGN10DAT.ImageUrl == "~/DataView/Images/close.png") && (dr["LockStatus"].ToString() != "Locked"))
            {
    ...
    protected void QueryRaiseSIGN10DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand(" insert into tblQuery values('" + lblCenterNumber.Text + "','" + lblScreeningNo.Text + "','" + lblSubjectInitial.Text + "','" + lblVisit.Text + "','" + lblPage.Text + "','" + lblSIGN10DAT.Text + "','" + LabelUserName.Text + "','" + DateTime.Today.ToString("dd-MMM-yyyy") + "','','','','Open','','','','','')", con);
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Open' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN10DAT = '" + TextBoxSIGN10DAT.Text + "'", con1);
    ...
    protected void CloseQuerySIGN10DAT_Click(object sender, EventArgs e)
    {
        ...
        cmd1 = new SqlCommand("Update [Visit1].[PatientPresentationSymptomsAndSigns]  set  QueryStatus = 'Query Closed' where SITENUM='" + lblCenterNumber.Text + "' and SUBNUM = '" + lblScreeningNo.Text + "' and SUBINI = '" + lblSubjectInitial.Text + "'and SIGN10DAT = '" + TextBoxSIGN10DAT.Text + "'", con1);
